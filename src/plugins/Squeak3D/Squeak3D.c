/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from B3DEnginePlugin
   Balloon3D-Plugins-eem.23 uuid: dbdf2f40-097a-4885-afd0-569d1dcf0f43
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "B3DEnginePlugin Balloon3D-Plugins-eem.23 uuid: "
    "dbdf2f40-097a-4885-afd0-569d1dcf0f43 " __DATE__;
#else
...
static sqInt interpolateFromtoatinto(float *last, float *next, double t,
                                     float *out);
...
static void *stackPrimitiveIndexArrayofSizevalidateforVertexSize(
    sqInt stackIndex, sqInt nItems, sqInt aBool, sqInt maxIndex);
...
static sqInt transformPrimitiveNormalbyrescale(float *pVertex, float *matrix,
                                               sqInt rescale);
...
static const char *moduleName = "Squeak3D Balloon3D-Plugins-eem.23 " INT_EXT;
...
b3dClipPolygon(void) {
  ...
  if ((vtxArray == null) || ((tempVtxArray == null) || (failed()))) {
    return primitiveFail();
  }
  ...
  countSqInt = vtxCount;
  countSqInt = clipPolygonLeftFromtocount(vtxArray, tempVtxArray, countSqInt);
  if (!countSqInt) {
    count = 0;
    goto l1;
  }
  countSqInt = clipPolygonRightFromtocount(tempVtxArray, vtxArray, countSqInt);
  if (!countSqInt) {
    count = 0;
    goto l1;
  }
  countSqInt = clipPolygonTopFromtocount(vtxArray, tempVtxArray, countSqInt);
  if (!countSqInt) {
    count = 0;
    goto l1;
  }
  countSqInt = clipPolygonBottomFromtocount(tempVtxArray, vtxArray, countSqInt);
  if (!countSqInt) {
    count = 0;
    goto l1;
  }
  countSqInt = clipPolygonFrontFromtocount(vtxArray, tempVtxArray, countSqInt);
  if (!countSqInt) {
    count = 0;
    goto l1;
  }
  countSqInt = clipPolygonBackFromtocount(tempVtxArray, vtxArray, countSqInt);
  count = countSqInt;
  /* end clipPolygon:count:with:mask: */
l1:
  pop(5);
  pushInteger(count);
  return 0;
...
b3dComputeMinIndexZ(void) {
  ...
  idxArray = stackPrimitiveIndexArrayofSizevalidateforVertexSize(1, idxSize, 1,
                                                                 vtxSize);
...
/*	Primitive. Initialize the primitive level objects of the given
 * rasterizer. */
...
b3dInitializeRasterizerState(void) {
  ...
  if (!((isPointers(stateOop)) && ((slotSizeOf(stateOop)) >= 7))) {
    return primitiveFail();
  }
  objOop = fetchPointerofObject(0, stateOop);
  if (!((isWords(objOop)) &&
        ((b3dInitializeFaceAllocator(firstIndexableField(objOop),
                                     byteSizeOf(objOop))) == B3D_NO_ERROR))) {
    return primitiveFail();
  }
  objOop = fetchPointerofObject(1, stateOop);
  if (!((isWords(objOop)) &&
        ((b3dInitializeEdgeAllocator(firstIndexableField(objOop),
                                     byteSizeOf(objOop))) == B3D_NO_ERROR))) {
    return primitiveFail();
  }
  objOop = fetchPointerofObject(2, stateOop);
  if (!((isWords(objOop)) &&
        ((b3dInitializeAttrAllocator(firstIndexableField(objOop),
                                     byteSizeOf(objOop))) == B3D_NO_ERROR))) {
    return primitiveFail();
  }
  objOop = fetchPointerofObject(3, stateOop);
  if (!((isWords(objOop)) &&
        ((b3dInitializeAET(firstIndexableField(objOop), byteSizeOf(objOop))) ==
         B3D_NO_ERROR))) {
    return primitiveFail();
  }
  objOop = fetchPointerofObject(4, stateOop);
  if (!((isWords(objOop)) &&
        ((b3dInitializeEdgeList(firstIndexableField(objOop),
                                byteSizeOf(objOop))) == B3D_NO_ERROR))) {
    return primitiveFail();
  }
  objOop = fetchPointerofObject(5, stateOop);
  if (!((isWords(objOop)) &&
        ((b3dInitializeFillList(firstIndexableField(objOop),
                                byteSizeOf(objOop))) == B3D_NO_ERROR))) {
    return primitiveFail();
  }
  return 0;
...
b3dInitPrimitiveObject(void) {
  ...
  idxArray = stackPrimitiveIndexArrayofSizevalidateforVertexSize(3, idxSize, 1,
                                                                 vtxSize);
  if (!idxArray) {
    return primitiveFail();
  }
  ...
  /* Do the work */
  if (primitive == 3) {
    if (b3dAddPolygonObject((void *)primObj, primSize, B3D_FACE_RGB,
                            textureIndex, (B3DPrimitiveVertex *)vtxArray,
                            vtxSize, &viewport) != B3D_NO_ERROR) {
      return primitiveFail();
    }
  }
  if (primitive == 5) {
    if (b3dAddIndexedTriangleObject(
            (void *)primObj, primSize, B3D_FACE_RGB, textureIndex,
            (B3DPrimitiveVertex *)vtxArray, vtxSize, (B3DInputFace *)idxArray,
            idxSize / 3, &viewport) != B3D_NO_ERROR) {
      return primitiveFail();
    }
  }
  if (primitive == 6) {
    if (b3dAddIndexedQuadObject((void *)primObj, primSize, B3D_FACE_RGB,
                                textureIndex, (B3DPrimitiveVertex *)vtxArray,
                                vtxSize, (B3DInputQuad *)idxArray, idxSize / 4,
                                &viewport) != B3D_NO_ERROR) {
      return primitiveFail();
    }
  }
...
b3dLoadIndexArray(void) {
  ...
  srcPtr = firstIndexableField(srcArray);
  ...
  dstPtr = firstIndexableField(dstArray);
...
b3dLoadVertexBuffer(void) {
  ...
  if ((dstPtr == null) || ((defaultVtx == null) || (failed()))) {
    return primitiveFail();
  }
...
b3dOrthoNormInverseMatrix(void) {
  ...
  if (!((isWords(srcOop)) && ((slotSizeOf(srcOop)) == 16))) {
    return primitiveFail();
  }
...
b3dPrimitiveNextClippedTriangle(void) {
  ...
  idxArray = stackPrimitiveIndexArrayofSizevalidateforVertexSize(1, idxCount, 1,
                                                                 vtxCount);
  if ((vtxArray == null) || ((idxArray == null) || (failed()))) {
    return primitiveFail();
  }
  ...
  for (i = firstIndex; i <= idxCount; i += 3) {
    ...
    if (!((idx1 == 0) || ((idx2 == 0) || (idx3 == 0)))) {
      triMask = (vtxArray[(idx1 * PrimVertexSize) + PrimVtxClipFlags]) &
                ((vtxArray[(idx2 * PrimVertexSize) + PrimVtxClipFlags]) &
                 (vtxArray[(idx3 * PrimVertexSize) + PrimVtxClipFlags]));

      /* Check if tri is completely inside */
      if (!((InAllMask & triMask) == InAllMask)) {
        if (((triMask & OutAllMask) != 0)) {
          idxArray[i] = 0;
          idxArray[i + 1] = 0;
          idxArray[i + 2] = 0;
        } else {
...
b3dShadeVertexBuffer(void) {
  ...
  if ((vtxArray == null) || ((primMaterial == null) || (failed()))) {
    return primitiveFail();
  }
  ...
  for (i = 1; i <= vtxCount; i += 1) {
    ...
    for (j = 0; j < lightCount; j += 1) {
      ...
      primLight = firstIndexableField(lightOop);
      ...
      if (((lightFlags & FlagPositional) != 0)) {
        l2vDirection[0] =
            ((litVertex[PrimVtxPositionX]) - (primLight[PrimLightPositionX]));
        l2vDirection[1] =
            ((litVertex[PrimVtxPositionY]) - (primLight[PrimLightPositionY]));
        l2vDirection[2] =
            ((litVertex[PrimVtxPositionZ]) - (primLight[PrimLightPositionZ]));

        /* l2vDistance := self dotProductOf: l2vDirection with: l2vDirection. */
        l2vDistance = (((l2vDirection[0]) * (l2vDirection[0])) +
                       ((l2vDirection[1]) * (l2vDirection[1]))) +
                      ((l2vDirection[2]) * (l2vDirection[2]));
        ...
        if (((lightFlags & FlagDirectional) != 0)) {
      ...
      lightScale = 1.0;
      if (((lightFlags & FlagAttenuated) != 0)) {
        lightScale =
            1.0 /
            ((primLight[PrimLightAttenuationConstant]) +
             (l2vDistance *
              ((primLight[PrimLightAttenuationLinear]) +
               (l2vDistance * (primLight[PrimLightAttenuationSquared])))));
      }
      if (((lightFlags & FlagHasSpot) != 0)) {
        lightScale = lightScale * (computeSpotFactor());
      }

      /* Compute ambient and diffuse part only if lightScale is non-zero. */
      if (lightScale > 0.001) {
        if (((lightFlags & FlagAmbientPart) != 0)) {
          lightPart = primLight + AmbientPart;

          /* begin addPart:from:trackFlag:scale: */
          if (((vbFlags & VBTrackAmbient) != 0)) {
            ...
            rPart = (((primMaterial + AmbientPart)[0]) * (lightPart[0])) *
                    lightScale;
            gPart = (((primMaterial + AmbientPart)[1]) * (lightPart[1])) *
                    lightScale;
            bPart = (((primMaterial + AmbientPart)[2]) * (lightPart[2])) *
                    lightScale;
            aPart = (((primMaterial + AmbientPart)[3]) * (lightPart[3])) *
                    lightScale;
          }
        ...
        if (((lightFlags & FlagDiffusePart) != 0)) {
          /* begin dotProductOfFloat:withDouble: */
          cosAngle = ((((litVertex + PrimVtxNormal)[0]) * (l2vDirection[0])) +
                      (((litVertex + PrimVtxNormal)[1]) * (l2vDirection[1]))) +
                     (((litVertex + PrimVtxNormal)[2]) * (l2vDirection[2]));
          ...
          /* For two-sided lighting check if cosAngle > 0.0 meaning that it is a
           * front face */
          if (cosAngle > 0.0) {
            lightPart = primLight + DiffusePart;
            scale = lightScale * cosAngle;

            /* begin addPart:from:trackFlag:scale: */
            if (((vbFlags & VBTrackDiffuse) != 0)) {
              ...
              rPart =
                  (((primMaterial + DiffusePart)[0]) * (lightPart[0])) * scale;
              gPart =
                  (((primMaterial + DiffusePart)[1]) * (lightPart[1])) * scale;
              bPart =
                  (((primMaterial + DiffusePart)[2]) * (lightPart[2])) * scale;
              aPart =
                  (((primMaterial + DiffusePart)[3]) * (lightPart[3])) * scale;
            }
      ...
      if ((((lightFlags & FlagSpecularPart) != 0)) &&
          ((primMaterial[MaterialShininess]) > 0.0)) {
        l2vSpecDir[0] = (l2vDirection[0]);
        l2vSpecDir[1] = (l2vDirection[1]);
        l2vSpecDir[2] = (l2vDirection[2]);
        if (((vbFlags & VBUseLocalViewer) != 0)) {
          /* begin computeSpecularDirection */
          /* begin inverseLengthOfFloat: */
          scaleDouble = ((((litVertex + PrimVtxPosition)[0]) *
                          ((litVertex + PrimVtxPosition)[0])) +
                         (((litVertex + PrimVtxPosition)[1]) *
                          ((litVertex + PrimVtxPosition)[1]))) +
                        (((litVertex + PrimVtxPosition)[2]) *
                         ((litVertex + PrimVtxPosition)[2]));
          if ((scaleDouble == 0.0) || (scaleDouble == 1.0)) {
            scale = scaleDouble;
            goto l1;
          }
          scale = 1.0 / (sqrt(scaleDouble));
          /* end inverseLengthOfFloat: */
        l1:
          l2vSpecDir[0] =
              ((l2vSpecDir[0]) - ((litVertex[PrimVtxPositionX]) * scale));
          l2vSpecDir[1] =
              ((l2vSpecDir[1]) - ((litVertex[PrimVtxPositionY]) * scale));
          l2vSpecDir[2] =
              ((l2vSpecDir[2]) - ((litVertex[PrimVtxPositionZ]) * scale));
        } else {
          l2vSpecDir[2] = ((l2vSpecDir[2]) - 1.0);
        }

        /* begin dotProductOfFloat:withDouble: */
        cosAngle = ((((litVertex + PrimVtxNormal)[0]) * (l2vSpecDir[0])) +
                    (((litVertex + PrimVtxNormal)[1]) * (l2vSpecDir[1]))) +
                   (((litVertex + PrimVtxNormal)[2]) * (l2vSpecDir[2]));
        if (cosAngle > 0.0) {
          ...
          lightPart = primLight + SpecularPart;

          /* begin addPart:from:trackFlag:scale: */
          if (((vbFlags & VBTrackSpecular) != 0)) {
            rPart = ((vtxInColor[0]) * (lightPart[0])) * specularFactor;
            gPart = ((vtxInColor[1]) * (lightPart[1])) * specularFactor;
            bPart = ((vtxInColor[2]) * (lightPart[2])) * specularFactor;
            aPart = ((vtxInColor[3]) * (lightPart[3])) * specularFactor;
          } else {
            rPart = (((primMaterial + SpecularPart)[0]) * (lightPart[0])) *
                    specularFactor;
            gPart = (((primMaterial + SpecularPart)[1]) * (lightPart[1])) *
                    specularFactor;
            bPart = (((primMaterial + SpecularPart)[2]) * (lightPart[2])) *
                    specularFactor;
            aPart = (((primMaterial + SpecularPart)[3]) * (lightPart[3])) *
                    specularFactor;
          }
    ...
    (((int *)litVertex))[PrimVtxColor32] =
        (b +
         ((((usqInt)((g + ((((usqInt)((r + ((((usqInt)(a) << 8))))) << 8)))))
            << 8))));
...
b3dTransformDirection(void) {
  ...
  if (!((isWords(v3Oop)) && ((slotSizeOf(v3Oop)) == 3))) {
    return primitiveFail();
  }
  ...
  oop = stackValue(1);
  if ((isWords(oop)) && ((slotSizeOf(oop)) == 16)) {
    matrix = firstIndexableField(oop);
    goto l1;
  }
  primitiveFail();
  matrix = ((void *)null);
...
l3:
  ...
  m31 = ((float *)m3);
  for (i = 0; i <= 3; i += 1) {
    c1 = ((((m11[0]) * (m21[0])) + ((m11[1]) * (m21[4]))) +
          ((m11[2]) * (m21[8]))) +
         ((m11[3]) * (m21[12]));
    c2 = ((((m11[0]) * (m21[1])) + ((m11[1]) * (m21[5]))) +
          ((m11[2]) * (m21[9]))) +
         ((m11[3]) * (m21[13]));
    c3 = ((((m11[0]) * (m21[2])) + ((m11[1]) * (m21[6]))) +
          ((m11[2]) * (m21[10]))) +
         ((m11[3]) * (m21[14]));
    c4 = ((((m11[0]) * (m21[3])) + ((m11[1]) * (m21[7]))) +
          ((m11[2]) * (m21[11]))) +
         ((m11[3]) * (m21[15]));
...
l1:
  ...
  rz = (((x * (matrix[8])) + (y * (matrix[9]))) + (z * (matrix[10]))) +
       (matrix[11]);
  rw = (((x * (matrix[12])) + (y * (matrix[13]))) + (z * (matrix[14]))) +
       (matrix[15]);
  v3Oop = cloneObject(v3Oop);
  if (!v3Oop) {
    return primitiveFailFor(PrimErrNoMemory);
...
b3dTransformVertexBuffer(void) {
  ...
  oop = stackValue(1);
  if ((isWords(oop)) && ((slotSizeOf(oop)) == 16)) {
    projectionMatrix = firstIndexableField(oop);
    goto l1;
  }
  primitiveFail();
  projectionMatrix = ((void *)null);
  /* end stackMatrix: */
l1:
  ...
  oop = stackValue(2);
  if ((isWords(oop)) && ((slotSizeOf(oop)) == 16)) {
    modelViewMatrix = firstIndexableField(oop);
    goto l2;
  }
  primitiveFail();
  modelViewMatrix = ((void *)null);
  /* end stackMatrix: */
l2:
  vtxCount = stackIntegerValue(3);
  vtxArray = stackPrimitiveVertexArrayofSize(4, vtxCount);
  ...
  hasNormals = ((flags & VBVtxHasNormals) != 0);

  /* Check if we have to rescale the normals */
  if (hasNormals) {
    if (((mvFlags & FlagM44Identity) != 0)) {
      rescale = 0;
    } else {
  ...
  if ((((mvFlags & FlagM44NoPerspective) != 0)) && (prFlags == 0)) {
    if (mvFlags == FlagM44NoTranslation) {
      for (i = 1; i <= vtxCount; i += 1) {
        if (hasNormals) {
  ...
  if ((((mvFlags & prFlags) & FlagM44Identity) != 0)) {
    for (i = 1; i <= vtxCount; i += 1) {
  ...
  /* end transformVB:count:by:and:flags: */
l3:
  pop(5);
  return 0;
}
...
static sqInt clipPolygonBackFromtocount(int *buf1, int *buf2, sqInt n) {
  ...
  inLast = (((last[PrimVtxClipFlags]) & InBackBit) != 0);
  for (i = 1; i <= n; i += 1) {
    inNext = (((next[PrimVtxClipFlags]) & InBackBit) != 0);
    if (!(inLast == inNext)) {
      /* begin backClipValueFrom:to: */
      t = (((((float *)last))[PrimVtxRasterPosZ]) -
           ((((float *)last))[PrimVtxRasterPosW])) /
          ((((((float *)next))[PrimVtxRasterPosW]) -
            ((((float *)last))[PrimVtxRasterPosW])) -
           (((((float *)next))[PrimVtxRasterPosZ]) -
            ((((float *)last))[PrimVtxRasterPosZ])));
      outIndex += 1;
      interpolateFromtoatinto(((float *)last), ((float *)next), t,
                              ((float *)(buf2 + (outIndex * PrimVertexSize))));
    }
...
static sqInt clipPolygonBottomFromtocount(int *buf1, int *buf2, sqInt n) {
  ...
  last = buf1 + (n * PrimVertexSize);
  next = buf1 + PrimVertexSize;
  inLast = (((last[PrimVtxClipFlags]) & InBottomBit) != 0);
  for (i = 1; i <= n; i += 1) {
    inNext = (((next[PrimVtxClipFlags]) & InBottomBit) != 0);
    if (!(inLast == inNext)) {
      /* begin bottomClipValueFrom:to: */
      t = (0.0 - (((((float *)last))[PrimVtxRasterPosY]) +
                  ((((float *)last))[PrimVtxRasterPosW]))) /
          ((((((float *)next))[PrimVtxRasterPosW]) -
            ((((float *)last))[PrimVtxRasterPosW])) +
           (((((float *)next))[PrimVtxRasterPosY]) -
            ((((float *)last))[PrimVtxRasterPosY])));
      outIndex += 1;
      interpolateFromtoatinto(((float *)last), ((float *)next), t,
                              ((float *)(buf2 + (outIndex * PrimVertexSize))));
    }
...
static sqInt clipPolygonFrontFromtocount(int *buf1, int *buf2, sqInt n) {
  ...
  last = buf1 + (n * PrimVertexSize);
  next = buf1 + PrimVertexSize;
  inLast = (((last[PrimVtxClipFlags]) & InFrontBit) != 0);
  for (i = 1; i <= n; i += 1) {
    inNext = (((next[PrimVtxClipFlags]) & InFrontBit) != 0);
    if (!(inLast == inNext)) {
      /* begin frontClipValueFrom:to: */
      t = (0.0 - (((((float *)last))[PrimVtxRasterPosZ]) +
                  ((((float *)last))[PrimVtxRasterPosW]))) /
          ((((((float *)next))[PrimVtxRasterPosW]) -
            ((((float *)last))[PrimVtxRasterPosW])) +
           (((((float *)next))[PrimVtxRasterPosZ]) -
...
static sqInt clipPolygonLeftFromtocount(int *buf1, int *buf2, sqInt n) {
  ...
  last = buf1 + (n * PrimVertexSize);
  next = buf1 + PrimVertexSize;
  inLast = (((last[PrimVtxClipFlags]) & InLeftBit) != 0);
  for (i = 1; i <= n; i += 1) {
    inNext = (((next[PrimVtxClipFlags]) & InLeftBit) != 0);
    if (!(inLast == inNext)) {
      /* begin leftClipValueFrom:to: */
      t = (0.0 - (((((float *)last))[PrimVtxRasterPosX]) +
                  ((((float *)last))[PrimVtxRasterPosW]))) /
          ((((((float *)next))[PrimVtxRasterPosW]) -
            ((((float *)last))[PrimVtxRasterPosW])) +
           (((((float *)next))[PrimVtxRasterPosX]) -
            ((((float *)last))[PrimVtxRasterPosX])));
      outIndex += 1;
      interpolateFromtoatinto(((float *)last), ((float *)next), t,
                              ((float *)(buf2 + (outIndex * PrimVertexSize))));
    }
...
static sqInt clipPolygonRightFromtocount(int *buf1, int *buf2, sqInt n) {
  ...
  last = buf1 + (n * PrimVertexSize);
  next = buf1 + PrimVertexSize;
  inLast = (((last[PrimVtxClipFlags]) & InRightBit) != 0);
  for (i = 1; i <= n; i += 1) {
    inNext = (((next[PrimVtxClipFlags]) & InRightBit) != 0);
    if (!(inLast == inNext)) {
      /* begin rightClipValueFrom:to: */
      t = (((((float *)last))[PrimVtxRasterPosX]) -
           ((((float *)last))[PrimVtxRasterPosW])) /
          ((((((float *)next))[PrimVtxRasterPosW]) -
            ((((float *)last))[PrimVtxRasterPosW])) -
           (((((float *)next))[PrimVtxRasterPosX]) -
...
static sqInt clipPolygonTopFromtocount(int *buf1, int *buf2, sqInt n) {
  ...
  last = buf1 + (n * PrimVertexSize);
  next = buf1 + PrimVertexSize;
  inLast = (((last[PrimVtxClipFlags]) & InTopBit) != 0);
  for (i = 1; i <= n; i += 1) {
    inNext = (((next[PrimVtxClipFlags]) & InTopBit) != 0);
    if (!(inLast == inNext)) {
      /* begin topClipValueFrom:to: */
      t = (((((float *)last))[PrimVtxRasterPosY]) -
           ((((float *)last))[PrimVtxRasterPosW])) /
          ((((((float *)next))[PrimVtxRasterPosW]) -
            ((((float *)last))[PrimVtxRasterPosW])) -
           (((((float *)next))[PrimVtxRasterPosY]) -
...
static double computeSpotFactor(void) {
  ...
  /* Compute cos angle between direction of the spot light and direction to
   * vertex */
  /* begin dotProductOfFloat:withDouble: */
  cosAngle = ((((primLight + PrimLightDirection)[0]) * (l2vDirection[0])) +
              (((primLight + PrimLightDirection)[1]) * (l2vDirection[1]))) +
             (((primLight + PrimLightDirection)[2]) * (l2vDirection[2]));
  cosAngle = 0.0 - cosAngle;
...
static sqInt interpolateFromtoatinto(float *last, float *next, double t,
  ...
  rgbaNext = ((usqInt)(rgbaNext)) >> 8;
  delta = (((int)(nextValue - lastValue))) * t;
  newValue += (((usqInt)((((sqInt)(lastValue + delta)))) << 8));
  lastValue = rgbaLast & 0xFF;
  rgbaLast = ((usqInt)(rgbaLast)) >> 8;
  nextValue = rgbaNext & 0xFF;
  rgbaNext = ((usqInt)(rgbaNext)) >> 8;
  delta = (((int)(nextValue - lastValue))) * t;
  newValue += (((usqInt)((((sqInt)(lastValue + delta)))) << 16));
  lastValue = rgbaLast & 0xFF;
  nextValue = rgbaNext & 0xFF;
  delta = (((int)(nextValue - lastValue))) * t;
  newValue += (((usqInt)((((sqInt)(lastValue + delta)))) << 24));
...
static double inverseLengthOfDouble(double *aVector) {
  ...
  scale = (((aVector[0]) * (aVector[0])) + ((aVector[1]) * (aVector[1]))) +
          ((aVector[2]) * (aVector[2]));
...
static sqInt loadObjectsFrom(sqInt stackIndex) {
  ...
  for (i = 0; i < arraySize; i += 1) {
    ...
    objPtr = firstIndexableField(objOop);
...
static sqInt loadRasterizerState(sqInt stackIndex) {
  ...
  if (!((isPointers(stateOop)) && ((slotSizeOf(stateOop)) >= 10))) {
    return 0;
  }
...
static sqInt loadTextureinto(sqInt textureOop, B3DTexture *destPtr) {
  ...
  return b3dLoadTexture(destPtr, formWidth, formHeight, formDepth,
                        (unsigned int *)bitsPtr, 0, NULL) == B3D_NO_ERROR;
}
...
static sqInt stackLightArrayValue(sqInt stackIndex) {
  ...
  for (i = 0; i < arraySize; i += 1) {
    ...
    if (!((isWords(oop)) && ((slotSizeOf(oop)) == PrimLightSize))) {
      return primitiveFail();
    }
  }
  return array;
...
static void *stackMaterialValue(sqInt stackIndex) {
  ...
  if ((isWords(oop)) && ((slotSizeOf(oop)) == MaterialSize)) {
...
static void *stackPrimitiveVertex(sqInt index) {
  ...
  if ((isWords(oop)) && ((slotSizeOf(oop)) == PrimVertexSize)) {
    return firstIndexableField(oop);
  }
  return null;
}
...
void *Squeak3D_exports[][3] = {
    {(void *)_m, "b3dClipPolygon\000\001\000", (void *)b3dClipPolygon},
    {(void *)_m, "b3dComputeMinIndexZ\000\003\000",
     (void *)b3dComputeMinIndexZ},
    {(void *)_m, "b3dComputeMinZ\000\003\000", (void *)b3dComputeMinZ},
    {(void *)_m, "b3dDetermineClipFlags\000\001\000",
     (void *)b3dDetermineClipFlags},
    {(void *)_m, "b3dInitializeRasterizerState\000\002\000",
     (void *)b3dInitializeRasterizerState},
    {(void *)_m, "b3dInitPrimitiveObject\000\001\000",
     (void *)b3dInitPrimitiveObject},
    {(void *)_m, "b3dInplaceHouseHolderInvert\000\377\000",
     (void *)b3dInplaceHouseHolderInvert},
    {(void *)_m, "b3dLoadIndexArray\000\001\000", (void *)b3dLoadIndexArray},
    {(void *)_m, "b3dLoadVertexBuffer\000\001\000",
     (void *)b3dLoadVertexBuffer},
    {(void *)_m, "b3dMapVertexBuffer\000\001\000", (void *)b3dMapVertexBuffer},
    {(void *)_m, "b3dOrthoNormInverseMatrix\000\001\000",
     (void *)b3dOrthoNormInverseMatrix},
    {(void *)_m, "b3dPrimitiveNextClippedTriangle\000\001\000",
     (void *)b3dPrimitiveNextClippedTriangle},
    {(void *)_m, "b3dPrimitiveObjectSize\000\377\000",
     (void *)b3dPrimitiveObjectSize},
    {(void *)_m, "b3dPrimitiveTextureSize\000\377\000",
     (void *)b3dPrimitiveTextureSize},
    {(void *)_m, "b3dRasterizerVersion\000\377\000",
     (void *)b3dRasterizerVersion},
    {(void *)_m, "b3dShaderVersion\000\377\000", (void *)b3dShaderVersion},
    {(void *)_m, "b3dShadeVertexBuffer\000\001\000",
     (void *)b3dShadeVertexBuffer},
    {(void *)_m, "b3dStartRasterizer\000\377\000", (void *)b3dStartRasterizer},
    {(void *)_m, "b3dTransformDirection\000\001\000",
     (void *)b3dTransformDirection},
    {(void *)_m, "b3dTransformerVersion\000\377\000",
     (void *)b3dTransformerVersion},
    {(void *)_m, "b3dTransformMatrixWithInto\000\377\000",
     (void *)b3dTransformMatrixWithInto},
    {(void *)_m, "b3dTransformPoint\000\001\000", (void *)b3dTransformPoint},
    {(void *)_m, "b3dTransformPrimitiveNormal\000\000\000",
     (void *)b3dTransformPrimitiveNormal},
    {(void *)_m, "b3dTransformPrimitivePosition\000\377\000",
     (void *)b3dTransformPrimitivePosition},
    {(void *)_m, "b3dTransformPrimitiveRasterPosition\000\377\000",
     (void *)b3dTransformPrimitiveRasterPosition},
    {(void *)_m, "b3dTransformVertexBuffer\000\001\000",
     (void *)b3dTransformVertexBuffer},
    {(void *)_m, "b3dTransposeMatrix\000\001\000", (void *)b3dTransposeMatrix},
    {(void *)_m, "getModuleName", (void *)getModuleName},
    {(void *)_m, "initialiseModule", (void *)initialiseModule},
    {(void *)_m, "moduleUnloaded", (void *)moduleUnloaded},
    {(void *)_m, "primitiveSetBitBltPlugin\000\001\000",
...
#if SPURVM
EXPORT(signed short) b3dClipPolygonMetadata = 0x100;
EXPORT(signed short) b3dComputeMinIndexZMetadata = 0x300;
EXPORT(signed short) b3dComputeMinZMetadata = 0x300;
EXPORT(signed short) b3dDetermineClipFlagsMetadata = 0x100;
EXPORT(signed short) b3dInitializeRasterizerStateMetadata = 0x200;
EXPORT(signed short) b3dInitPrimitiveObjectMetadata = 0x100;
EXPORT(signed short) b3dLoadIndexArrayMetadata = 0x100;
EXPORT(signed short) b3dLoadVertexBufferMetadata = 0x100;
EXPORT(signed short) b3dMapVertexBufferMetadata = 0x100;
EXPORT(signed short) b3dOrthoNormInverseMatrixMetadata = 0x100;
EXPORT(signed short) b3dPrimitiveNextClippedTriangleMetadata = 0x100;
EXPORT(signed short) b3dShadeVertexBufferMetadata = 0x100;
EXPORT(signed short) b3dTransformDirectionMetadata = 0x100;
EXPORT(signed short) b3dTransformPointMetadata = 0x100;
EXPORT(signed short) b3dTransformPrimitiveNormalMetadata = 0;
EXPORT(signed short) b3dTransformVertexBufferMetadata = 0x100;
EXPORT(signed short) b3dTransposeMatrixMetadata = 0x100;
EXPORT(signed short) primitiveSetBitBltPluginMetadata = 0x100;
#endif // SPURVM
