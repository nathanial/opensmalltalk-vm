/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from
        JoystickTabletPlugin VMMaker.oscog-eem.3475 uuid:
...
static const char *moduleName =
    "JoystickTabletPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return joystickInit(); }

/*	Get information on the pen tablet attached to this machine. Fail if
   there is no tablet. If successful, the result is an array of integers; see
   the Smalltalk call on this primitive for its interpretation.
 */
...
EXPORT(sqInt)
shutdownModule(void) { return joystickShutdown(); }
...
void *JoystickTabletPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveGetTabletParameters\000\000\000",
     (void *)primitiveGetTabletParameters},
    {(void *)_m, "primitiveReadJoystick\000\000\000",
     (void *)primitiveReadJoystick},
    {(void *)_m, "primitiveReadTablet\000\000\000",
     (void *)primitiveReadTablet},
