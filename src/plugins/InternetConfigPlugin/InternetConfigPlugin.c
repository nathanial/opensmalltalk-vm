/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from
        InternetConfigPlugin VMMaker.oscog-eem.3475 uuid:
...
static const char *moduleName =
    "InternetConfigPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return sqInternetConfigurationInit(); }
...
primitiveGetMacintoshFileTypeAndCreatorFrom(void) {
  ...
  aFileName = firstIndexableField(stackValue(0));
  keyLength = byteSizeOf(((sqInt)(sqIntptr_t)(aFileName)-BaseHeaderSize));
  sqInternetGetMacintoshFileTypeAndCreatorFromkeySizeinto(aFileName, keyLength,
                                                          creator);
...
primitiveGetStringKeyedBy(void) {
  ...
  aKey = firstIndexableField(stackValue(0));
  keyLength = byteSizeOf(((sqInt)(sqIntptr_t)(aKey)-BaseHeaderSize));
  size = sqInternetConfigurationGetStringKeyedBykeySizeinto(aKey, keyLength,
                                                            aString);
...
EXPORT(sqInt)
shutdownModule(void) { return sqInternetConfigurationShutdown(); }
...
void *InternetConfigPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveGetMacintoshFileTypeAndCreatorFrom\000\000\000",
     (void *)primitiveGetMacintoshFileTypeAndCreatorFrom},
    {(void *)_m, "primitiveGetStringKeyedBy\000\000\000",
     (void *)primitiveGetStringKeyedBy},
