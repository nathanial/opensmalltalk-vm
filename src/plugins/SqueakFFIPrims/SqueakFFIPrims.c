/* Automatically generated by
        ThreadedFFIPlugin VMMaker.oscog-eem.3456 uuid:
   e316760f-1758-4b6b-aa08-f84bc7c44ef3
 */

#if defined(__ARM_ARCH_5__) || defined(__ARM_ARCH_6__) ||                      \
    defined(__ARM_ARCH_7__) || defined(__arm32__) || defined(ARM32) ||         \
    defined(_M_ARM)
...
#define ARM64AppleFFIPlugin_exports SqueakFFIPrims_exports
#include "ARM64AppleFFIPlugin.c"

#elif defined(_M_I386) || defined(_M_IX86) || defined(_X86_) ||                \
    defined(i386) || defined(i486) || defined(i586) || defined(i686) ||        \
    defined(__i386__) || defined(__386__) || defined(X86) || defined(I386)
...
#define RiscV64FFIPlugin_exports SqueakFFIPrims_exports
#include "RiscV64FFIPlugin.c"
