/* Automatically generated by
   ...
   6617a9c2-d1a4-4065-87c1-65631276475a
        (* Compiler-eem.518)
   from
        ThreadedARM32FFIPlugin VMMaker.oscog-eem.3601 uuid:
   6617a9c2-d1a4-4065-87c1-65631276475a
 */
...
static const char *moduleName =
    "ARM32FFIPlugin VMMaker.oscog-eem.3601 " INT_EXT;
static sqInt nilObj;
  ...
  if (((((calloutState->ffiArgHeader)) & FFIFlagStructure) != 0)) {
    ...
    if (ptrClass == (classExternalAddress())) {
      ...
      availableRegisterSpace =
          (NumIntRegArgs - ((calloutState->integerRegisterIndex))) * 4;
      ...
      if (availableRegisterSpace > 0) {
        if (structSize <= availableRegisterSpace) {
          ...
          if (((calloutState->currentArg)) == ((calloutState->argVector))) {
            ...
            memcpy(((void *)((&(((calloutState->integerRegisters))[(
                       calloutState->integerRegisterIndex)])))),
                   ptrAddress, availableRegisterSpace);
          } else {
      ...
      if (stackPartSize > 0) {
        ...
        memcpy((calloutState->currentArg),
               (&((((char *)ptrAddress))[availableRegisterSpace])),
               stackPartSize);
    ...
    l1:
      ...
      case 8: // ffiPushUnsigned64:in:
        if (((calloutState->integerRegisterIndex)) < (NumIntRegArgs - 1)) {
          (calloutState->integerRegisterIndex =
               (((((calloutState->integerRegisterIndex)) + 1) | 1) - 1));
          ((calloutState
                ->integerRegisters))[(calloutState->integerRegisterIndex)] =
              (((usqInt)intValue));
          ((calloutState
                ->integerRegisters))[((calloutState->integerRegisterIndex)) +
                                     1] = (((usqInt)((intValue) >> 32)));
          (calloutState->integerRegisterIndex =
               ((calloutState->integerRegisterIndex)) + 2);
        } else {
          ...
          longAtput(((calloutState->currentArg)) + BytesPerWord,
                    ((usqInt)((intValue) >> 32)));
    ...
    if (atomicType == FFITypeSingleFloat) {
      ...
      if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
        if (((calloutState->backfillFloatRegisterIndex)) > 0) {
          ((calloutState
                ->floatRegisters))[(calloutState->backfillFloatRegisterIndex)] =
              valueFloat;
      ...
      if (((calloutState->floatRegisterIndex)) < (NumFloatRegArgs - 1)) {
        if ((((calloutState->floatRegisterIndex)) & 1) == 1) {
          (calloutState->backfillFloatRegisterIndex =
               (calloutState->floatRegisterIndex));
          (calloutState->floatRegisterIndex =
               ((calloutState->floatRegisterIndex)) + 1);
        }
        (*((double *)((&(((calloutState->floatRegisters))[(
             calloutState->floatRegisterIndex)])))) = floatValue);
        (calloutState->floatRegisterIndex =
             ((calloutState->floatRegisterIndex)) + 2);
      } else {
        if ((((calloutState->currentArg)) + 8) > ((calloutState->limit))) {
          return FFIErrorCallFrameTooBig;
        }
...
l2:
  ...
  if ((((calloutState->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) ==
    ...
    (calloutState->structReturnType =
         ((calloutState->structReturnSize)) <= BytesPerWord);
  }
  err = 0;
...
l4:
  ...
  if (((calloutState->floatRegisterIndex)) > 0) {
    loadFloatRegs((*((double *)((&(((calloutState->floatRegisters))[0]))))),
                  (*((double *)((&(((calloutState->floatRegisters))[2]))))),
                  (*((double *)((&(((calloutState->floatRegisters))[4]))))),
                  (*((double *)((&(((calloutState->floatRegisters))[6]))))),
                  (*((double *)((&(((calloutState->floatRegisters))[8]))))),
                  (*((double *)((&(((calloutState->floatRegisters))[10]))))),
                  (*((double *)((&(((calloutState->floatRegisters))[12]))))),
                  (*((double *)((&(((calloutState->floatRegisters))[14]))))));
  }
  ...
  if ((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1)) {
    if (atomicType == FFITypeSingleFloat) {
      floatRet = dispatchFunctionPointerwithwithwithwith(
          ((float (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t))address),
      ...
      floatRet = dispatchFunctionPointerwithwithwithwith(
          ((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t))address),
          ((calloutState->integerRegisters))[0],
          ((calloutState->integerRegisters))[1],
          ((calloutState->integerRegisters))[2],
          ((calloutState->integerRegisters))[3]);
  ...
  intRet = dispatchFunctionPointerwithwithwithwith(
      ((usqIntptr_t (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t,
                        sqIntptr_t))address),
      ((calloutState->integerRegisters))[0],
      ((calloutState->integerRegisters))[1],
      ((calloutState->integerRegisters))[2],
  ...
  /* undo any callee argument pops because it may confuse stack management with
   * the alloca. */
  if (isCalleePopsConvention((calloutState->callFlags))) {
    setsp((calloutState->argVector));
  }
...
#endif /* SPURVM */
    memcpy(
        firstIndexableField(oopSqInt),
        ((calloutState->structReturnType) ? (&intRet) : (calloutState->limit)),
        (calloutState->structReturnSize));
    storePointerofObjectwithValue(0, retOop, oopSqInt);
    result = retOop;
    goto l5;
  ...
  if (atomicType <= FFITypeSignedInt32) {
    if (atomicType <= FFITypeSignedInt16) {
      /* # of significant bits */
    ...
    result = (((atomicType & 1) != 0) ? signed32BitIntegerFor(intRet)
