/* Automatically generated by
        VMPluginCodeGenerator VMMaker.oscog-eem.3601 uuid:
   6617a9c2-d1a4-4065-87c1-65631276475a
        (* Compiler-eem.518)
   from
        ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3601 uuid:
   6617a9c2-d1a4-4065-87c1-65631276475a
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "ThreadedX64SysVFFIPlugin VMMaker.oscog-eem.3601 uuid: "
    "6617a9c2-d1a4-4065-87c1-65631276475a " __DATE__;
#else
...
#define ThreadedFFI64Bit16ByteReturnDD SixteenByteReturnDD
#define ThreadedFFIAbstractStructReturnStruct SixteenByteReturnDD
...
#define ThreadedFFI64Bit16ByteReturnDI SixteenByteReturnDI
#define ThreadedFFIAbstractStructReturnStruct SixteenByteReturnDI
...
#define ThreadedFFI64Bit16ByteReturnID SixteenByteReturnID
#define ThreadedFFIAbstractStructReturnStruct SixteenByteReturnID
...
/*** Function Prototypes ***/
static sqInt alignmentOfStructSpecOfLengthStartingAt(unsigned int *specs,
                                                     sqInt specSize,
                                                     sqInt *indexPtr);
static sqInt checkAlignmentOfStructSpecOfLengthStartingAt(unsigned int *specs,
                                                          sqInt specSize,
                                                          sqInt startIndex);
static sqInt checkAlignmentOfUnionSpecOfLengthStartingAt(unsigned int *specs,
                                                         sqInt specSize,
                                                         sqInt startIndex);
...
static sqInt isUnionSpecOfLengthStartingAt(unsigned int *specs, sqInt specSize,
                                           sqInt startIndex);
...
static sqInt registerTypeForStructSpecsOfLength(unsigned int *specs,
                                                sqInt specSize);
static sqInt
registerTypeForStructSpecsOfLengthStartingAtByteOffsetEightbyteOffset(
    sqInt initialRegisterType, unsigned int *specs, sqInt specSize,
    sqInt *indexPtr, sqInt initialByteOffset, sqInt initialEightbyteOffset);
static sqInt
registerTypeForUnionSpecsOfLengthStartingAtByteOffsetEightbyteOffset(
    sqInt initialRegisterType, unsigned int *specs, sqInt specSize,
    sqInt *indexPtr, sqInt byteOffset, sqInt eightbyteOffset);
...
static const char *moduleName =
    "X64SysVFFIPlugin VMMaker.oscog-eem.3601 " INT_EXT;
static sqInt nilObj;
...
static sqInt alignmentOfStructSpecOfLengthStartingAt(unsigned int *specs,
  ...
  assert((spec & ((FFIFlagPointer + FFIFlagAtomic) + FFIFlagStructure)) ==
         FFIFlagStructure);
  byteAlignment = 1;
  while (1) {
    indexPtr[0] = ((indexPtr[0]) + 1);
    if (!((indexPtr[0]) < specSize))
      break;
    spec = specs[indexPtr[0]];
    ...
    thisAlignment = (((spec & FFIFlagPointer) != 0)
                         ...
                         : (((spec & FFIFlagStructure) != 0)
                                ? alignmentOfStructSpecOfLengthStartingAt(
                                      specs, specSize, indexPtr)
                                : spec & FFIStructSizeMask));
    byteAlignment =
        ((byteAlignment < thisAlignment) ? thisAlignment : byteAlignment);
  }
  assert(0);
  return byteAlignment;
}
...
static sqInt checkAlignmentOfStructSpecOfLengthStartingAt(unsigned int *specs,
  ...
  if (isUnionSpecOfLengthStartingAt(specs, specSize, index)) {
    return checkAlignmentOfUnionSpecOfLengthStartingAt(specs, specSize,
                                                       startIndex);
  }
  ...
  while (((index += 1)) < specSize) {
    ...
    if (((spec & FFIFlagPointer) != 0)) {
      ...
      if (((spec & FFIFlagStructure) != 0)) {
        if (!(checkAlignmentOfStructSpecOfLengthStartingAt(specs, specSize,
                                                           index))) {
          return 0;
        }
        fieldAlignment =
    ...
    maxAlignment =
        ((maxAlignment < fieldAlignment) ? fieldAlignment : maxAlignment);
...
static sqInt ffiArgumentSpecClassin(sqInt oop, sqInt argSpec, sqInt argClass,
  ...
  unsigned int numIntegerRegisters;
  sqInt oopClass;
  sqInt oopClassSqInt;
  ...
  if (((((calloutState->ffiArgHeader)) & FFIFlagStructure) != 0)) {
    ...
    if (ptrClass == (classExternalAddress())) {
      ...
      if (structSize <= 16) {
        registerType = registerTypeForStructSpecsOfLength(
            ((unsigned int *)argSpec1), argSpecSize);
        if (!(registerType == 6)) {
          ...
          if (structSize <= 8) {
            ...
            numIntegerRegisters =
                (((usqInt)((registerType & 2))) >> 1) + (registerType & 1);
            numDoubleRegisters = 2 - numIntegerRegisters;
          }
          if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters) <=
               NumFloatRegArgs) &&
              ((((calloutState->integerRegisterIndex)) + numIntegerRegisters) <=
               NumIntRegArgs)) {
            if (passField0InXmmReg) {
              /* begin ffiPushFloat64:in: */
              if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
                ((calloutState
                      ->floatRegisters))[(calloutState->floatRegisterIndex)] =
                    ((*((double *)ptrAddress)));
                ...
                if ((((calloutState->currentArg)) + WordSize) >
                    ((calloutState->limit))) {
                  goto l1;
                }
                floatAtput((calloutState->currentArg),
                           (*((double *)ptrAddress)));
                (calloutState->currentArg =
                     ((calloutState->currentArg)) + WordSize);
              }
            ...
            l1:;
              ...
              if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
                ...
                longAtput((calloutState->currentArg),
                          (*((long long *)ptrAddress)));
                (calloutState->currentArg =
                     ((calloutState->currentArg)) + WordSize);
              }
      ...
      /* See sec 3.2.3 of http://people.freebsd.org/~obrien/amd64-elf-abi.pdf.
         (dravft version 0.90). All of the folowing are passed in registers:
        ...
        if (structSize <= 16) {
          ...
          if (!(registerType == 6)) {
            ...
            if (((((calloutState->floatRegisterIndex)) + numDoubleRegisters) <=
                 NumFloatRegArgs) &&
                ((((calloutState->integerRegisterIndex)) +
                  numIntegerRegisters) <= NumIntRegArgs)) {
              if (passField0InXmmReg) {
                /* begin ffiPushFloat64:in: */
                if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
                  ((calloutState
  ...
  l7:
    ...
    if (atomicType == FFITypeSingleFloat) {
      ...
      if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
        ...
        /* Float passed in least significant word, but good to zero the high
         * bits for clarity. */
...
l2:
  ...
  if ((((calloutState->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) ==
    ...
    registerType = (((calloutState->structReturnSize)) <= (WordSize * 2)
                        ? registerTypeForStructSpecsOfLength(
...
l4:
  ...
  returnStructByValue =
      (((calloutState->ffiRetHeader)) & ((FFIFlagStructure + FFIFlagPointer) +
                                         FFIFlagAtomic)) == FFIFlagStructure;
  vmHandle =
  ...
  if ((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1)) {
    if (atomicType == FFITypeSingleFloat) {
      floatRet = dispatchFunctionPointerwithwithwithwithwithwith(
  ...
  if (!returnStructByValue) {
    intRet = dispatchFunctionPointerwithwithwithwithwithwith(
        ((sqInt (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t,
                    sqIntptr_t))address),
        ((calloutState->integerRegisters))[0],
        ((calloutState->integerRegisters))[1],
        ((calloutState->integerRegisters))[2],
    ...
    if (((((calloutState->ffiRetHeader)) & FFIFlagPointer) != 0)) {
      ...
      argTypes =
          fetchPointerofObject(ExternalFunctionArgTypesIndex, specLiteral);
      ...
      if (retClass == nilObj) {
        ...
        if ((((usqInt)(atomicType1)) >> 1) ==
            (((usqInt)(FFITypeSignedChar8)) >> 1)) {
          result = (!(stringForCString(((char *)retVal)))
                        ? fetchPointerofObject(PrimErrNoMemory + 1,
                                               primitiveErrorTable())
                        : stringForCString(((char *)retVal)));
          goto l5;
        }
    ...
    if (atomicType == FFITypeBool) {
      ...
      value = (byteSize == (sizeof(retVal))
                   ? retVal
                   : retVal &
                         ((((((unsigned long long)1)) << (byteSize * 8))) - 1));
    ...
    if (atomicType <= FFITypeSignedInt32) {
      ...
      result = (((atomicType & 1) != 0) ? signed64BitIntegerFor(retVal)
                                        : positive64BitIntegerFor(retVal));
      goto l5;
    }
    if ((((usqInt)(atomicType)) >> 1) ==
        (((usqInt)(FFITypeSignedInt64)) >> 1)) {
      result = (((atomicType & 1) != 0) ? signed64BitIntegerFor(retVal)
                                        : positive64BitIntegerFor(retVal));
      goto l5;
    }
  ...
  switch (registerType) {
  case 0:
    sddRet = dispatchFunctionPointerwithwithwithwithwithwith(
        ((SixteenByteReturnDD (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t,
                                  sqIntptr_t, sqIntptr_t, sqIntptr_t))address),
        ((calloutState->integerRegisters))[0],
        ((calloutState->integerRegisters))[1],
        ((calloutState->integerRegisters))[2],
        ((calloutState->integerRegisters))[3],
  ...
  case 1:
    sidRet = dispatchFunctionPointerwithwithwithwithwithwith(
        ((SixteenByteReturnID (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t,
                                  sqIntptr_t, sqIntptr_t, sqIntptr_t))address),
        ((calloutState->integerRegisters))[0],
        ((calloutState->integerRegisters))[1],
        ((calloutState->integerRegisters))[2],
    ...
    break;
  case 2:
    sdiRet = dispatchFunctionPointerwithwithwithwithwithwith(
        ((SixteenByteReturnDI (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t,
                                  sqIntptr_t, sqIntptr_t, sqIntptr_t))address),
        ((calloutState->integerRegisters))[0],
        ((calloutState->integerRegisters))[1],
        ((calloutState->integerRegisters))[2],
    ...
    break;
  case 3:
    siiRet = dispatchFunctionPointerwithwithwithwithwithwith(
  ...
  case 4:
    floatRet = dispatchFunctionPointerwithwithwithwithwithwith(
        ((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t,
                     sqIntptr_t))address),
        ((calloutState->integerRegisters))[0],
        ((calloutState->integerRegisters))[1],
        ((calloutState->integerRegisters))[2],
...
#endif /* SPURVM */
  memcpy(firstIndexableField(oopSqInt), sRetPtr,
         (calloutState->structReturnSize));
  storePointerofObjectwithValue(0, retOop, oopSqInt);
  result = retOop;
...
/*	Answer with a number characterizing the register type for passing a
   struct of size <= 16 bytes. The bit at offset i of registerType is set to 1
   if eightbyte at offset i is a int register (RAX ...) The bit at offset 2
   indicates if there is a single eightbyte (struct size
        <= 8)
...
static sqInt registerTypeForStructSpecsOfLength(unsigned int *specs,
  ...
  registerType = (byteSize <= 8 ? 4 : 0);
  return (
      isUnionSpecOfLengthStartingAt(specs, specSize, 0)
          ? registerTypeForUnionSpecsOfLengthStartingAtByteOffsetEightbyteOffset(
                registerType, specs, specSize, (&index), 0, 0)
          : registerTypeForStructSpecsOfLengthStartingAtByteOffsetEightbyteOffset(
                registerType, specs, specSize, (&index), 0, 0));
}

/*	Answer with a number characterizing the register type for passing a
   struct of size <= 16 bytes. On input, the index points to the structure
   header (the one with FFIFlagStructure + structSize) On output, the index
   points to the structure trailer (the FFIFlagStructure).
 */
    ...
    if (spec == FFIFlagStructure) {
      ...
      if (((spec & FFIFlagPointer) != 0)) {
        ...
        case FFIFlagStructure:
          fieldSize = 0;
          subIndex = indexPtr[0];
          alignment = alignmentOfStructSpecOfLengthStartingAt(specs, specSize,
                                                              (&subIndex));
      ...
      if (byteOffset & (alignment - 1)) {
        byteOffset =
            (((byteOffset | (alignment - 1)) - (alignment - 1))) + alignment;
      }
      ...
      /* If this eightbyte contains an int field, then we must use an int
       * register */
      if (recurse) {
        registerType =
            registerTypeForUnionSpecsOfLengthStartingAtByteOffsetEightbyteOffset(
                registerType, specs, specSize, indexPtr, byteOffset,
                eightbyteOffset);
      }

      /* union in structs require a recursive form, because we handle
         byteOffset/eightbyteOffset differently where to put the next field? */
...
/*	Answer with a number characterizing the register type for passing a
   union of size <= 16 bytes. On input, the index points to the structure header
   (the one with FFIFlagStructure + structSize) On output, the index points to
   the structure trailer (the FFIFlagStructure).
 */
  ...
  while (1) {
    ...
    if (spec == FFIFlagStructure) {
      ...
      if (((spec & FFIFlagPointer) != 0)) {
        ...
        case FFIFlagStructure:
          recurse =
              !(isUnionSpecOfLengthStartingAt(specs, specSize, indexPtr[0]));
          if (!recurse) {
            subLevel += 1;
          }
          break;
