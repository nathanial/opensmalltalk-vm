/* Automatically generated by
   ...
   fe32aec6-a1d5-4e6a-814c-287d3f6467ab (Compiler-eem.520) from
        ThreadedRiscV64FFIPlugin VMMaker.oscog-eem.3658 uuid:
...
static const char *moduleName =
    "RiscV64FFIPlugin VMMaker.oscog-eem.3658 " INT_EXT;
static sqInt nilObj;
  ...
  l2:
    ...
    if (atomicType == FFITypeSingleFloat) {
      ...
      if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
        (*((long *)((&(((calloutState->floatRegisters))[(
        ...
        if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
          ((calloutState
                ->integerRegisters))[(calloutState->integerRegisterIndex)] = -1;
          singleFloatAtput((&(((calloutState->integerRegisters))[(
                               calloutState->integerRegisterIndex)])),
                           valueFloat);
          (calloutState->integerRegisterIndex =
               ((calloutState->integerRegisterIndex)) + 1);
      ...
      /* Note: this is a 'memcopy', so size is preserved. Casting to #double
         changes the size Use integer register if available */
      return 0;
    } else {
      ...
      if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
        ...
        if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
          floatAtput((&(((calloutState->integerRegisters))[(
                         calloutState->integerRegisterIndex)])),
                     floatValue);
          (calloutState->integerRegisterIndex =
               ((calloutState->integerRegisterIndex)) + 1);
  ...
  if ((((usqInt)(atomicType)) >> 1) == (((usqInt)(FFITypeSingleFloat)) >> 1)) {
    if (atomicType == FFITypeDoubleFloat) {
      doubleRet = dispatchFunctionPointerwithwithwithwithwithwithwithwith(
          ((double (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t,
                       sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t))address),
      ...
      doubleRet = dispatchFunctionPointerwithwithwithwithwithwithwithwith(
          ((float (*)(sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t,
                      sqIntptr_t, sqIntptr_t, sqIntptr_t, sqIntptr_t))address),
          ((calloutState->integerRegisters))[0],
          ((calloutState->integerRegisters))[1],
          ((calloutState->integerRegisters))[2],
