/* Automatically generated by
   ...
   6617a9c2-d1a4-4065-87c1-65631276475a
        (* Compiler-eem.518)
   from
        ThreadedX64Win64FFIPlugin VMMaker.oscog-eem.3601 uuid:
   6617a9c2-d1a4-4065-87c1-65631276475a
 */
...
#define ThreadedFFICalloutStateForX64Win64 CalloutState
...
static const char *moduleName =
    "X64Win64FFIPlugin VMMaker.oscog-eem.3601 " INT_EXT;
static sqInt nilObj;
...
static sqInt ffiArgumentSpecClassin(sqInt oop, sqInt argSpec, sqInt argClass,
  ...
  if (((((calloutState->ffiArgHeader)) & FFIFlagStructure) != 0)) {
    ...
    if (ptrClass == (classExternalAddress())) {
       ...
       */
      if ((structSize <= WordSize) && ((structSize & (structSize - 1)) == 0)) {
        memcpy((&arg), ptrAddress, structSize);

        /* begin ffiPushUnsigned64:in: */
        if (((calloutState->integerRegisterIndex)) < NumIntRegArgs) {
          ...
          longAtput((calloutState->currentArg), arg);
          (calloutState->currentArg = ((calloutState->currentArg)) + WordSize);
        }
        return 0;
      }

      /* BUG!! This memory should be 16-byte aligned; Spur guarantees only
       * 8-byte alignment. */
    ...
    if (ptrClass == (classByteArray())) {
      ...
      if (!(((((calloutState->ffiArgHeader)) & FFIFlagPointer) != 0))) {
         ...
         * https://docs.microsoft.com/en-us/cpp/build/x64-calling-convention?view=vs-2019
         */
        if ((structSize <= WordSize) &&
            ((structSize & (structSize - 1)) == 0)) {
          memcpy((&arg), ptrAddress, structSize);
  ...
  l2:
    ...
    if (atomicType == FFITypeSingleFloat) {
      ...
      if (((calloutState->floatRegisterIndex)) < NumFloatRegArgs) {
        ...
        (calloutState->floatRegisterSignature) =
            ((calloutState->floatRegisterSignature)) +
            (1U << ((calloutState->floatRegisterIndex)));
        (calloutState->integerRegisterIndex) =
            ((calloutState->floatRegisterIndex) =
...
l2:
  ...
  if ((((calloutState->ffiRetHeader)) & (FFIFlagPointer | FFIFlagStructure)) ==
    ...
    (calloutState->structReturnType = /* canReturnInRegistersStructOfSize: */
     (((calloutState->structReturnSize)) <= WordSize) &&
     ((((calloutState->structReturnSize)) &
       (((calloutState->structReturnSize)) - 1)) == 0));
  }
  err = 0;
  ...
  vmHandle =
      disownVM(/* disownFlagsFor: */
               (((((calloutState->callFlags)) & FFICallFlagThreaded) != 0)
                    ...
                    : DisownVMForFFICall));
  if (((calloutState->floatRegisterSignature)) > 0) {
...
void *X64Win64FFIPlugin_exports[][3] = {
