...
#if SPURVM
EXPORT(signed short) primitiveCompareStringMetadata = 0x101;
EXPORT(signed short) primitiveCompressToByteArrayMetadata = 515;
EXPORT(signed short) primitiveConvert8BitSignedMetadata = 259;
EXPORT(signed short) primitiveDecompressFromByteArrayMetadata = 515;
EXPORT(signed short) primitiveFindFirstInStringMetadata = 0x101;
EXPORT(signed short) primitiveFindSubstringMetadata = 0x101;
EXPORT(signed short) primitiveIndexOfAsciiInStringMetadata = 0x101;
EXPORT(signed short) primitiveStringHashMetadata = 0x101;
EXPORT(signed short) primitiveTranslateStringWithTableMetadata = 0x101;
#endif // SPURVM
