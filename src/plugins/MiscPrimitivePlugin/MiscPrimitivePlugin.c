...
primitiveCompressToByteArray(void)
{
	...
	for (jSqInt = 0; jSqInt <= 3; jSqInt += 1) {
		ba[(iSqInt + 1) + jSqInt] = ((((usqInt)(size)) >> ((3 - jSqInt) * 8)) & 0xFF);
	}
	i = (iSqInt + 1) + 4;
	/* end encodeInt:in:at: */
l1:
	...
	while (k < size) {
		...
		if (j > k) {
			if (eqBytes) {
				...
				/* begin encodeBytesOf:in:at: */
				for (jSqInt = 0; jSqInt <= 3; jSqInt += 1) {
					ba[(i + 1) + jSqInt] = ((((usqInt)(((((j - k) + 1) * 4) + 1))) >> ((3 - jSqInt) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
				/* end encodeInt:in:at: */
l2:
				...
				/* begin encodeBytesOf:in:at: */
				for (jSqInt = 0; jSqInt <= 3; jSqInt += 1) {
					ba[(i + 1) + jSqInt] = ((((usqInt)(((((j - k) + 1) * 4) + 2))) >> ((3 - jSqInt) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
				/* end encodeInt:in:at: */
l3:
			...
			if (eqBytes) {
				...
				/* begin encodeBytesOf:in:at: */
				for (jSqInt = 0; jSqInt <= 3; jSqInt += 1) {
					ba[(i + 1) + jSqInt] = ((((usqInt)((5))) >> ((3 - jSqInt) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
				/* end encodeInt:in:at: */
l4:
				...
				/* begin encodeBytesOf:in:at: */
				for (jSqInt = 0; jSqInt <= 3; jSqInt += 1) {
					ba[(i + 1) + jSqInt] = ((((usqInt)((((j - k) * 4) + 3))) >> ((3 - jSqInt) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
				/* end encodeInt:in:at: */
l5:
				for (m = k; m < j; m += 1) {
					/* begin encodeBytesOf:in:at: */
					for (jSqInt = 0; jSqInt <= 3; jSqInt += 1) {
						ba[i + jSqInt] = ((((usqInt)((bm[m]))) >> ((3 - jSqInt) * 8)) & 0xFF);
					}
					i += 4;
				}
				k = j;
...
primitiveFindSubstring(void)
{
	...
	if (((keySize = sizeOfSTArrayFromCPrimitive(key))) > 0) {
		...
		/* the sizeOfSTArrayFromCPrimitive:'s fail for e.g. CompiledMethod */
		for (startIndex = start; startIndex <= ((bodySize - 1) - keySize); startIndex += 1) {
			index = 0;
...
void* MiscPrimitivePlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveCompareString\000\001\001", (void*)primitiveCompareString},
	{(void*)_m, "primitiveCompressToByteArray\000\002\003", (void*)primitiveCompressToByteArray},
	{(void*)_m, "primitiveConvert8BitSigned\000\001\003", (void*)primitiveConvert8BitSigned},
	{(void*)_m, "primitiveDecompressFromByteArray\000\002\003", (void*)primitiveDecompressFromByteArray},
	{(void*)_m, "primitiveFindFirstInString\000\001\001", (void*)primitiveFindFirstInString},
	{(void*)_m, "primitiveFindSubstring\000\001\001", (void*)primitiveFindSubstring},
	{(void*)_m, "primitiveIndexOfAsciiInString\000\001\001", (void*)primitiveIndexOfAsciiInString},
	{(void*)_m, "primitiveStringHash\000\001\001", (void*)primitiveStringHash},
	{(void*)_m, "primitiveTranslateStringWithTable\000\001\001", (void*)primitiveTranslateStringWithTable},
