...
#if SPURVM
EXPORT(signed short) primitiveChangeModeMetadata = 0;
EXPORT(signed short) primitiveChangeOwnerMetadata = 0;
EXPORT(signed short) primitiveClosedirMetadata = 0x100;
EXPORT(signed short) primitiveFileAttributeMetadata = 0;
EXPORT(signed short) primitiveFileAttributesMetadata = 0;
EXPORT(signed short) primitiveFileExistsMetadata = 0;
EXPORT(signed short) primitiveOpendirMetadata = 0;
EXPORT(signed short) primitivePlatToStPathMetadata = 0;
EXPORT(signed short) primitiveReaddirMetadata = 0x100;
EXPORT(signed short) primitiveRewinddirMetadata = 0x100;
EXPORT(signed short) primitiveStToPlatPathMetadata = 0;
EXPORT(signed short) primitiveSymlinkChangeOwnerMetadata = 0;
#endif // SPURVM
