...
static const char *moduleName = "BochsIA32Plugin Cog-eem.472 " INT_EXT;
...
primitiveIntegerRegisterState(void) {
  ...
  if ((byteSizeOf(registerStateVector)) !=
      (NumIntegerRegisterStateFields *
       (sizeof(int /* integerRegisterElementType */)))) {
