/* Automatically generated by
   ...
   89cfcf0e-7f62-4687-b4a0-b2e75c471fd9 (Compiler-eem.513) from
        JPEGReadWriter2Plugin VMMaker.oscog-eem.3509 uuid:
   89cfcf0e-7f62-4687-b4a0-b2e75c471fd9
 */
...
static const char *moduleName =
    "JPEGReadWriter2Plugin VMMaker.oscog-eem.3509 " INT_EXT;
...
primImageHeight(void) {
  j_decompress_ptr aJPEGDecompressStruct;

  if (!(isBytes(stackValue(0)))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
  aJPEGDecompressStruct = firstIndexableField(stackValue(0));

  /* Various parameter checks */
  if (!((byteSizeOf(
            ((sqInt)(sqIntptr_t)(aJPEGDecompressStruct)-BaseHeaderSize))) >=
        (sizeof(struct jpeg_decompress_struct)))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
  methodReturnInteger((aJPEGDecompressStruct->image_height));
  return 0;
}
...
primImageNumComponents(void) {
  ...
  methodReturnInteger((aJPEGDecompressStruct->num_components));
  return 0;
}
...
primImageWidth(void) {
  ...
  methodReturnInteger((aJPEGDecompressStruct->image_width));
  return 0;
}
...
primJPEGCompressStructSize(void) {
  methodReturnInteger(sizeof(struct jpeg_compress_struct));
  return null;
}
...
primJPEGDecompressStructSize(void) {
  methodReturnInteger(sizeof(struct jpeg_decompress_struct));
  return null;
}
...
primJPEGErrorMgr2StructSize(void) {
  methodReturnInteger(sizeof(struct error_mgr2));
  return null;
}
...
primJPEGPluginIsPresent(void) {
  methodReturnValue(((1) ? trueObject() : falseObject()));
  return null;
}
...
primJPEGReadHeaderfromByteArrayerrorMgr(void) {
  unsigned char *aJPEGDecompressStruct;
  unsigned char *aJPEGErrorMgr2Struct;
  unsigned char *source;
  sqInt sourceSize;

  if (!((isBytes(stackValue(2))) &&
        ((isBytes(stackValue(1))) && (isBytes(stackValue(0)))))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
  aJPEGDecompressStruct = firstIndexableField(stackValue(2));
  source = firstIndexableField(stackValue(1));
  aJPEGErrorMgr2Struct = firstIndexableField(stackValue(0));
  ...
  if (!(((byteSizeOf(
         ...
         (sizeof(struct jpeg_decompress_struct))) &&
        ((byteSizeOf(
             ((sqInt)(sqIntptr_t)(aJPEGErrorMgr2Struct)-BaseHeaderSize))) >=
         (sizeof(struct error_mgr2))))) {
    return primitiveFail();
  }
  sourceSize = byteSizeOf(((sqInt)(sqIntptr_t)(source)-BaseHeaderSize));
  if (sourceSize > 0) {
    primJPEGReadHeaderfromByteArraysizeerrorMgrReadHeader(
        aJPEGDecompressStruct, source, sourceSize, aJPEGErrorMgr2Struct);
  }
  if (!(failed())) {
    pop(3);
  }
...
primJPEGReadImagefromByteArrayonFormdoDitheringerrorMgr(void) {
  ...
  aJPEGDecompressStruct = firstIndexableField(stackValue(4));
  source = firstIndexableField(stackValue(3));
  form = stackValue(2);
  ...
  formComponents = (formDepth != 8 ? 4 : 1);
  formComponentBitSize = (formDepth != 16 ? 8 : 4);
  ...
  primJPEGReadImagefromByteArrayonFormdoDitheringerrorMgrReadScanlines(
      aJPEGDecompressStruct, aJPEGErrorMgr2Struct, source, sourceSize,
      ditherFlag, formBitmap, pixelsPerWord, wordsPerRow, formNativeDepth);
  if (!(failed())) {
    pop(5);
  }
  return null;
...
EXPORT(sqInt)
primJPEGWriteImageonByteArrayformqualityprogressiveJPEGerrorMgr(void) {
  unsigned char *aJPEGCompressStruct;
  unsigned char *aJPEGErrorMgr2Struct;
  ...
  aJPEGCompressStruct = firstIndexableField(stackValue(5));
  destination = firstIndexableField(stackValue(4));
  form = stackValue(3);
  ...
  /* Various parameter checks */
  if (!(((byteSizeOf(
             ((sqInt)(sqIntptr_t)(aJPEGCompressStruct)-BaseHeaderSize))) >=
  ...
  if (destinationSize > 0) {
    primJPEGWriteImageonByteArrayformqualityprogressiveJPEGerrorMgrWriteScanlines(
        formWidth, formHeight, formNativeDepth, formBitmap, aJPEGCompressStruct,
        aJPEGErrorMgr2Struct, quality, progressiveFlag, pixelsPerWord,
        wordsPerRow, destination, (&destinationSize));
  }
  if (!(failed())) {
    methodReturnValue(integerObjectOf(destinationSize));
  }
  return null;
}
...
void *JPEGReadWriter2Plugin_exports[][3] = {
    ...
    {(void *)_m, "primImageNumComponents\000\000\000",
     (void *)primImageNumComponents},
    {(void *)_m, "primImageWidth\000\000\000", (void *)primImageWidth},
    {(void *)_m, "primJPEGCompressStructSize\000\377\000",
     (void *)primJPEGCompressStructSize},
    {(void *)_m, "primJPEGDecompressStructSize\000\377\000",
     (void *)primJPEGDecompressStructSize},
    {(void *)_m, "primJPEGErrorMgr2StructSize\000\377\000",
     (void *)primJPEGErrorMgr2StructSize},
    {(void *)_m, "primJPEGPluginIsPresent\000\377\000",
     (void *)primJPEGPluginIsPresent},
    {(void *)_m, "primJPEGReadHeaderfromByteArrayerrorMgr\000\000\000",
     (void *)primJPEGReadHeaderfromByteArrayerrorMgr},
    {(void *)_m,
     "primJPEGReadImagefromByteArrayonFormdoDitheringerrorMgr\000\002\000",
     (void *)primJPEGReadImagefromByteArrayonFormdoDitheringerrorMgr},
    {(void *)_m,
     "primJPEGWriteImageonByteArrayformqualityprogressiveJPEGerrorMgr\000\002"
     "\000",
     (void *)primJPEGWriteImageonByteArrayformqualityprogressiveJPEGerrorMgr},
    {(void *)_m, "primSupports8BitGrayscaleJPEGs\000\377\000",
     (void *)primSupports8BitGrayscaleJPEGs},
...
EXPORT(signed short)
primJPEGReadImagefromByteArrayonFormdoDitheringerrorMgrMetadata = 0x200;
EXPORT(signed short)
primJPEGWriteImageonByteArrayformqualityprogressiveJPEGerrorMgrMetadata = 0x200;
#endif // SPURVM
