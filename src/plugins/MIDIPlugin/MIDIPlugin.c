/* Automatically generated by
   ...
   89cfcf0e-7f62-4687-b4a0-b2e75c471fd9 (Compiler-eem.513) from MIDIPlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "MIDIPlugin VMMaker.oscog-eem.3509 uuid: "
...
static const char *moduleName = "MIDIPlugin VMMaker.oscog-eem.3509 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return midiInit(); }
...
/*	Return the value of the MIDI clock as a SmallInteger. The range is
   limited to SmallInteger maxVal / 2 to allow scheduling MIDI events into the
   future without overflowing a SmallInteger. The sqMIDIGetClock function is
   assumed to wrap at or before 16r20000000.
 */
...
EXPORT(sqInt)
shutdownModule(void) { return midiShutdown(); }
...
void *MIDIPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveMIDIClosePort\000\000\000",
     (void *)primitiveMIDIClosePort},
    {(void *)_m, "primitiveMIDIGetClock\000\377\000",
     (void *)primitiveMIDIGetClock},
    {(void *)_m, "primitiveMIDIGetPortCount\000\377\000",
     (void *)primitiveMIDIGetPortCount},
    {(void *)_m, "primitiveMIDIGetPortDirectionality\000\000\000",
     (void *)primitiveMIDIGetPortDirectionality},
    {(void *)_m, "primitiveMIDIGetPortName\000\000\000",
     (void *)primitiveMIDIGetPortName},
    {(void *)_m, "primitiveMIDIOpenPort\000\000\000",
     (void *)primitiveMIDIOpenPort},
    {(void *)_m, "primitiveMIDIParameterGet\000\000\000",
     (void *)primitiveMIDIParameterGet},
    {(void *)_m, "primitiveMIDIParameterGetOrSet\000\000\000",
     (void *)primitiveMIDIParameterGetOrSet},
    {(void *)_m, "primitiveMIDIParameterSet\000\000\000",
     (void *)primitiveMIDIParameterSet},
