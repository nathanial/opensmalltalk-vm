/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from
        KlattSynthesizerPlugin VMMaker.oscog-eem.3475 uuid:
...
static const char *moduleName = "Klatt VMMaker.oscog-eem.3475 " INT_EXT;
static sqInt nmod;
static sqInt nopen;
static sqInt nper;
...
static float parallelFrictionBranch(float source) {
  return ((((resonatorvalue(R2fp, source)) - (resonatorvalue(R3fp, source))) +
           (resonatorvalue(R4fp, source))) -
          (resonatorvalue(R5fp, source))) +
         (resonatorvalue(R6fp, source));
}
...
static float parallelVoicedBranch(float source) {
  return (((((resonatorvalue(R1vp, source)) + (resonatorvalue(R2vp, source))) +
            (resonatorvalue(R3vp, source))) +
           (resonatorvalue(R4vp, source))) +
          (resonatorvalue(Rnpp, source))) +
         (resonatorvalue(Rtpp, source));
}
...
l2:
  ...
  while (index <= top) {
    ...
    if (nper >= t0) {
      ...
      if ((frame[F0]) > 0) {
        ...
        deltaF0 = ((((frame[Flutter]) * 2.0) * (frame[F0])) / 100.0) *
                  ((asin + bsin) + csin);
        pitch += deltaF0;

        /* begin addJitter */
        pitch += ((((nextRandom()) - 0x7FFF) * (frame[Jitter])) / 32768.0) *
                 (frame[F0]);
        if (periodCount % 2) {
        ...
        if (qzero > 0) {
          ...
          expuphi = exp(ub * phi);
          qb = (expuphi *
                ((((rphid * ((ub * ub) + 1.0)) + ub) * sinphi) - cosphi)) +
               1.0;
          while (qb > 0) {
            ua = ub;
            qa = qb;
          ...
          expuphi = exp(ua * phi);
          qa = (expuphi *
                ((((rphid * ((ua * ua) + 1.0)) + ua) * sinphi) - cosphi)) +
               1.0;
          qb = qzero;
          while (qa < 0) {
            ub = ua;
        ...
        while ((ub - ua) > Epsilon) {
          ...
          expuphi = exp(uc * phi);
          qc = (expuphi *
                ((((rphid * ((uc * uc) + 1.0)) + uc) * sinphi) - cosphi)) +
               1.0;
          if (qc > 0) {
            ua = uc;
            qa = qc;
        ...
        /* Add shimmer and diplophonia amplitude pertirbations.
           (This must be done AFTER the actual computation of the LF
           parameters.) */
  ...
  l4:
    ...
    answerDouble = (((resonatorA(Rnz)) * glotout) +
                    ((resonatorB(Rnz)) * ((p1Double = resonatorP1(Rnz))))) +
                   ((resonatorC(Rnz)) * (resonatorP2(Rnz)));
    ...
    answerFloat = (((resonatorA(Rnpc)) * outFloat) +
                   ((resonatorB(Rnpc)) * ((p1Float = resonatorP1(Rnpc))))) +
                  ((resonatorC(Rnpc)) * (resonatorP2(Rnpc)));
    ...
    /* begin antiResonator:value: */
    answerDouble = (((resonatorA(Rtz)) * outFloat) +
                    ((resonatorB(Rtz)) * ((p1Double = resonatorP1(Rtz))))) +
                   ((resonatorC(Rtz)) * (resonatorP2(Rtz)));
    aFloatFloat = p1Double;
    ...
    /* begin resonator:value: */
    answerFloat = (((resonatorA(Rtpc)) * outFloat) +
                   ((resonatorB(Rtpc)) * ((p1Float = resonatorP1(Rtpc))))) +
                  ((resonatorC(Rtpc)) * (resonatorP2(Rtpc)));
    ...
    if (cascade >= 8) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R8c)) * outFloat) +
                     ((resonatorB(R8c)) * ((p1Float = resonatorP1(R8c))))) +
                    ((resonatorC(R8c)) * (resonatorP2(R8c)));
    ...
    if (cascade >= 7) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R7c)) * outFloat) +
                     ((resonatorB(R7c)) * ((p1Float = resonatorP1(R7c))))) +
                    ((resonatorC(R7c)) * (resonatorP2(R7c)));
    ...
    if (cascade >= 6) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R6c)) * outFloat) +
                     ((resonatorB(R6c)) * ((p1Float = resonatorP1(R6c))))) +
                    ((resonatorC(R6c)) * (resonatorP2(R6c)));
    ...
    if (cascade >= 5) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R5c)) * outFloat) +
                     ((resonatorB(R5c)) * ((p1Float = resonatorP1(R5c))))) +
                    ((resonatorC(R5c)) * (resonatorP2(R5c)));
    ...
    if (cascade >= 4) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R4c)) * outFloat) +
                     ((resonatorB(R4c)) * ((p1Float = resonatorP1(R4c))))) +
                    ((resonatorC(R4c)) * (resonatorP2(R4c)));
    ...
    if (cascade >= 3) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R3c)) * outFloat) +
                     ((resonatorB(R3c)) * ((p1Float = resonatorP1(R3c))))) +
                    ((resonatorC(R3c)) * (resonatorP2(R3c)));
    ...
    if (cascade >= 2) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R2c)) * outFloat) +
                     ((resonatorB(R2c)) * ((p1Float = resonatorP1(R2c))))) +
                    ((resonatorC(R2c)) * (resonatorP2(R2c)));
    ...
    if (cascade >= 1) {
      /* begin resonator:value: */
      answerFloat = (((resonatorA(R1c)) * outFloat) +
                     ((resonatorB(R1c)) * ((p1Float = resonatorP1(R1c))))) +
                    ((resonatorC(R1c)) * (resonatorP2(R1c)));
  ...
  l3:
    ...
    /* begin resonator:value: */
    answer = (((resonatorA(Rout)) * out) +
              ((resonatorB(Rout)) * ((p1 = resonatorP1(Rout))))) +
             ((resonatorC(Rout)) * (resonatorP2(Rout)));
...
static float resonatorA(sqInt index) { return resonators[(index * 5) - 5]; }

/* KlattSynthesizerPlugin>>#resonatorB: */
static float resonatorB(sqInt index) { return resonators[(index * 5) - 4]; }

/* KlattSynthesizerPlugin>>#resonatorC: */
static float resonatorC(sqInt index) { return resonators[(index * 5) - 3]; }

/* KlattSynthesizerPlugin>>#resonatorP1: */
static float resonatorP1(sqInt index) { return resonators[(index * 5) - 2]; }

/* KlattSynthesizerPlugin>>#resonatorP2: */
static float resonatorP2(sqInt index) { return resonators[(index * 5) - 1]; }
...
static float resonatorvalue(sqInt index, float aFloat) {
  ...
  answer = (((resonatorA(index)) * aFloat) +
            ((resonatorB(index)) * ((p1 = resonatorP1(index))))) +
           ((resonatorC(index)) * (resonatorP2(index)));
...
void *Klatt_exports[][3] = {
    ...
    {(void *)_m, "primitiveSynthesizeFrameIntoStartingAt\000\001\000",
     (void *)primitiveSynthesizeFrameIntoStartingAt},
