/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from JPEGReaderPlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "JPEGReaderPlugin VMMaker.oscog-eem.3475 uuid: "
...
static const char *moduleName =
    "JPEGReaderPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
static sqInt colorComponentfrom(int *aColorComponent, sqInt oop) {
  ...
  aColorComponent[BlockWidthIndex] =
      (fetchIntegerofObject(BlockWidthIndex, oop));
  aColorComponent[MCUWidthIndex] = (fetchIntegerofObject(MCUWidthIndex, oop));
  aColorComponent[PriorDCValueIndex] =
      (fetchIntegerofObject(PriorDCValueIndex, oop));
  return !(failed());
}
...
primitiveColorConvertGrayscaleMCU(void) {
  ...
  if (!((isWords(arrayOop)) && ((slotSizeOf(arrayOop)) == 3))) {
    return primitiveFail();
  }
  ...
  for (i = 0; i < jpegBitsSize; i += 1) {
    ...
    y = ((y < 1) ? 1 : y);
    jpegBits[i] =
        (((0xFF000000U + ((((usqInt)(y) << 16)))) + ((((usqInt)(y) << 8)))) +
         y);
  }
  pop(4);
  return 0;
...
primitiveColorConvertMCU(void) {
  ...
  jpegBits = firstIndexableField(arrayOop);
  arrayOop = stackValue(3);
  if (!((isPointers(arrayOop)) && ((slotSizeOf(arrayOop)) == 3))) {
    return primitiveFail();
  }
  ...
  for (i = 0; i < jpegBitsSize; i += 1) {
    ...
    blockIndexSqInt =
        (((((usqInt)(dyInt)) >> 3)) * (cbComponent[BlockWidthIndex])) +
        ((((usqInt)(dxInt)) >> 3));
    ...
    blockIndex1 =
        (((((usqInt)(dyInt)) >> 3)) * (crComponent[BlockWidthIndex])) +
        ((((usqInt)(dxInt)) >> 3));
    ...
    red = ((red < 1) ? 1 : red);
    green = ((y - ((FIXn0n34414 * cb) / 0x10000)) -
             ((FIXn0n71414 * cr) / 0x10000)) +
            (residuals[GreenIndex]);
    ...
    blue = ((blue < 1) ? 1 : blue);
    jpegBits[i] = (((0xFF000000U + (((((usqInt)(red) << 16))))) +
                    (((((usqInt)(green) << 8))))) +
                   blue);
  }
  pop(4);
...
primitiveDecodeMCU(void) {
  ...
  if (!((isWords(arrayOop)) && ((slotSizeOf(arrayOop)) == DCTSize2))) {
    return primitiveFail();
  }
  ...
  byte = yComponent[PriorDCValueIndex] =
      ((yComponent[PriorDCValueIndex]) + byte);
  anArray[0] = byte;
...
l5:
  ...
  storeIntegerofObjectwithValue(PriorDCValueIndex, stackValue(3),
                                yComponent[PriorDCValueIndex]);
  pop(5);
  return 0;
}
...
void *JPEGReaderPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveColorConvertGrayscaleMCU\000\003\000",
     (void *)primitiveColorConvertGrayscaleMCU},
    {(void *)_m, "primitiveColorConvertMCU\000\004\000",
