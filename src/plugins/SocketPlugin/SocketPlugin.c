/* Automatically generated by
        SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.3509 uuid:
   89cfcf0e-7f62-4687-b4a0-b2e75c471fd9 (Compiler-eem.513) from SocketPlugin
   VMMaker.oscog-eem.3509 uuid: 89cfcf0e-7f62-4687-b4a0-b2e75c471fd9
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "SocketPlugin VMMaker.oscog-eem.3509 uuid: "
    "89cfcf0e-7f62-4687-b4a0-b2e75c471fd9 " __DATE__;
#else
...
static const char *moduleName = "SocketPlugin VMMaker.oscog-eem.3509 " INT_EXT;
...
static sqInt intToNetAddress(sqInt addr) {
  ...
  naPtr = firstIndexableField(netAddressOop);
...
primitiveHasSocketAccess(void) {
  ...
  /* If the security plugin can be loaded, use it to check .
     If not, assume it's ok */
  _return_value = (sHSAfn == 0) || (((sqInt (*)(void))sHSAfn)());
  if (!(failed())) {
...
primitiveResolverError(void) {
  ...
  _return_value = sqResolverError();
  if (!(failed())) {
    methodReturnInteger(_return_value);
  }
  return null;
}
...
primitiveResolverGetAddressInfo(void) {
  ...
  if (!(failed())) {
    ...
    sqResolverGetAddressInfoHostSizeServiceSizeFlagsFamilyTypeProtocol(
        hostName, hostSize, servName, servSize, flags, family, type, protocol);
  }
  if (!(failed())) {
    pop(6);
  }
...
primitiveResolverStartAddressLookup(void) {
  ...
  sz = byteSizeOf(
      ((sqInt)(sqIntptr_t)((((unsigned char *)address))) - BaseHeaderSize));
  if (!(sz == 4)) {
    addr = primitiveFail();
    goto l1;
  }
  addr = ((((((unsigned char *)address))[3]) +
           ((((usqInt)(((((unsigned char *)address))[2])) << 8)))) +
          ((((usqInt)(((((unsigned char *)address))[1])) << 16)))) +
         ((((usqInt)(((*((unsigned char *)address)))) << 24)));
  /* end netAddressToInt: */
l1:
  if (!(failed())) {
...
primitiveSocketAccept(void) {
  ...
  if (!(failed())) {
    socketOop =
        instantiateClassindexableSize(classByteArray(), sizeof(SQSocket));

    s = socketValueOf(socketOop);
    if (!(failed())) {
      sqSocketAcceptFromRecvBytesSendBytesSemaID(s, serverSocket, recvBufSize,
                                                 sendBufSize, semaIndex);
      if (!(failed())) {
  ...
  if (!(failed())) {
    ...
    if (!(failed())) {
      sqSocketAcceptFromRecvBytesSendBytesSemaIDReadSemaIDWriteSemaID(
          s, serverSocket, recvBufSize, sendBufSize, semaIndex, aReadSema,
          aWriteSema);
      if (!(failed())) {
        methodReturnValue(socketOop);
      }
...
primitiveSocketAddressGetPort(void) {
  ...
  addrBase = firstIndexableField(addr);
  if (!(failed())) {
...
primitiveSocketCreate(void) {
  ...
  if (!(failed())) {
    sqSocketCreateNetTypeSocketTypeRecvBytesSendBytesSemaID(
        s, netType, socketType, recvBufSize, sendBufSize, semaIndex);
    if (!(failed())) {
      methodReturnValue(socketOop);
    }
    return null;
...
primitiveSocketCreate3Semaphores(void) {
  ...
  if (!(failed())) {
    sqSocketCreateNetTypeSocketTypeRecvBytesSendBytesSemaIDReadSemaIDWriteSemaID(
        s, netType, socketType, recvBufSize, sendBufSize, semaIndex, aReadSema,
        aWriteSema);
    if (!(failed())) {
      methodReturnValue(socketOop);
    }
...
primitiveSocketCreateRAW(void) {
  ...
  if (!(failed())) {
    sqSocketCreateRawProtoTypeRecvBytesSendBytesSemaIDReadSemaIDWriteSemaID(
        s, netType, protoType, recvBufSize, sendBufSize, semaIndex, aReadSema,
        aWriteSema);
    if (!(failed())) {
      methodReturnValue(socketOop);
    }
...
primitiveSocketGetOptions(void) {
  ...
  returnedValue = 0;
  errorCode = sqSocketGetOptionsoptionNameStartoptionNameSizereturnedValue(
      s, ((char *)(firstIndexableField(optionName))), byteSizeOf(optionName),
      (&returnedValue));
...
primitiveSocketListenOnPortBacklogInterface(void) {
  ...
  /* begin netAddressToInt: */
  sz = byteSizeOf(
      ((sqInt)(sqIntptr_t)((((unsigned char *)ifAddr))) - BaseHeaderSize));
  if (!(sz == 4)) {
    addr = primitiveFail();
    goto l1;
  }
  addr = ((((((unsigned char *)ifAddr))[3]) +
           ((((usqInt)(((((unsigned char *)ifAddr))[2])) << 8)))) +
          ((((usqInt)(((((unsigned char *)ifAddr))[1])) << 16)))) +
         ((((usqInt)(((*((unsigned char *)ifAddr)))) << 24)));
  /* end netAddressToInt: */
l1:
  if (!(failed())) {
...
primitiveSocketReceiveDataBufCount(void) {
  ...
  if (!((isWordsOrBytes(array)) &&
        ((elementSize > 0) &&
         ((startIndex >= 1) && ((count >= 0) && (((startIndex + count) - 1) <=
                                                 (slotSizeOf(array)))))))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
  ...
  if (!(failed())) {
    ...
    bytesReceived = sqSocketReceiveDataBufCount(
        s, arrayBase + ((startIndex - 1) * elementSize), count * elementSize);
    if (!(failed())) {
...
primitiveSocketReceiveUDPDataBufCount(void) {
  ...
  bytesReceived = sqSocketReceiveUDPDataBufCountaddressportmoreFlag(
      s, arrayBase + ((startIndex - 1) * elementSize), count * elementSize,
      (&address), (&port), (&moreFlag));
  ...
  storePointerofObjectwithValue(3, results,
                                (moreFlag ? trueObject() : falseObject()));
  if (!(failed())) {
    methodReturnValue(results);
  }
  return null;
...
primitiveSocketSendDataBufCount(void) {
  ...
  if (!(failed())) {
    arrayBase = firstIndexableField(array);
    bytesSent = sqSocketSendDataBufCount(
        s, arrayBase + ((startIndex - 1) * elementSize), count * elementSize);
  }
...
primitiveSocketSendUDPDataBufCount(void) {
  ...
  /* begin netAddressToInt: */
  sz = byteSizeOf(
      ((sqInt)(sqIntptr_t)((((unsigned char *)hostAddress))) - BaseHeaderSize));
  if (!(sz == 4)) {
  ...
  hostAddressInteger =
      ((((((unsigned char *)hostAddress))[3]) +
        ((((usqInt)(((((unsigned char *)hostAddress))[2])) << 8)))) +
       ((((usqInt)(((((unsigned char *)hostAddress))[1])) << 16)))) +
      ((((usqInt)(((*((unsigned char *)hostAddress)))) << 24)));
  /* end netAddressToInt: */
l1:
  if (!(failed())) {
    arrayBase = firstIndexableField(array);
    bytesSent = sqSockettoHostportSendDataBufCount(
        s, hostAddressInteger, portNumber,
        arrayBase + ((startIndex - 1) * elementSize), count * elementSize);
  }
...
/*	THIS BADLY NEEDS TO BE REWRITTEN TO TAKE Booleans AND Integers AS WELL
   AS (OR INSTEAD OF) Strings. It is only used with booleans and integers and
   parsing these back out of strings in
...
primitiveSocketSetOptions(void) {
  ...
  s = socketValueOf(socket);
  success((isBytes(optionName)) && (isBytes(optionValue)));
  if (failed()) {
    return null;
  }
  returnedValue = 0;
  errorCode =
      sqSocketSetOptionsoptionNameStartoptionNameSizeoptionValueStartoptionValueSizereturnedValue(
          s, ((char *)(firstIndexableField(optionName))),
          byteSizeOf(optionName), ((char *)(firstIndexableField(optionValue))),
          byteSizeOf(optionValue), (&returnedValue));
  results = instantiateClassindexableSize(classArray(), 2);
  storeIntegerofObjectwithValue(0, results, errorCode);
  storeIntegerofObjectwithValue(1, results, returnedValue);
  if (!(failed())) {
...
EXPORT(sqInt)
shutdownModule(void) { return socketShutdown(); }
...
void *SocketPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveDisableSocketAccess\000\377\000",
     (void *)primitiveDisableSocketAccess},
    {(void *)_m, "primitiveHasSocketAccess\000\377\000",
     (void *)primitiveHasSocketAccess},
    {(void *)_m, "primitiveInitializeNetwork\000\000\000",
     (void *)primitiveInitializeNetwork},
    {(void *)_m, "primitiveResolverAbortLookup\000\377\000",
     (void *)primitiveResolverAbortLookup},
    {(void *)_m, "primitiveResolverAddressLookupResult\000\377\000",
     (void *)primitiveResolverAddressLookupResult},
    {(void *)_m, "primitiveResolverError\000\377\000",
     (void *)primitiveResolverError},
    {(void *)_m, "primitiveResolverGetAddressInfo\000\000\000",
     (void *)primitiveResolverGetAddressInfo},
    {(void *)_m, "primitiveResolverGetAddressInfoFamily\000\377\000",
     (void *)primitiveResolverGetAddressInfoFamily},
    {(void *)_m, "primitiveResolverGetAddressInfoNext\000\377\000",
     (void *)primitiveResolverGetAddressInfoNext},
    {(void *)_m, "primitiveResolverGetAddressInfoProtocol\000\377\000",
     (void *)primitiveResolverGetAddressInfoProtocol},
    {(void *)_m, "primitiveResolverGetAddressInfoResult\000\000\000",
     (void *)primitiveResolverGetAddressInfoResult},
    {(void *)_m, "primitiveResolverGetAddressInfoSize\000\377\000",
     (void *)primitiveResolverGetAddressInfoSize},
    {(void *)_m, "primitiveResolverGetAddressInfoType\000\377\000",
     (void *)primitiveResolverGetAddressInfoType},
    {(void *)_m, "primitiveResolverGetNameInfo\000\001\000",
     (void *)primitiveResolverGetNameInfo},
    {(void *)_m, "primitiveResolverGetNameInfoHostResult\000\000\000",
     (void *)primitiveResolverGetNameInfoHostResult},
    {(void *)_m, "primitiveResolverGetNameInfoHostSize\000\377\000",
     (void *)primitiveResolverGetNameInfoHostSize},
    {(void *)_m, "primitiveResolverGetNameInfoServiceResult\000\000\000",
     (void *)primitiveResolverGetNameInfoServiceResult},
    {(void *)_m, "primitiveResolverGetNameInfoServiceSize\000\377\000",
     (void *)primitiveResolverGetNameInfoServiceSize},
    {(void *)_m, "primitiveResolverHostNameResult\000\000\000",
     (void *)primitiveResolverHostNameResult},
    {(void *)_m, "primitiveResolverHostNameSize\000\377\000",
     (void *)primitiveResolverHostNameSize},
    {(void *)_m, "primitiveResolverLocalAddress\000\377\000",
     (void *)primitiveResolverLocalAddress},
    {(void *)_m, "primitiveResolverNameLookupResult\000\377\000",
     (void *)primitiveResolverNameLookupResult},
    {(void *)_m, "primitiveResolverStartAddressLookup\000\000\000",
     (void *)primitiveResolverStartAddressLookup},
    {(void *)_m, "primitiveResolverStartNameLookup\000\000\000",
     (void *)primitiveResolverStartNameLookup},
    {(void *)_m, "primitiveResolverStatus\000\377\000",
     (void *)primitiveResolverStatus},
    {(void *)_m, "primitiveSocketAbortConnection\000\001\000",
     (void *)primitiveSocketAbortConnection},
    {(void *)_m, "primitiveSocketAccept\000\001\000",
     (void *)primitiveSocketAccept},
    {(void *)_m, "primitiveSocketAccept3Semaphores\000\001\000",
     (void *)primitiveSocketAccept3Semaphores},
    {(void *)_m, "primitiveSocketAddressGetPort\000\001\000",
     (void *)primitiveSocketAddressGetPort},
    {(void *)_m, "primitiveSocketAddressSetPort\000\001\000",
     (void *)primitiveSocketAddressSetPort},
    {(void *)_m, "primitiveSocketBindTo\000\001\000",
     (void *)primitiveSocketBindTo},
    {(void *)_m, "primitiveSocketBindToPort\000\001\000",
     (void *)primitiveSocketBindToPort},
    {(void *)_m, "primitiveSocketCloseConnection\000\001\000",
     (void *)primitiveSocketCloseConnection},
    {(void *)_m, "primitiveSocketConnectionStatus\000\001\000",
     (void *)primitiveSocketConnectionStatus},
    {(void *)_m, "primitiveSocketConnectTo\000\001\000",
     (void *)primitiveSocketConnectTo},
    {(void *)_m, "primitiveSocketConnectToPort\000\001\000",
     (void *)primitiveSocketConnectToPort},
    {(void *)_m, "primitiveSocketCreate\000\000\000",
     (void *)primitiveSocketCreate},
    {(void *)_m, "primitiveSocketCreate3Semaphores\000\000\000",
     (void *)primitiveSocketCreate3Semaphores},
    {(void *)_m, "primitiveSocketCreateRAW\000\000\000",
     (void *)primitiveSocketCreateRAW},
    {(void *)_m, "primitiveSocketDestroy\000\001\000",
     (void *)primitiveSocketDestroy},
    {(void *)_m, "primitiveSocketError\000\001\000",
     (void *)primitiveSocketError},
    {(void *)_m, "primitiveSocketGetOptions\000\001\000",
     (void *)primitiveSocketGetOptions},
    {(void *)_m, "primitiveSocketListenOnPort\000\001\000",
     (void *)primitiveSocketListenOnPort},
    {(void *)_m, "primitiveSocketListenOnPortBacklog\000\001\000",
     (void *)primitiveSocketListenOnPortBacklog},
    {(void *)_m, "primitiveSocketListenOnPortBacklogInterface\000\001\000",
     (void *)primitiveSocketListenOnPortBacklogInterface},
    {(void *)_m, "primitiveSocketListenWithBacklog\000\001\000",
     (void *)primitiveSocketListenWithBacklog},
    {(void *)_m, "primitiveSocketListenWithOrWithoutBacklog\000\001\000",
     (void *)primitiveSocketListenWithOrWithoutBacklog},
    {(void *)_m, "primitiveSocketLocalAddress\000\001\000",
     (void *)primitiveSocketLocalAddress},
    {(void *)_m, "primitiveSocketLocalAddressResult\000\001\000",
     (void *)primitiveSocketLocalAddressResult},
    {(void *)_m, "primitiveSocketLocalAddressSize\000\001\000",
     (void *)primitiveSocketLocalAddressSize},
    {(void *)_m, "primitiveSocketLocalPort\000\001\000",
     (void *)primitiveSocketLocalPort},
    {(void *)_m, "primitiveSocketReceiveDataAvailable\000\001\000",
     (void *)primitiveSocketReceiveDataAvailable},
    {(void *)_m, "primitiveSocketReceiveDataBufCount\000\001\000",
     (void *)primitiveSocketReceiveDataBufCount},
    {(void *)_m, "primitiveSocketReceiveUDPDataBufCount\000\001\000",
     (void *)primitiveSocketReceiveUDPDataBufCount},
    {(void *)_m, "primitiveSocketRemoteAddress\000\001\000",
     (void *)primitiveSocketRemoteAddress},
    {(void *)_m, "primitiveSocketRemoteAddressResult\000\001\000",
     (void *)primitiveSocketRemoteAddressResult},
    {(void *)_m, "primitiveSocketRemoteAddressSize\000\001\000",
     (void *)primitiveSocketRemoteAddressSize},
    {(void *)_m, "primitiveSocketRemotePort\000\001\000",
     (void *)primitiveSocketRemotePort},
    {(void *)_m, "primitiveSocketSendDataBufCount\000\001\000",
     (void *)primitiveSocketSendDataBufCount},
    {(void *)_m, "primitiveSocketSendDone\000\001\000",
     (void *)primitiveSocketSendDone},
    {(void *)_m, "primitiveSocketSendUDPDataBufCount\000\001\000",
     (void *)primitiveSocketSendUDPDataBufCount},
    {(void *)_m, "primitiveSocketSetOptions\000\001\000",
     (void *)primitiveSocketSetOptions},
...
EXPORT(signed short) primitiveResolverGetAddressInfoMetadata = 0;
EXPORT(signed short) primitiveResolverGetAddressInfoResultMetadata = 0;
EXPORT(signed short) primitiveResolverGetNameInfoMetadata = 0x100;
EXPORT(signed short) primitiveResolverGetNameInfoHostResultMetadata = 0;
EXPORT(signed short) primitiveResolverGetNameInfoServiceResultMetadata = 0;
EXPORT(signed short) primitiveResolverHostNameResultMetadata = 0;
EXPORT(signed short) primitiveResolverStartAddressLookupMetadata = 0;
EXPORT(signed short) primitiveResolverStartNameLookupMetadata = 0;
...
EXPORT(signed short)
primitiveSocketListenOnPortBacklogInterfaceMetadata = 0x100;
