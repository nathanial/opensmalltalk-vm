/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from
        Float64ArrayPlugin VMMaker.oscog-eem.3475 uuid:
...
static const char *moduleName =
    "Float64ArrayPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
/*	Primitive. Add the receiver and the argument, both Float64Arrays and
...
primitiveAddFloat64Array(void) {
  ...
  arg = stackValue(0);
  rcvr = stackValue(1);
  if (!((isLong64s(arg)) && ((isLong64s(rcvr)) && (((length = stSizeOf(arg))) ==
                                                   (stSizeOf(rcvr)))))) {
...
primitiveAt(void) {
  ...
  rcvr = stackValue(1);
  if (!((!(failed())) && ((isLong64s(rcvr)) &&
                          ((index > 0) && (index <= (slotSizeOf(rcvr))))))) {
    return primitiveFail();
  }
  doublePtr = firstIndexableField(rcvr);
...
primitiveAtPut(void) {
  ...
  value = stackValue(0);
  floatValue = (isIntegerObject(value) ? ((double)(integerValueOf(value)))
                                       : floatValueOf(value));
...
/*	Primitive. Divide each element in the receiver by the corresponding
        element in the argument, both Float64Arrays, and store the result into
   the receiver.
 */
...
/*	Primitive. Divide each element in the receiver by the argument, a
   scalar, and store the result into the receiver, a Float64Array
 */
...
/*	Primitive. Compute the dot product of the receiver and the argument,
   both Float64Arrays. The dot product is defined as the sum of the products of
...
primitiveEqual(void) {
  ...
  arg = stackValue(0);
  rcvr = stackValue(1);
  if (!((isLong64s(arg)) && (isLong64s(rcvr)))) {
    return primitiveFail();
  }
...
/*	Primitive. Multiply the receiver and the argument, both Float64Arrays
...
/*	Primitive. Multiply elements in the receiver, a Float64Array, by
   argument, a scalar value, and store the result into the receiver.
 */
...
/*	Primitive. Subtract each element in the argument from each element in
   the receiver, both Float64Arrays and store the result into the receiver.
 */
...
/*	Primitive. Subtract the argument, a scalar value from each element in
   the receiver, a Float64Array */
...
void *Float64ArrayPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveAddFloat64Array\000\001\003",
     (void *)primitiveAddFloat64Array},
    ...
    {(void *)_m, "primitiveDivFloat64Array\000\001\003",
     (void *)primitiveDivFloat64Array},
    {(void *)_m, "primitiveDivScalar\000\001\003", (void *)primitiveDivScalar},
    {(void *)_m, "primitiveDotProduct\000\001\003",
     (void *)primitiveDotProduct},
    {(void *)_m, "primitiveEqual\000\001\003", (void *)primitiveEqual},
    {(void *)_m, "primitiveFromFloatArray\000\001\003",
     (void *)primitiveFromFloatArray},
    {(void *)_m, "primitiveHashArray\000\001\003", (void *)primitiveHashArray},
    {(void *)_m, "primitiveLength\000\001\003", (void *)primitiveLength},
    {(void *)_m, "primitiveMulFloat64Array\000\001\003",
     (void *)primitiveMulFloat64Array},
    ...
    {(void *)_m, "primitiveSubFloat64Array\000\001\003",
     (void *)primitiveSubFloat64Array},
