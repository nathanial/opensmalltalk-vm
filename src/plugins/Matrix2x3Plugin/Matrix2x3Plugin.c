/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from Matrix2x3Plugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "Matrix2x3Plugin VMMaker.oscog-eem.3475 uuid: "
...
static sqInt roundAndStoreResultRectx0y0x1y1(sqInt dstOop, double x0, double y0,
                                             double x1, double y1);
...
static const char *moduleName =
    "Matrix2x3Plugin VMMaker.oscog-eem.3475 " INT_EXT;
...
primitiveComposeMatrix(void) {
  ...
  if (!((isWords(matrix)) && ((slotSizeOf(matrix)) == 6))) {
    primitiveFail();
    m3 = null;
    goto l1;
  }
  m3 = firstIndexableField(matrix);
...
primitiveInvertPoint(void) {
  ...
  matrixSqInt = stackValue(1);

  /* begin loadArgumentMatrix: */
  if (!((isWords(matrixSqInt)) && ((slotSizeOf(matrixSqInt)) == 6))) {
    primitiveFail();
    matrix = null;
    goto l1;
  }
  matrix = firstIndexableField(matrixSqInt);
  /* end loadArgumentMatrix: */
l1:
  if (failed()) {
    return null;
  ...
  if (!(failed())) {
    ...
    m23ResultY += 0.5;
    if (!((/* okayIntValue: */
           (m23ResultX >= (((double)(MinSmallInteger)))) &&
    ...
    popthenPush(
        2, makePointwithxValueyValue(((sqInt)m23ResultX), ((sqInt)m23ResultY)));
...
primitiveInvertRectInto(void) {
  ...
  /* end loadArgumentMatrix: */
l1:
  if (!((matrix) && (((fetchClassOf(srcOop)) == (fetchClassOf(dstOop))) &&
                     ((isPointers(srcOop)) && ((slotSizeOf(srcOop)) == 2))))) {
    return primitiveFail();
  }
...
l1:
  if (!(failed())) {
    methodReturnBool(((((((matrix[0]) == (1.0f)) && ((matrix[1]) == (0.0f))) &&
                        ((matrix[2]) == (0.0f))) &&
                       ((matrix[3]) == (0.0f))) &&
                      ((matrix[4]) == (1.0f))) &&
                     ((matrix[5]) == (0.0f)));
...
l1:
  if (!(failed())) {
    ...
    m23ResultX =
        ((m23ArgX * (matrix[0])) + (m23ArgY * (matrix[1]))) + (matrix[2]);
    m23ResultY =
        ((m23ArgX * (matrix[3])) + (m23ArgY * (matrix[4]))) + (matrix[5]);
...
void *Matrix2x3Plugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveComposeMatrix\000\001\000",
     (void *)primitiveComposeMatrix},
    {(void *)_m, "primitiveInvertPoint\000\001\000",
     (void *)primitiveInvertPoint},
    {(void *)_m, "primitiveInvertRectInto\000\002\000",
     (void *)primitiveInvertRectInto},
    {(void *)_m, "primitiveIsIdentity\000\001\000",
     (void *)primitiveIsIdentity},
    {(void *)_m, "primitiveIsPureTranslation\000\001\000",
     (void *)primitiveIsPureTranslation},
    {(void *)_m, "primitiveTransformPoint\000\001\000",
     (void *)primitiveTransformPoint},
    {(void *)_m, "primitiveTransformRectInto\000\002\000",
     (void *)primitiveTransformRectInto},
...
#if SPURVM
EXPORT(signed short) primitiveComposeMatrixMetadata = 0x100;
EXPORT(signed short) primitiveInvertPointMetadata = 0x100;
EXPORT(signed short) primitiveInvertRectIntoMetadata = 0x200;
EXPORT(signed short) primitiveIsIdentityMetadata = 0x100;
EXPORT(signed short) primitiveIsPureTranslationMetadata = 0x100;
EXPORT(signed short) primitiveTransformPointMetadata = 0x100;
EXPORT(signed short) primitiveTransformRectIntoMetadata = 0x200;
#endif // SPURVM
