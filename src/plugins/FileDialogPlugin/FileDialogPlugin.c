/* Automatically generated by
   ...
   1a32964f-d425-4ed5-b830-6e8ce3d98688
        (* Compiler-eem.518)
   from
        FileDialogPlugin VMMaker.oscog-eem.3599 uuid:
   1a32964f-d425-4ed5-b830-6e8ce3d98688
 */
...
static const char *moduleName =
    "FileDialogPlugin VMMaker.oscog-eem.3599 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return fileDialogInitialize(); }
...
l2:
  ...
  /* inSmalltalk: filterPattern */
  methodReturnReceiver();
  return 0;
}

/*	Primitive. Reap the return value from the dialog callback.
        This is unimplemented (stubbed out) on all current platforms and so it
   is obsolete.
 */
...
/*	Primitive. Hide/destroy the file dialog after it is done.
        ...
        Notes: This primitive may fail if the dialog wasn't completed and
   platform doesn't support destroying existing dialogs. Generally it is assumed
   that the dialog has been closed by the user before calling this method. */
...
primitiveFileDialogDoneSemaphore(void) {
  ...
  /* inSmalltalk: semaIndex */
  methodReturnReceiver();
  return 0;
}

/*	Primitive. Get the current filter index from one of the previously
   chosen filters. Arguments: dlgHandle: Handle for the file dialog. Return
   value: Filter index. */
...
/*	Primitive. Retrieve the result of the file dialog.
        Arguments:
        dlgHandle:	Handle of the file dialog.
        Return value: Array of strings for multiSelect, String for chosen file
   if not multiSelect, or nil if canceled */
...
primitiveFileDialogGetResult(void) {
  ...
  dlgHandle = ((int)(positive32BitValueOf(stackValue(0))));
  if (!(failed())) {
    if ((results = fileDialogGetResults(dlgHandle))) {
...
/*	Primitive. Set the callback semaphore to be used for running modal
        dialogs. This is unimplemented (stubbed out) on all current platforms
   and so it is obsolete. */
...
/*	Primitive. Set the current filter index from one of the previously
   chosen filters. Arguments: dlgHandle: Handle for the file dialog. index:
   Current filter index. Return value: Nothing. */
...
void *FileDialogPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveFileDialogAddFilter\000\000\000",
     (void *)primitiveFileDialogAddFilter},
    {(void *)_m, "primitiveFileDialogCallbackReturn\000\377\000",
     (void *)primitiveFileDialogCallbackReturn},
    {(void *)_m, "primitiveFileDialogCreate\000\377\000",
     (void *)primitiveFileDialogCreate},
    {(void *)_m, "primitiveFileDialogDestroy\000\377\000",
     (void *)primitiveFileDialogDestroy},
    {(void *)_m, "primitiveFileDialogDone\000\377\000",
     (void *)primitiveFileDialogDone},
    {(void *)_m, "primitiveFileDialogDoneSemaphore\000\000\000",
     (void *)primitiveFileDialogDoneSemaphore},
    {(void *)_m, "primitiveFileDialogGetFilterIndex\000\377\000",
     (void *)primitiveFileDialogGetFilterIndex},
    {(void *)_m, "primitiveFileDialogGetResult\000\377\000",
     (void *)primitiveFileDialogGetResult},
    {(void *)_m, "primitiveFileDialogSetCallbackSemaphore\000\377\000",
     (void *)primitiveFileDialogSetCallbackSemaphore},
    {(void *)_m, "primitiveFileDialogSetFile\000\000\000",
     (void *)primitiveFileDialogSetFile},
    {(void *)_m, "primitiveFileDialogSetFilterIndex\000\000\000",
     (void *)primitiveFileDialogSetFilterIndex},
    {(void *)_m, "primitiveFileDialogSetLabel\000\000\000",
     (void *)primitiveFileDialogSetLabel},
    {(void *)_m, "primitiveFileDialogSetProperty\000\000\000",
     (void *)primitiveFileDialogSetProperty},
    {(void *)_m, "primitiveFileDialogShow\000\000\000",
     (void *)primitiveFileDialogShow},
    {(void *)_m, "primitiveGetFileLocation\000\000\000",
     (void *)primitiveGetFileLocation},
