    ...
    while (((deltaX -= 1)) != 0) {
      ...
      if (srcAlpha == 0xFF) {
        ...
        if (srcAlpha) {
          ...
          /* begin dither32To16:threshold: */
          addThresholdSqInt = (((sqInt)((usqInt)(ditherThreshold) << 8)));
          sourceWord = ((
              unsigned int)(((((((usqInt)((
                                     dither8Lookup[addThresholdSqInt +
                                                   (((((usqInt)(sourceWord)) >>
                                                      16)) &
                                                    0xFF)]))
                                 << 10)))) +
          ...
          /* begin dstLongAt: */
          assert((((usqInt)dstIndex)) < endOfDestination);
          dstValueSqInt = long32At((void *)(dstIndex));
          dstValueSqInt = dstValueSqInt & dstMask;
          dstValueSqInt = dstValueSqInt | sourceWord;

          /* dstLongAt:put: */
          long32Atput((void *)(dstIndex), dstValueSqInt);
        }
      }
