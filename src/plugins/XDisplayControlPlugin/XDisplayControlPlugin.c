/* Automatically generated by
        VMPluginCodeGenerator * VMMaker.oscog-eem.3545 uuid:
   94bd3515-6be5-45a4-a50b-5b012dae3a34 (Compiler-eem.514) from
        XDisplayControlPlugin
   VMConstruction-Plugins-XDisplayControlPlugin.oscog-eem.20 uuid:
   8f957df8-42a6-437b-b6a2-f9f954360ef0
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "XDisplayControlPlugin "
    "VMConstruction-Plugins-XDisplayControlPlugin.oscog-eem.20 uuid: "
    "8f957df8-42a6-437b-b6a2-f9f954360ef0 " __DATE__;
#else
...
static const char *moduleName =
    "XDisplayControlPlugin "
    "VMConstruction-Plugins-XDisplayControlPlugin.oscog-eem.20 " INT_EXT;
...
EXPORT(sqInt)
moduleUnloaded(char *aModuleName) { return 0; }
...
/*	Call an internal function which will disconnect the X display session.
   The actual Squeak window on the X server is not effected, but this instance
   of Squeak will not have any further interaction with it.
 */
/*	Do not allow this if running in secure mode */
...
/*	Call an internal function to disconnect the X display session and
   destroy the Squeak window on the X display. */
/*	Do not allow this if running in secure mode */
...
void *XDisplayControlPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveCanConnectToDisplay\000\001\000",
     (void *)primitiveCanConnectToDisplay},
    {(void *)_m, "primitiveDisconnectDisplay\000\377\000",
     (void *)primitiveDisconnectDisplay},
    {(void *)_m, "primitiveFlushDisplay\000\377\000",
     (void *)primitiveFlushDisplay},
    {(void *)_m, "primitiveGetDisplayName\000\377\000",
     (void *)primitiveGetDisplayName},
    {(void *)_m, "primitiveIsConnectedToDisplay\000\377\000",
     (void *)primitiveIsConnectedToDisplay},
    {(void *)_m, "primitiveKillDisplay\000\377\000",
     (void *)primitiveKillDisplay},
    {(void *)_m, "primitiveModuleName\000\377\000",
     (void *)primitiveModuleName},
    {(void *)_m, "primitiveOpenDisplay\000\377\000",
     (void *)primitiveOpenDisplay},
    {(void *)_m, "primitiveSetDisplayName\000\001\000",
     (void *)primitiveSetDisplayName},
...
#if SPURVM
EXPORT(signed short) primitiveCanConnectToDisplayMetadata = 0x100;
EXPORT(signed short) primitiveSetDisplayNameMetadata = 0x100;
#endif // SPURVM
