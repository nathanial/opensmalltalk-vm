/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from SecurityPlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "SecurityPlugin VMMaker.oscog-eem.3475 uuid: "
...
EXPORT(sqInt)
secCanOpenAsyncFileOfSizeWritable(char *fileName, sqInt fileNameSize,
                                  sqInt writeFlag);
EXPORT(sqInt)
secCanOpenFileOfSizeWritable(char *fileName, sqInt fileNameSize,
                             sqInt writeFlag);
...
static const char *moduleName =
    "SecurityPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return ioInitSecurity(); }
...
EXPORT(sqInt)
secCanRenameImage(void) { return ioCanRenameImage(); }
...
EXPORT(sqInt)
secCanWriteImage(void) { return ioCanWriteImage(); }
...
EXPORT(sqInt)
secDisableFileAccess(void) { return ioDisableFileAccess(); }

/* SecurityPlugin>>#secDisableSocketAccess */
EXPORT(sqInt)
secDisableSocketAccess(void) { return ioDisableSocketAccess(); }

/* SecurityPlugin>>#secHasEnvironmentAccess */
EXPORT(sqInt)
secHasEnvironmentAccess(void) { return ioHasEnvironmentAccess(); }

/* SecurityPlugin>>#secHasFileAccess */
EXPORT(sqInt)
secHasFileAccess(void) { return ioHasFileAccess(); }

/* SecurityPlugin>>#secHasSocketAccess */
EXPORT(sqInt)
secHasSocketAccess(void) { return ioHasSocketAccess(); }
...
void *SecurityPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveCanWriteImage\000\377\000",
     (void *)primitiveCanWriteImage},
    {(void *)_m, "primitiveDisableImageWrite\000\377\000",
     (void *)primitiveDisableImageWrite},
    {(void *)_m, "primitiveGetSecureUserDirectory\000\377\000",
     (void *)primitiveGetSecureUserDirectory},
    {(void *)_m, "primitiveGetUntrustedUserDirectory\000\377\000",
     (void *)primitiveGetUntrustedUserDirectory},
    ...
    {(void *)_m, "secCanOpenAsyncFileOfSizeWritable",
     (void *)secCanOpenAsyncFileOfSizeWritable},
    {(void *)_m, "secCanOpenFileOfSizeWritable",
