/* Automatically generated by
        SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.1950 uuid:
   b4089b49-1494-49d2-8966-57cba5c92194 from ObjectiveCPlugin
   ObjectiveC-Plugin-John M McIntosh.20 uuid:
   945d3486-9e4a-487b-a4e0-b19a75c8042f
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "ObjectiveCPlugin ObjectiveC-Plugin-John M McIntosh.20 uuid: "
    "945d3486-9e4a-487b-a4e0-b19a75c8042f " __DATE__;
#else
...
static sqInt initialiseModule(void) { return 1; }
...
primitiveGetAddressFromEntryPointString(void) {
  ...
  entryPointNameLength =
      slotSizeOf(((sqInt)(long)(aEntryPointName)-BaseHeaderSize));
...
primitiveGetMethodSignatureForSelector(void) {
  ...
  messageSignatureObject =
      [classOrInstanceObject methodSignatureForSelector:selectorObject];
  NS_HANDLER
...
primitiveGetNSStringForString(void) {
  ...
  aStringAsNSString = 0;
  NS_DURING;
  aStringAsNSString = [[NSString alloc] initWithBytes:aString
                                               length:stringLength
                                             encoding:encoding];
  NS_HANDLER
...
primitiveGetObjCClassForString(void) {
  ...
  classNameNSString = [[NSString alloc] initWithBytes:aClassName
...
primitiveGetSelectorForString(void) {
  ...
  selectorNSString = [[NSString alloc] initWithBytes:aSelectorName
...
primitiveMethodSignatureGetArgumentType(void) {
  ...
  nsMethodSignatureObject =
      ((NSMethodSignature *)(positive64BitValueOf(aMethodSignatureOop)));
  string = null;
  if (failed()) {
    return null;
  }
...
primitiveNSInvocationGetArgument(void) {
  ...
  nsInvocationInstance =
      ((NSInvocation *)(positive64BitValueOf(aMethodSignatureOop)));
...
primitiveNSInvocationWithMethodSignature(void) {
  ...
  NS_DURING;
  nsInvocationOops =
      [NSInvocation invocationWithMethodSignature:methodSignatureOop];
  NS_HANDLER;
  success(0);
  {
    return null;
...
primitivePerformSelectorOnMainThreadWithWaitTilDone(void) {
  ...
  NS_DURING;
  [classOrInstanceObject performSelectorOnMainThread:selectorObject
                                          withObject:object1
                                       waitUntilDone:doneFlag];
  NS_HANDLER;
  success(0);
  {
    return null;
...
primitivePerformSelectorWith(void) {
  ...
  NS_DURING;
  returnValue =
      [classOrInstanceObject performSelector:selectorObject withObject:object1];
  NS_HANDLER
  returnValue = nil;
  NS_ENDHANDLER;
  if (failed()) {
...
static sqInt shutdownModule(void) { return 1; }
...
void *ObjectiveCPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveCallbackLeave\000\000",
     (void *)primitiveCallbackLeave},
    {(void *)_m, "primitiveGetAddressFromEntryPointString\000\377",
     (void *)primitiveGetAddressFromEntryPointString},
    {(void *)_m, "primitiveGetAutoReleasePool\000\377",
     (void *)primitiveGetAutoReleasePool},
    {(void *)_m, "primitiveGetClass\000\000", (void *)primitiveGetClass},
    {(void *)_m, "primitiveGetDescription\000\000",
     (void *)primitiveGetDescription},
    {(void *)_m, "primitiveGetMethodSignatureForSelector\000\000",
     (void *)primitiveGetMethodSignatureForSelector},
    {(void *)_m, "primitiveGetNSStringForString\000\001",
     (void *)primitiveGetNSStringForString},
    {(void *)_m, "primitiveGetObjCClassForString\000\377",
     (void *)primitiveGetObjCClassForString},
    {(void *)_m, "primitiveGetSelectorForString\000\377",
     (void *)primitiveGetSelectorForString},
    {(void *)_m, "primitiveGetSuperClass\000\000",
     (void *)primitiveGetSuperClass},
    {(void *)_m, "primitiveIsEqual\000\000", (void *)primitiveIsEqual},
    {(void *)_m, "primitiveMethodSignatureGetArgumentType\000\000",
     (void *)primitiveMethodSignatureGetArgumentType},
    {(void *)_m, "primitiveMethodSignatureGetMethodReturnLength\000\000",
     (void *)primitiveMethodSignatureGetMethodReturnLength},
    {(void *)_m, "primitiveMethodSignatureGetNumberOfArguments\000\000",
     (void *)primitiveMethodSignatureGetNumberOfArguments},
    {(void *)_m, "primitiveMethodSignatureGetReturnType\000\000",
     (void *)primitiveMethodSignatureGetReturnType},
    {(void *)_m, "primitiveNSInvocationCalloc\000\000",
     (void *)primitiveNSInvocationCalloc},
    {(void *)_m, "primitiveNSInvocationFree\000\000",
     (void *)primitiveNSInvocationFree},
    {(void *)_m, "primitiveNSInvocationGetArgument\000\000",
     (void *)primitiveNSInvocationGetArgument},
    {(void *)_m, "primitiveNSInvocationGetCharPointerType\000\000",
     (void *)primitiveNSInvocationGetCharPointerType},
    {(void *)_m, "primitiveNSInvocationGetClassType\000\000",
     (void *)primitiveNSInvocationGetClassType},
    {(void *)_m, "primitiveNSInvocationGetCType\000\000",
     (void *)primitiveNSInvocationGetCType},
    {(void *)_m, "primitiveNSInvocationGetDoubleType\000\000",
     (void *)primitiveNSInvocationGetDoubleType},
    {(void *)_m, "primitiveNSInvocationGetFloatType\000\000",
     (void *)primitiveNSInvocationGetFloatType},
    {(void *)_m, "primitiveNSInvocationGetIntType\000\000",
     (void *)primitiveNSInvocationGetIntType},
    {(void *)_m, "primitiveNSInvocationGetLongLongType\000\000",
     (void *)primitiveNSInvocationGetLongLongType},
    {(void *)_m, "primitiveNSInvocationGetLongType\000\000",
     (void *)primitiveNSInvocationGetLongType},
    {(void *)_m, "primitiveNSInvocationGetObjectType\000\000",
     (void *)primitiveNSInvocationGetObjectType},
    {(void *)_m, "primitiveNSInvocationGetReturnValue\000\000",
     (void *)primitiveNSInvocationGetReturnValue},
    {(void *)_m, "primitiveNSInvocationGetSelectorType\000\000",
     (void *)primitiveNSInvocationGetSelectorType},
    {(void *)_m, "primitiveNSInvocationGetShortType\000\000",
     (void *)primitiveNSInvocationGetShortType},
    {(void *)_m, "primitiveNSInvocationGetStructureType\000\000",
     (void *)primitiveNSInvocationGetStructureType},
    {(void *)_m, "primitiveNSInvocationMalloc\000\000",
     (void *)primitiveNSInvocationMalloc},
    {(void *)_m, "primitiveNSInvocationSetCType\000\000",
     (void *)primitiveNSInvocationSetCType},
    {(void *)_m, "primitiveNSInvocationSetDoubleType\000\000",
     (void *)primitiveNSInvocationSetDoubleType},
    {(void *)_m, "primitiveNSInvocationSetFloatType\000\000",
     (void *)primitiveNSInvocationSetFloatType},
    {(void *)_m, "primitiveNSInvocationSetIntType\000\000",
     (void *)primitiveNSInvocationSetIntType},
    {(void *)_m, "primitiveNSInvocationSetLongLongType\000\000",
     (void *)primitiveNSInvocationSetLongLongType},
    {(void *)_m, "primitiveNSInvocationSetLongType\000\000",
     (void *)primitiveNSInvocationSetLongType},
    {(void *)_m, "primitiveNSInvocationSetPointerType\000\000",
     (void *)primitiveNSInvocationSetPointerType},
    {(void *)_m, "primitiveNSInvocationSetRetained\000\000",
     (void *)primitiveNSInvocationSetRetained},
    {(void *)_m, "primitiveNSInvocationSetSelector\000\000",
     (void *)primitiveNSInvocationSetSelector},
    {(void *)_m, "primitiveNSInvocationSetShortType\000\000",
     (void *)primitiveNSInvocationSetShortType},
    {(void *)_m, "primitiveNSInvocationSetStringType\000\000",
     (void *)primitiveNSInvocationSetStringType},
    {(void *)_m, "primitiveNSInvocationSetStructureType\000\000",
     (void *)primitiveNSInvocationSetStructureType},
    {(void *)_m, "primitiveNSInvocationSetVoidPointerType\000\000",
     (void *)primitiveNSInvocationSetVoidPointerType},
    {(void *)_m, "primitiveNSInvocationWithMethodSignature\000\000",
     (void *)primitiveNSInvocationWithMethodSignature},
    {(void *)_m, "primitiveNSLog\000\000", (void *)primitiveNSLog},
    {(void *)_m, "primitiveNSStringToUTF8\000\000",
     (void *)primitiveNSStringToUTF8},
    {(void *)_m, "primitivePerformSelector\000\000",
     (void *)primitivePerformSelector},
    {(void *)_m, "primitivePerformSelectorOnMainThreadWithWaitTilDone\000\000",
     (void *)primitivePerformSelectorOnMainThreadWithWaitTilDone},
    {(void *)_m, "primitivePerformSelectorWith\000\000",
     (void *)primitivePerformSelectorWith},
    {(void *)_m, "primitivePerformSelectorWithWith\000\000",
     (void *)primitivePerformSelectorWithWith},
...
signed char primitivePerformSelectorOnMainThreadWithWaitTilDoneAccessorDepth =
    0;
