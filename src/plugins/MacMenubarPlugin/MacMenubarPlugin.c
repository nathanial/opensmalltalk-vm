/* Automatically generated by
        SmartSyntaxPluginCodeGenerator VMMaker.oscog-eem.3571 uuid:
   3527b27c-12a8-45c8-b1d8-f1a62d525309
        (* Compiler-nice.517)
   from
        MacMenubarPlugin VMMaker.oscog-eem.3571 uuid:
   3527b27c-12a8-45c8-b1d8-f1a62d525309
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "MacMenubarPlugin VMMaker.oscog-eem.3571 uuid: "
    "3527b27c-12a8-45c8-b1d8-f1a62d525309 " __DATE__;
#else
...
static const char *moduleName =
    "MacMenubarPlugin VMMaker.oscog-eem.3571 " INT_EXT;
...
primitiveCreateStandardWindowMenu(void) {
  ...
  _return_value = /* positiveMachineIntegerFor: */
      (BytesPerWord == 8 ? positive64BitIntegerFor(((usqIntptr_t)menuHandle))
...
#if TARGET_API_MAC_CARBON
  GetIndMenuItemWithCommandID(menuHandle, kHICommandHide, 1, &applicationMenu,
                              &outIndex);
#endif
...
primitiveGetMenuBar(void) {
  ...
  value = ((usqIntptr_t)(GetMenuBar()));

  /* begin positiveMachineIntegerFor: */
  _return_value = (BytesPerWord == 8 ? positive64BitIntegerFor(value)
...
primitiveGetMenuHandle(void) {
  ...
  menuID = integerValueOf(menuID);
  value = ((usqIntptr_t)(GetMenuHandle(menuID)));
...
primitiveNewMenu(void) {
  ...
  value = ((usqIntptr_t)(NewMenu(menuID, ((ConstStr255Param)menuTitle))));
...
primitiveSetMenuBar(void) {
  ...
  menuHandleOop = stackValue(0);
  menuBarHandle =
      ((MenuBarHandle)(positiveMachineIntegerValueOf(menuHandleOop)));
...
void *MacMenubarPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveAppendMenu\000\000\000",
     (void *)primitiveAppendMenu},
    {(void *)_m, "primitiveAppendMenuItemText\000\000\000",
     (void *)primitiveAppendMenuItemText},
    {(void *)_m, "primitiveCheckMenuItem\000\000\000",
     (void *)primitiveCheckMenuItem},
    {(void *)_m, "primitiveClearMenuBar\000\377\000",
     (void *)primitiveClearMenuBar},
    {(void *)_m, "primitiveCountMenuItems\000\000\000",
     (void *)primitiveCountMenuItems},
    {(void *)_m, "primitiveCreateStandardWindowMenu\000\000\000",
     (void *)primitiveCreateStandardWindowMenu},
    {(void *)_m, "primitiveDeleteMenu\000\000\000",
     (void *)primitiveDeleteMenu},
    {(void *)_m, "primitiveDeleteMenuItem\000\000\000",
     (void *)primitiveDeleteMenuItem},
    {(void *)_m, "primitiveDisableMenuCommand\000\000\000",
     (void *)primitiveDisableMenuCommand},
    {(void *)_m, "primitiveDisableMenuItem\000\000\000",
     (void *)primitiveDisableMenuItem},
    {(void *)_m, "primitiveDisableMenuItemIcon\000\000\000",
     (void *)primitiveDisableMenuItemIcon},
    {(void *)_m, "primitiveDisposeMenu\000\000\000",
     (void *)primitiveDisposeMenu},
    {(void *)_m, "primitiveDisposeMenuBar\000\000\000",
     (void *)primitiveDisposeMenuBar},
    {(void *)_m, "primitiveDrawMenuBar\000\377\000",
     (void *)primitiveDrawMenuBar},
    {(void *)_m, "primitiveEnableMenuCommand\000\000\000",
     (void *)primitiveEnableMenuCommand},
    {(void *)_m, "primitiveEnableMenuItem\000\000\000",
     (void *)primitiveEnableMenuItem},
    {(void *)_m, "primitiveEnableMenuItemIcon\000\000\000",
     (void *)primitiveEnableMenuItemIcon},
    {(void *)_m, "primitiveGetIndMenuItemWithCommandID\000\000\000",
     (void *)primitiveGetIndMenuItemWithCommandID},
    {(void *)_m, "primitiveGetIndMenuWithCommandID\000\000\000",
     (void *)primitiveGetIndMenuWithCommandID},
    {(void *)_m, "primitiveGetItemCmd\000\000\000",
     (void *)primitiveGetItemCmd},
    {(void *)_m, "primitiveGetItemIcon\000\000\000",
     (void *)primitiveGetItemIcon},
    {(void *)_m, "primitiveGetItemMark\000\000\000",
     (void *)primitiveGetItemMark},
    {(void *)_m, "primitiveGetItemStyle\000\000\000",
     (void *)primitiveGetItemStyle},
    {(void *)_m, "primitiveGetMenuBar\000\377\000",
     (void *)primitiveGetMenuBar},
    {(void *)_m, "primitiveGetMenuHandle\000\000\000",
     (void *)primitiveGetMenuHandle},
    {(void *)_m, "primitiveGetMenuID\000\000\000", (void *)primitiveGetMenuID},
    {(void *)_m, "primitiveGetMenuItemCommandID\000\000\000",
     (void *)primitiveGetMenuItemCommandID},
    {(void *)_m, "primitiveGetMenuItemFontID\000\000\000",
     (void *)primitiveGetMenuItemFontID},
    {(void *)_m, "primitiveGetMenuItemHierarchicalID\000\000\000",
     (void *)primitiveGetMenuItemHierarchicalID},
    {(void *)_m, "primitiveGetMenuItemKeyGlyph\000\000\000",
     (void *)primitiveGetMenuItemKeyGlyph},
    {(void *)_m, "primitiveGetMenuItemModifiers\000\000\000",
     (void *)primitiveGetMenuItemModifiers},
    {(void *)_m, "primitiveGetMenuItemText\000\000\000",
     (void *)primitiveGetMenuItemText},
    {(void *)_m, "primitiveGetMenuItemTextEncoding\000\000\000",
     (void *)primitiveGetMenuItemTextEncoding},
    {(void *)_m, "primitiveGetMenuTitle\000\000\000",
     (void *)primitiveGetMenuTitle},
    {(void *)_m, "primitiveHideMenuBar\000\377\000",
     (void *)primitiveHideMenuBar},
    {(void *)_m, "primitiveHiliteMenu\000\000\000",
     (void *)primitiveHiliteMenu},
    {(void *)_m, "primitiveInsertFontResMenu\000\000\000",
     (void *)primitiveInsertFontResMenu},
    {(void *)_m, "primitiveInsertIntlResMenu\000\000\000",
     (void *)primitiveInsertIntlResMenu},
    {(void *)_m, "primitiveInsertMenu\000\000\000",
     (void *)primitiveInsertMenu},
    {(void *)_m, "primitiveInsertMenuItem\000\000\000",
     (void *)primitiveInsertMenuItem},
    {(void *)_m, "primitiveInvalMenuBar\000\377\000",
     (void *)primitiveInvalMenuBar},
    {(void *)_m, "primitiveIsMenuBarVisible\000\377\000",
     (void *)primitiveIsMenuBarVisible},
    {(void *)_m, "primitiveIsMenuItemEnabled\000\000\000",
     (void *)primitiveIsMenuItemEnabled},
    {(void *)_m, "primitiveIsMenuItemIconEnabled\000\000\000",
     (void *)primitiveIsMenuItemIconEnabled},
    {(void *)_m, "primitiveNewMenu\000\000\000", (void *)primitiveNewMenu},
    {(void *)_m, "primitiveSetItemCmd\000\000\000",
     (void *)primitiveSetItemCmd},
    {(void *)_m, "primitiveSetItemIcon\000\000\000",
     (void *)primitiveSetItemIcon},
    {(void *)_m, "primitiveSetItemMark\000\000\000",
     (void *)primitiveSetItemMark},
    {(void *)_m, "primitiveSetItemStyle\000\000\000",
     (void *)primitiveSetItemStyle},
    {(void *)_m, "primitiveSetMenuBar\000\000\000",
     (void *)primitiveSetMenuBar},
    {(void *)_m, "primitiveSetMenuItemCommandID\000\000\000",
     (void *)primitiveSetMenuItemCommandID},
    {(void *)_m, "primitiveSetMenuItemFontID\000\000\000",
     (void *)primitiveSetMenuItemFontID},
    {(void *)_m, "primitiveSetMenuItemHierarchicalID\000\000\000",
     (void *)primitiveSetMenuItemHierarchicalID},
    {(void *)_m, "primitiveSetMenuItemKeyGlyph\000\000\000",
     (void *)primitiveSetMenuItemKeyGlyph},
    {(void *)_m, "primitiveSetMenuItemModifiers\000\000\000",
     (void *)primitiveSetMenuItemModifiers},
    {(void *)_m, "primitiveSetMenuItemText\000\000\000",
     (void *)primitiveSetMenuItemText},
    {(void *)_m, "primitiveSetMenuItemTextEncoding\000\000\000",
     (void *)primitiveSetMenuItemTextEncoding},
    {(void *)_m, "primitiveSetMenuTitle\000\000\000",
     (void *)primitiveSetMenuTitle},
    {(void *)_m, "primitiveShowMenuBar\000\377\000",
     (void *)primitiveShowMenuBar},
...
#if SPURVM
EXPORT(signed short) primitiveAppendMenuMetadata = 0;
EXPORT(signed short) primitiveAppendMenuItemTextMetadata = 0;
...
EXPORT(signed short) primitiveSetMenuItemTextMetadata = 0;
EXPORT(signed short) primitiveSetMenuItemTextEncodingMetadata = 0;
EXPORT(signed short) primitiveSetMenuTitleMetadata = 0;
#endif // SPURVM
