/* Automatically generated by
        VMPluginCodeGenerator VMMaker.oscog-eem.3510 uuid:
   d3135530-f366-405e-bf1f-cdcd0f5fce01 (Compiler-eem.513) from ScratchPlugin
   VMMaker.oscog-eem.3510 uuid: d3135530-f366-405e-bf1f-cdcd0f5fce01
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "ScratchPlugin VMMaker.oscog-eem.3510 uuid: "
    "d3135530-f366-405e-bf1f-cdcd0f5fce01 " __DATE__;
#else
...
static const char *moduleName = "ScratchPlugin VMMaker.oscog-eem.3510 " INT_EXT;
...
l1:
  ...
  out = firstIndexableField(outOop);
  /* end checkedUnsignedIntPtrOf: */
l2:
  sz = stSizeOf(inOop);
...
l2:
  ...
  for (x = 0; x < width; x += 1) {
    for (y = 0; y < height; y += 1) {
      ...
      if (r <= 1.0) {
        ang = atan2(dy, dx);
        srcX = ((sqInt)(0x400 * (centerX + ((r * (cos(ang))) * centerX))));
        srcY = ((sqInt)(0x400 * (centerY + ((r * (sin(ang))) * centerY))));
      } else {
        srcX = 0x400 * x;
        srcY = 0x400 * y;
      }
      ...
      xSqInt = (((usqInt)(srcX)) >> 10);
      if ((xSqInt < -1) || (xSqInt >= width)) {
        pix = 0;
        goto l5;
      }
      ySqInt = (((usqInt)(srcY)) >> 10);
      if ((ySqInt < -1) || (ySqInt >= height)) {
        pix = 0;
        goto l5;
      }
      xFrac = srcX & 0x3FF;
      ...
      if (xFrac > 0) {
        ...
        if (!topPix) {
          topPix = (in[index + 1]) & 0xFFFFFF;
          goto l3;
        }
        if (!((in[index + 1]) & 0xFFFFFF)) {
          goto l3;
        }
        frac1 = 0x400 - xFrac;
        rSqInt = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) +
                  (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) &
                            0xFF))) /
                 0x400;
        g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) +
             (xFrac *
              (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) /
            0x400;
        b = ((frac1 * (topPix & 0xFF)) +
             (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) /
            0x400;
        result =
            ((((((usqInt)(rSqInt) << 16)))) + (((((usqInt)(g) << 8))))) + b;
        if (!result) {
          result = 1;
        }
        topPix = result;
      ...
      if (xFrac > 0) {
        ...
        frac1 = 0x400 - xFrac;
        rSqInt = ((frac1 * (((((usqInt)(bottomPix)) >> 16)) & 0xFF)) +
                  (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) &
                            0xFF))) /
                 0x400;
        g = ((frac1 * (((((usqInt)(bottomPix)) >> 8)) & 0xFF)) +
             (xFrac *
              (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) /
            0x400;
        b = ((frac1 * (bottomPix & 0xFF)) +
             (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) /
            0x400;
        result =
            ((((((usqInt)(rSqInt) << 16)))) + (((((usqInt)(g) << 8))))) + b;
      ...
      frac1 = 0x400 - yFrac;
      rSqInt = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) +
                (yFrac * (((((usqInt)(bottomPix)) >> 16)) & 0xFF))) /
               0x400;
      g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) +
           (yFrac * (((((usqInt)(bottomPix)) >> 8)) & 0xFF))) /
          0x400;
      b = ((frac1 * (topPix & 0xFF)) + (yFrac * (bottomPix & 0xFF))) / 0x400;
      result = ((((((usqInt)(rSqInt) << 16)))) + (((((usqInt)(g) << 8))))) + b;
      if (!result) {
        result = 1;
      }
      pix = result;
...
primitiveGetFolderPath(void) {
  ...
  dst = firstIndexableField(resultOop);
  for (i = 0; i < count; i += 1) {
    dst[i] = (nameStr[i]);
  }
...
l1:
  ...
  if (xFrac > 0) {
    ...
    frac1 = 0x400 - xFrac;
    r = ((frac1 * (((((usqInt)(topPix)) >> 16)) & 0xFF)) +
         (xFrac *
          (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) /
        0x400;
    g = ((frac1 * (((((usqInt)(topPix)) >> 8)) & 0xFF)) +
         (xFrac * (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 8)) & 0xFF))) /
        0x400;
    b = ((frac1 * (topPix & 0xFF)) +
         (xFrac * (((in[index + 1]) & 0xFFFFFF) & 0xFF))) /
        0x400;
    resultSqInt = ((((((usqInt)(r) << 16)))) + (((((usqInt)(g) << 8))))) + b;
    if (!resultSqInt) {
      resultSqInt = 1;
    }
    topPix = resultSqInt;
  ...
  if (xFrac > 0) {
    ...
    frac1 = 0x400 - xFrac;
    r = ((frac1 * (((((usqInt)(bottomPix)) >> 16)) & 0xFF)) +
         (xFrac *
          (((((usqInt)(((in[index + 1]) & 0xFFFFFF))) >> 16)) & 0xFF))) /
        0x400;
    g = ((frac1 * (((((usqInt)(bottomPix)) >> 8)) & 0xFF)) +
...
primitiveIsHidden(void) {
  ...
  src = firstIndexableField(pathOop);
...
primitiveOpenURL(void) {
  ...
  src = firstIndexableField(urlOop);
...
/*	This version isn't really able to do much with full ARGB based images;
   the A channel will be ignored and only fully transparent pixels will be
        treated as transparent. The output pixel will be either fully
...
l2:
  ...
  xIncr = (inW * 0x400) / outW;

  /* source y increment, scaled by 1024 */
  yIncr = (inH * 0x400) / outH;
  for (outY = 0; outY < outH; outY += 1) {
    inX = 0;
    for (outX = 0; outX < outW; outX += 1) {
      w1 = (0x400 - (inX & 0x3FF)) * (0x400 - (inY & 0x3FF));
      w2 = (inX & 0x3FF) * (0x400 - (inY & 0x3FF));
      w3 = (0x400 - (inX & 0x3FF)) * (inY & 0x3FF);
      ...
      outPix = 0;
      if (tWeight < 500000) {
        t = (((w1 * ((((usqInt)(p1)) >> 16) & 0xFF)) +
              (w2 * ((((usqInt)(p2)) >> 16) & 0xFF))) +
             (w3 * ((((usqInt)(p3)) >> 16) & 0xFF))) +
            (w4 * ((((usqInt)(p4)) >> 16) & 0xFF));
        outPix = (((usqInt)(((((usqInt)(t)) >> 20) & 0xFF)) << 16));
        t = (((w1 * ((((usqInt)(p1)) >> 8) & 0xFF)) +
              (w2 * ((((usqInt)(p2)) >> 8) & 0xFF))) +
             (w3 * ((((usqInt)(p3)) >> 8) & 0xFF))) +
            (w4 * ((((usqInt)(p4)) >> 8) & 0xFF));
        outPix = outPix | ((((usqInt)(((((usqInt)(t)) >> 20) & 0xFF)) << 8)));
        t = (((w1 * (p1 & 0xFF)) + (w2 * (p2 & 0xFF))) + (w3 * (p3 & 0xFF))) +
            (w4 * (p4 & 0xFF));
        outPix = outPix | ((((usqInt)(t)) >> 20) & 0xFF);

        /* If the result is black, remember to make it
         * Squeak-standard-fake-black */
        if (!outPix) {
          outPix = 1;
        }
...
primitiveSetUnicodePasteBuffer(void) {
  ...
  utf16 = firstIndexableField(strOop);
...
primitiveSetWindowTitle(void) {
  ...
  src = firstIndexableField(titleOop);
...
/*	On Windows, convert a short file/path name into a long one. Fail on
   other platforms.
 */
...
primitiveShortToLongPath(void) {
  ...
  ptr = firstIndexableField(shortPathOop);
  ...
  resultOop = instantiateClassindexableSize(classString(), count);
  ptr = firstIndexableField(resultOop);
  for (i = 0; i < count; i += 1) {
    ptr[i] = (longPath[i]);
  }
  popthenPush(2, resultOop);
...
l2:
  ...
  aArray = firstIndexableField(aArOop);
...
l3:
  ...
  bArray = firstIndexableField(bArOop);
  /* end checkedFloatPtrOf: */
l4:
      ...
      for (h = -4; h <= 4; h += 1) {
        ...
        if ((dist < 25) && (dist > 0)) {
          ...
          if ((dx > 0) && ((dy > 0) && ((dy < height) && (dx < width)))) {
            aArray[(dy * width) + dx] =
                (power *
                 (((double)((((double)1.0)) - (dist / (((double)25.0)))))));
          }
        }
      }
    }
  ...
  for (f = 1; f <= (width - 2); f += 1) {
    for (d = 1; d <= (height - 2); d += 1) {
      val = (d * width) + f;
      aArray[val] = ((((((((((bArray[val + 1]) + (bArray[val - 1])) +
                            (bArray[val + width])) +
                           (bArray[val - width])) +
                          ((bArray[(val - 1) - width]) / 2)) +
                         ((bArray[(val - 1) + width]) / 2)) +
                        ((bArray[(val + 1) - width]) / 2)) +
                       ((bArray[(val + 1) + width]) / 2)) /
                      4) -
  ...
  for (j = 0; j < height; j += 1) {
    for (i = 0; i < width; i += 1) {
      if ((i > 1) && ((i < (width - 1)) && ((j > 1) && (j < (height - 1))))) {
        val2 = (j * width) + i;
        dx2 = ((double)((((aArray[val2]) - (aArray[val2 - 1])) +
                         ((aArray[val2 + 1]) - (aArray[val2]))) *
                        64));
        dy2 = ((double)((((aArray[val2]) - (aArray[val2 - width])) +
                         ((aArray[val2 + width]) - (aArray[val2]))) /
                        64));
        if (dx2 < -2) {
          dx2 = -2;
        }
  ...
  for (x = 0; x < width; x += 1) {
    for (y = 0; y < height; y += 1) {
      ...
      if (d < radiusSquared) {
        ...
        /* begin interpolatedFrom:x:y:width:height: */
        xSqInt = (((usqInt)(xFixed)) >> 10);
        if ((xSqInt < -1) || (xSqInt >= width)) {
          pix = 0;
          goto l5;
        }
        ySqInt = (((usqInt)(yFixed)) >> 10);
        if ((ySqInt < -1) || (ySqInt >= height)) {
          pix = 0;
          goto l5;
        }
...
primOpenPortNamed(void) {
  ...
  src = firstIndexableField(nameOop);
...
/*	Get the name for the port with the given number. Fail if the port number
        is greater than the number of available ports. Port numbering starts
   with 1.
 */
...
/*	Read data from the given serial port into the given buffer (a ByteArray
...
primRead(void) {
  ...
  bytesRead = SerialPortRead(portNum, ((char *)(firstIndexableField(bufOop))),
                             stSizeOf(bufOop));
  pop(3);
...
/*	Write data to the given serial port from the given buffer (a ByteArray
   or String). Answer the number of bytes written.
 */
...
primWrite(void) {
  ...
  bytesWritten = SerialPortWrite(
      portNum, ((char *)(firstIndexableField(bufOop))), stSizeOf(bufOop));
  pop(3);
...
void *ScratchPlugin_exports[][3] = {
    ...
    {(void *)_m, "primClose\000\000\000", (void *)primClose},
    {(void *)_m, "primGetOption\000\000\000", (void *)primGetOption},
    {(void *)_m, "primIsPortOpen\000\000\000", (void *)primIsPortOpen},
    {(void *)_m, "primitiveBlur\000\001\000", (void *)primitiveBlur},
    {(void *)_m, "primitiveBrightnessShift\000\001\000",
     (void *)primitiveBrightnessShift},
    {(void *)_m, "primitiveCondenseSound\000\001\000",
     (void *)primitiveCondenseSound},
    {(void *)_m, "primitiveDoubleSize\000\000\000",
     (void *)primitiveDoubleSize},
    {(void *)_m, "primitiveExtractChannel\000\001\000",
     (void *)primitiveExtractChannel},
    {(void *)_m, "primitiveFisheye\000\001\000", (void *)primitiveFisheye},
    {(void *)_m, "primitiveGetFolderPath\000\000\000",
     (void *)primitiveGetFolderPath},
    {(void *)_m, "primitiveHalfSizeAverage\000\000\000",
     (void *)primitiveHalfSizeAverage},
    {(void *)_m, "primitiveHalfSizeDiagonal\000\000\000",
     (void *)primitiveHalfSizeDiagonal},
    {(void *)_m, "primitiveHueShift\000\001\000", (void *)primitiveHueShift},
    {(void *)_m, "primitiveInterpolate\000\001\000",
     (void *)primitiveInterpolate},
    {(void *)_m, "primitiveIsHidden\000\001\000", (void *)primitiveIsHidden},
    {(void *)_m, "primitiveOpenURL\000\001\000", (void *)primitiveOpenURL},
    {(void *)_m, "primitiveSaturationShift\000\001\000",
     (void *)primitiveSaturationShift},
    {(void *)_m, "primitiveScale\000\001\000", (void *)primitiveScale},
    {(void *)_m, "primitiveSetUnicodePasteBuffer\000\001\000",
     (void *)primitiveSetUnicodePasteBuffer},
    {(void *)_m, "primitiveSetWindowTitle\000\001\000",
     (void *)primitiveSetWindowTitle},
    {(void *)_m, "primitiveShortToLongPath\000\001\000",
     (void *)primitiveShortToLongPath},
    {(void *)_m, "primitiveWaterRipples1\000\001\000",
     (void *)primitiveWaterRipples1},
    {(void *)_m, "primitiveWhirl\000\001\000", (void *)primitiveWhirl},
    {(void *)_m, "primOpenPortNamed\000\001\000", (void *)primOpenPortNamed},
    {(void *)_m, "primPortCount\000\377\000", (void *)primPortCount},
    {(void *)_m, "primPortName\000\000\000", (void *)primPortName},
    {(void *)_m, "primRead\000\001\000", (void *)primRead},
    {(void *)_m, "primSetOption\000\000\000", (void *)primSetOption},
    {(void *)_m, "primWrite\000\001\000", (void *)primWrite},
...
#if SPURVM
EXPORT(signed short) primCloseMetadata = 0;
EXPORT(signed short) primGetOptionMetadata = 0;
EXPORT(signed short) primIsPortOpenMetadata = 0;
EXPORT(signed short) primitiveBlurMetadata = 0x100;
EXPORT(signed short) primitiveBrightnessShiftMetadata = 0x100;
EXPORT(signed short) primitiveCondenseSoundMetadata = 0x100;
EXPORT(signed short) primitiveDoubleSizeMetadata = 0;
EXPORT(signed short) primitiveExtractChannelMetadata = 0x100;
EXPORT(signed short) primitiveFisheyeMetadata = 0x100;
EXPORT(signed short) primitiveGetFolderPathMetadata = 0;
EXPORT(signed short) primitiveHalfSizeAverageMetadata = 0;
EXPORT(signed short) primitiveHalfSizeDiagonalMetadata = 0;
EXPORT(signed short) primitiveHueShiftMetadata = 0x100;
EXPORT(signed short) primitiveInterpolateMetadata = 0x100;
EXPORT(signed short) primitiveIsHiddenMetadata = 0x100;
EXPORT(signed short) primitiveOpenURLMetadata = 0x100;
EXPORT(signed short) primitiveSaturationShiftMetadata = 0x100;
EXPORT(signed short) primitiveScaleMetadata = 0x100;
EXPORT(signed short) primitiveSetUnicodePasteBufferMetadata = 0x100;
EXPORT(signed short) primitiveSetWindowTitleMetadata = 0x100;
EXPORT(signed short) primitiveShortToLongPathMetadata = 0x100;
EXPORT(signed short) primitiveWaterRipples1Metadata = 0x100;
EXPORT(signed short) primitiveWhirlMetadata = 0x100;
EXPORT(signed short) primOpenPortNamedMetadata = 0x100;
EXPORT(signed short) primPortNameMetadata = 0;
EXPORT(signed short) primReadMetadata = 0x100;
EXPORT(signed short) primSetOptionMetadata = 0;
EXPORT(signed short) primWriteMetadata = 0x100;
#endif // SPURVM
