/* Automatically generated by
        FT2PluginCodeGenerator Freetype-Plugin-EstebanLorenzano.70 uuid:
   3729adbd-b383-456b-96ec-dac31cd293f8 from FT2Plugin
   Freetype-Plugin-EstebanLorenzano.70 uuid:
   3729adbd-b383-456b-96ec-dac31cd293f8
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "FT2Plugin Freetype-Plugin-EstebanLorenzano.70 uuid: "
    "3729adbd-b383-456b-96ec-dac31cd293f8 " __DATE__;
#else
...
/*** Function Prototypes ***/
static char *fetchByteArrayofObjectassureSize(sqInt fieldIndex,
                                              sqInt objectPointer, sqInt aSize);
static short *fetchShortArrayofObjectassureSize(sqInt fieldIndex,
                                                sqInt objectPointer,
                                                sqInt aSize);
static long *fetchWordArrayofObjectassureSize(sqInt fieldIndex,
                                              sqInt objectPointer, sqInt aSize);
...
static int ftInitBitmapfromFormrenderMode(FT_Bitmap *bitmap, sqInt formOop,
                                          sqInt mode);
...
static sqInt primitiveGetTrackKerningPointSizedegree(sqInt pointSize,
                                                     sqInt degree);
...
static sqInt (*ioFilenamefromStringofLengthresolveAliases)(
    char *aCharBuffer, char *aFilenameString, sqInt filenameLength,
    sqInt aBoolean);
...
extern sqInt ioFilenamefromStringofLengthresolveAliases(char *aCharBuffer,
...
static char *fetchByteArrayofObjectassureSize(sqInt fieldIndex,
  ...
  if ((isBytes(array)) && ((slotSizeOf(array)) == aSize)) {
...
static short *fetchShortArrayofObjectassureSize(sqInt fieldIndex,
  ...
  array = fetchPointerofObject(fieldIndex, objectPointer);
  if ((isWords(array)) && ((slotSizeOf(array)) == ((aSize + 1) / 2))) {
    return arrayValueOf(array);
  }
  return null;
}
...
static long *fetchWordArrayofObjectassureSize(sqInt fieldIndex,
  ...
  array = fetchPointerofObject(fieldIndex, objectPointer);
  if ((isWords(array)) && ((slotSizeOf(array)) == aSize)) {
    return arrayValueOf(array);
  }
  return null;
}
...
static sqInt ftAllocateHandleInReceiverForPointer(void *aPointer) {
  ...
  storePointerofObjectwithValue(0, stackObjectValue(methodArgumentCount()),
                                returnedHandle);
...
static sqInt ftAllocateStringForPointer(const char *aPointer) {
  ...
  if (aPointer) {
    ...
    /* Copy from the C bytecode buffer to the Smalltalk ByteArray */
    returnedHandle =
        instantiateClassindexableSize(classString(), strlen(aPointer));
    extraByteArrayPtr = arrayValueOf(returnedHandle);
...
static FT_Encoding ftEncodingValueFromString(sqInt string) {
  ...
  success(
      (!(isIntegerObject(string))) &&
      ((isBytes(string)) && ((slotSizeOf(string)) == (sizeof(FT_Encoding)))));
  if (failed()) {
    return null;
  }
  retval = 0;
...
static void *ftHandleValueFromReceiver(sqInt rcvrOop) {
  ...
  success((isBytes(oop)) && ((slotSizeOf(oop)) == (sizeof(void *))));
  if (failed()) {
    return null;
  }
...
#define FT_ERROR_END_LIST                                                      \
  {0xFF, "Bad Squeak Method Parameter"}, { 0, NULL }                           \
  }                                                                            \
  ;
...
primitiveGetSfntTableOS2(void) {
  ...
  /* Copy from the C bytecode buffer to the Smalltalk ByteArray */
  returnedHandle =
      instantiateClassindexableSize(classByteArray(), sizeof(TT_OS2));
  extraByteArrayPtr = arrayValueOf(returnedHandle);
...
/*	Fill in many of the receiver's (an FT2Face) fields (other than its
   handle) from the FT_Face record that it points to. */
...
primitiveLoadGlyphSlotFromFace(void) {
  ...
  pushRemappableOop(rcvr);
  gfOop =
      instantiateClassindexableSize(classByteArray(), sizeof(FT_Glyph_Format));
...
primitiveLoadOutlineArraysFromFace(void) {
  ...
  if ((isWords(array)) && ((slotSizeOf(array)) == (pointsSize * 2))) {
...
l1: /* end fetchWordArray:ofObject:assureSize: */;
  ...
  if ((isBytes(array1)) && ((slotSizeOf(array1)) == pointsSize)) {
...
l2: /* end fetchByteArray:ofObject:assureSize: */;
  ...
  if ((isWords(array2)) && ((slotSizeOf(array2)) == ((contoursSize + 1) / 2))) {
...
primitiveLoadOutlineSizesFromFace(void) {
  ...
  storeIntegerofObjectwithValue(FT2OutlineContoursSizeIndex, rcvr,
                                gs->outline.n_contours);
  storeIntegerofObjectwithValue(FT2OutlinePointsSizeIndex, rcvr,
                                gs->outline.n_points);
  if (failed()) {
    ftParameterError();
    return null;
...
primitiveNewFaceFromFileAndIndex(void) {
  ...
  ioFilenamefromStringofLengthresolveAliases(translatedFilePath, fontFilePath,
                                             byteSize, 1);
...
primitiveNewMemoryFaceFromExternalMemoryAndIndex(void) {
  ...
  errorCode =
      FT_New_Memory_Face(library, memPointer, byteSize, anInteger, &face);
  success(errorCode == 0);
  if (failed()) {
    return null;
  }
...
primitiveSetTransform(void) {
  ...
  delta.x = deltasqIntPtr[0];
  delta.y = deltasqIntPtr[1];
  matrix.xx = matrixsqIntPtr[0];
  matrix.xy = matrixsqIntPtr[1];
  matrix.yx = matrixsqIntPtr[2];
  matrix.yy = matrixsqIntPtr[3];
  if (!(failed())) {
...
void *FT2Plugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveCopyToExternalMemory\000\000",
     (void *)primitiveCopyToExternalMemory},
    {(void *)_m, "primitiveDoneFace\000\001", (void *)primitiveDoneFace},
    {(void *)_m, "primitiveDoneFacePreserveFields\000\001",
     (void *)primitiveDoneFacePreserveFields},
    {(void *)_m, "primitiveEmboldenFaceGlyphSlotOutline\000\001",
     (void *)primitiveEmboldenFaceGlyphSlotOutline},
    {(void *)_m, "primitiveErrorCode\000\377", (void *)primitiveErrorCode},
    {(void *)_m, "primitiveErrorString\000\377", (void *)primitiveErrorString},
    {(void *)_m, "primitiveFreeExternalMemory\000\001",
     (void *)primitiveFreeExternalMemory},
    {(void *)_m, "primitiveGetFaceCharIndex\000\001",
     (void *)primitiveGetFaceCharIndex},
    {(void *)_m, "primitiveGetFaceCharMap\000\001",
     (void *)primitiveGetFaceCharMap},
    {(void *)_m, "primitiveGetFaceCharMapsIntoArray\000\001",
     (void *)primitiveGetFaceCharMapsIntoArray},
    {(void *)_m, "primitiveGetFaceGlyphName\000\001",
     (void *)primitiveGetFaceGlyphName},
    {(void *)_m, "primitiveGetKerningLeftRight\000\001",
     (void *)primitiveGetKerningLeftRight},
    {(void *)_m, "primitiveGetPostscriptName\000\001",
     (void *)primitiveGetPostscriptName},
    {(void *)_m, "primitiveGetSfntTableOS2\000\001",
     (void *)primitiveGetSfntTableOS2},
    {(void *)_m, "primitiveHasKerning\000\001", (void *)primitiveHasKerning},
    {(void *)_m, "primitiveLibraryHandle\000\000",
     (void *)primitiveLibraryHandle},
    {(void *)_m, "primitiveLoadCharacter\000\001",
     (void *)primitiveLoadCharacter},
    {(void *)_m, "primitiveLoadFaceBbox\000\001",
     (void *)primitiveLoadFaceBbox},
    {(void *)_m, "primitiveLoadFaceFields\000\001",
     (void *)primitiveLoadFaceFields},
    {(void *)_m, "primitiveLoadGlyph\000\001", (void *)primitiveLoadGlyph},
    {(void *)_m, "primitiveLoadGlyphSlotFromFace\000\001",
     (void *)primitiveLoadGlyphSlotFromFace},
    {(void *)_m, "primitiveLoadOutlineArraysFromFace\000\002",
     (void *)primitiveLoadOutlineArraysFromFace},
    {(void *)_m, "primitiveLoadOutlineSizesFromFace\000\001",
     (void *)primitiveLoadOutlineSizesFromFace},
    {(void *)_m, "primitiveModuleErrorCode\000\377",
     (void *)primitiveModuleErrorCode},
    {(void *)_m, "primitiveNewFaceFromFileAndIndex\000\000",
     (void *)primitiveNewFaceFromFileAndIndex},
    {(void *)_m, "primitiveNewMemoryFaceFromExternalMemoryAndIndex\000\001",
     (void *)primitiveNewMemoryFaceFromExternalMemoryAndIndex},
    {(void *)_m, "primitiveNumberOfOutlineCountours\000\002",
     (void *)primitiveNumberOfOutlineCountours},
    {(void *)_m, "primitiveRenderGlyphIntoForm\000\001",
     (void *)primitiveRenderGlyphIntoForm},
    {(void *)_m, "primitiveRenderGlyphIntoFormWithRenderMode\000\001",
     (void *)primitiveRenderGlyphIntoFormWithRenderMode},
    {(void *)_m, "primitiveResetErrorCode\000\377",
     (void *)primitiveResetErrorCode},
    {(void *)_m, "primitiveSetFaceCharMap\000\001",
     (void *)primitiveSetFaceCharMap},
    {(void *)_m, "primitiveSetPixelSizes\000\001",
     (void *)primitiveSetPixelSizes},
    {(void *)_m, "primitiveSetTransform\000\001",
     (void *)primitiveSetTransform},
    {(void *)_m, "primitiveTransformFaceGlyphSlotOutline\000\001",
     (void *)primitiveTransformFaceGlyphSlotOutline},
    {(void *)_m, "primitiveTranslateFaceGlyphSlotOutline\000\001",
     (void *)primitiveTranslateFaceGlyphSlotOutline},
