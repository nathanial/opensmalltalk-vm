/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from SoundPlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "SoundPlugin VMMaker.oscog-eem.3475 uuid: "
...
static const char *moduleName = "SoundPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return soundInit(); }
...
primitiveSoundEnableAEC(void) {
  ...
  if ((errorCode = snd_EnableAEC(trueOrFalse))) {
    primitiveFailFor((errorCode < 0 ? PrimErrGenericFailure : errorCode));
  }
  methodReturnReceiver();
  return 0;
}
...
primitiveSoundGetRecordLevel(void) {
  ...
  return (level >= 0 ? methodReturnInteger(level) : primitiveFail());
}
...
primitiveSoundInsertSamples(void) {
  ...
  if ((((usqInt)frameCount)) >
      ((byteSizeOf(((sqInt)(sqIntptr_t)(buf)-BaseHeaderSize))) /
       ((sizeof(short)) * 2))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
...
primitiveSoundRecordSamples(void) {
  ...
  if (!((startWordIndex >= 1) && (byteOffset < bufSizeInBytes))) {
    return primitiveFailFor(PrimErrBadIndex);
  }
  samplesRecorded = snd_RecordSamplesIntoAtLength(
      (((char *)buf)) + byteOffset, 0, bufSizeInBytes - byteOffset);
  if (!(failed())) {
...
/*	Start the double-buffered sound output with the given buffer size,
   sample rate, and stereo flag.
 */
...
/*	Start the double-buffered sound output with the given buffer size,
   sample rate, stereo flag, and semaphore index.
 */
...
void *SoundPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveGetDefaultSoundPlayer\000\377\000",
     (void *)primitiveGetDefaultSoundPlayer},
    {(void *)_m, "primitiveGetDefaultSoundRecorder\000\377\000",
     (void *)primitiveGetDefaultSoundRecorder},
    {(void *)_m, "primitiveGetNumberOfSoundPlayerDevices\000\377\000",
     (void *)primitiveGetNumberOfSoundPlayerDevices},
    {(void *)_m, "primitiveGetNumberOfSoundRecorderDevices\000\377\000",
     (void *)primitiveGetNumberOfSoundRecorderDevices},
    {(void *)_m, "primitiveGetSoundPlayerDeviceName\000\000\000",
     (void *)primitiveGetSoundPlayerDeviceName},
#if TerfVM
    {(void *)_m, "primitiveGetSoundPlayerDeviceUID\000\000\000",
     (void *)primitiveGetSoundPlayerDeviceUID},
#endif /* TerfVM */
    {(void *)_m, "primitiveGetSoundRecorderDeviceName\000\000\000",
     (void *)primitiveGetSoundRecorderDeviceName},
#if TerfVM
    {(void *)_m, "primitiveGetSoundRecorderDeviceUID\000\000\000",
     (void *)primitiveGetSoundRecorderDeviceUID},
#endif /* TerfVM */
    {(void *)_m, "primitiveSetDefaultSoundPlayer\000\000\000",
     (void *)primitiveSetDefaultSoundPlayer},
    {(void *)_m, "primitiveSetDefaultSoundRecorder\000\000\000",
     (void *)primitiveSetDefaultSoundRecorder},
    {(void *)_m, "primitiveSoundAvailableSpace\000\377\000",
     (void *)primitiveSoundAvailableSpace},
    {(void *)_m, "primitiveSoundEnableAEC\000\000\000",
     (void *)primitiveSoundEnableAEC},
    {(void *)_m, "primitiveSoundGetRecordingSampleRate\000\377\000",
     (void *)primitiveSoundGetRecordingSampleRate},
    {(void *)_m, "primitiveSoundGetRecordLevel\000\377\000",
     (void *)primitiveSoundGetRecordLevel},
    {(void *)_m, "primitiveSoundGetVolume\000\377\000",
     (void *)primitiveSoundGetVolume},
    {(void *)_m, "primitiveSoundInsertSamples\000\000\000",
     (void *)primitiveSoundInsertSamples},
    {(void *)_m, "primitiveSoundPlaySamples\000\000\000",
     (void *)primitiveSoundPlaySamples},
    {(void *)_m, "primitiveSoundPlaySilence\000\377\000",
     (void *)primitiveSoundPlaySilence},
    {(void *)_m, "primitiveSoundRecordSamples\000\000\000",
     (void *)primitiveSoundRecordSamples},
    {(void *)_m, "primitiveSoundSetLeftVolume\000\000\000",
     (void *)primitiveSoundSetLeftVolume},
    {(void *)_m, "primitiveSoundSetRecordLevel\000\000\000",
     (void *)primitiveSoundSetRecordLevel},
    {(void *)_m, "primitiveSoundStart\000\000\000",
     (void *)primitiveSoundStart},
    {(void *)_m, "primitiveSoundStartRecording\000\000\000",
     (void *)primitiveSoundStartRecording},
    {(void *)_m, "primitiveSoundStartWithSemaphore\000\000\000",
     (void *)primitiveSoundStartWithSemaphore},
    {(void *)_m, "primitiveSoundStop\000\377\000", (void *)primitiveSoundStop},
    {(void *)_m, "primitiveSoundStopRecording\000\377\000",
     (void *)primitiveSoundStopRecording},
    {(void *)_m, "primitiveSoundSupportsAEC\000\377\000",
     (void *)primitiveSoundSupportsAEC},
