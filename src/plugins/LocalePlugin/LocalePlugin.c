/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from LocalePlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "LocalePlugin VMMaker.oscog-eem.3475 uuid: "
...
static const char *moduleName = "LocalePlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return sqLocInitialize(); }

/*	return a 3 char string describing the country in use. ISO 3166 is the
        relevant source here; see
   http://www.unicode.org/onlinedat/countries.html for details. Using the 3
   character Alpha-3 codes
 */
...
/*	return a 1 char string describing the decimal symbol used - usually a .
   or a ,
 */
...
/*	return a 1 char string describing the digitGrouping symbol used -
   usually a . or a , between triples of digits
 */
...
/*	return a 3 char string describing the language in use. ISO 639 is the
        relevant source here; see http://www.w3.org/WAI/ER/IG/ert/iso639.html
   for details
 */
...
primitiveTimezoneOffset(void) {
  ...
  _return_value = sqLocGetTimezoneOffset();
  if (!(failed())) {
...
primitiveVMOffsetToUTC(void) {
  ...
  _return_value = sqLocGetVMOffsetToUTC();
  if (!(failed())) {
    methodReturnInteger(_return_value);
  }
  return null;
...
void *LocalePlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveCountry\000\377\000", (void *)primitiveCountry},
    {(void *)_m, "primitiveCurrencyNotation\000\377\000",
     (void *)primitiveCurrencyNotation},
    {(void *)_m, "primitiveCurrencySymbol\000\377\000",
     (void *)primitiveCurrencySymbol},
    {(void *)_m, "primitiveDaylightSavings\000\377\000",
     (void *)primitiveDaylightSavings},
    {(void *)_m, "primitiveDecimalSymbol\000\377\000",
     (void *)primitiveDecimalSymbol},
    {(void *)_m, "primitiveDigitGroupingSymbol\000\377\000",
     (void *)primitiveDigitGroupingSymbol},
    {(void *)_m, "primitiveLanguage\000\377\000", (void *)primitiveLanguage},
    {(void *)_m, "primitiveLongDateFormat\000\377\000",
     (void *)primitiveLongDateFormat},
    {(void *)_m, "primitiveMeasurementMetric\000\377\000",
     (void *)primitiveMeasurementMetric},
    {(void *)_m, "primitiveShortDateFormat\000\377\000",
     (void *)primitiveShortDateFormat},
    {(void *)_m, "primitiveTimeFormat\000\377\000",
     (void *)primitiveTimeFormat},
    {(void *)_m, "primitiveTimezoneOffset\000\377\000",
     (void *)primitiveTimezoneOffset},
    {(void *)_m, "primitiveVMOffsetToUTC\000\377\000",
     (void *)primitiveVMOffsetToUTC},
