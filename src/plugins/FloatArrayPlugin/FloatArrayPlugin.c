/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from FloatArrayPlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "FloatArrayPlugin VMMaker.oscog-eem.3475 uuid: "
...
static const char *moduleName =
    "FloatArrayPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
primitiveAt(void) {
  ...
  rcvr = stackValue(1);
  if (!((!(failed())) &&
        ((isWords(rcvr)) && ((index > 0) && (index <= (slotSizeOf(rcvr))))))) {
    return primitiveFail();
  }
...
/*	Primitive. Divide each element in the receiver by the argument, a
   scalar, and store the result into the receiver, a FloatArray
 */
...
/*	Primitive. Multiply elements in the receiver, a FloatArray, by argument,
...
/*	Primitive. Subtract each element in the argument from each element in
   the receiver, both FloatArrays and store the result into the receiver.
 */
...
void *FloatArrayPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveAddFloatArray\000\001\003",
     (void *)primitiveAddFloatArray},
    ...
    {(void *)_m, "primitiveDivFloatArray\000\001\003",
     (void *)primitiveDivFloatArray},
    ...
    {(void *)_m, "primitiveMulFloatArray\000\001\003",
     (void *)primitiveMulFloatArray},
    ...
    {(void *)_m, "primitiveSubFloatArray\000\001\003",
     (void *)primitiveSubFloatArray},
