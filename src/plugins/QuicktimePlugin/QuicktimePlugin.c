/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from QuicktimePlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "QuicktimePlugin VMMaker.oscog-eem.3475 uuid: "
...
static const char *moduleName =
    "QuicktimePlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
EXPORT(sqInt)
initialiseModule(void) { return sqQuicktimeInitialize(); }
...
moduleUnloaded(char *aModuleName) {
  if (!(strcmp(aModuleName, "QuicktimePlugin"))) {
    sqQuicktimeShutdown();
  }
  return 0;
}
...
primitiveSetGWorldPtrOntoExistingSurface(void) {
  ...
  stQuicktimeSetToExistingSurfacegworldwidthheightrowBytesdepthmovie(
      surfaceID, buffer, width, height, rowBytes, depth, movie);
  if (!(failed())) {
    pop(7);
  }
  return null;
...
primitiveSetGWorldPtrOntoSurface(void) {
  ...
  buffer = ((char *)(positiveMachineIntegerValueOf(bitMapPtr)));
  movie = ((sqIntptr_t)(positiveMachineIntegerValueOf(moviePtr)));
  results = stQuicktimeSetSurfacewidthheightrowBytesdepthmovie(
      buffer, width, height, rowBytes, depth, movie);
  if (!(failed())) {
    methodReturnValue(integerObjectOf(results));
  }
  return null;
}
...
void *QuicktimePlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveClearFrameCompletedSemaphore\000\000\000",
     (void *)primitiveClearFrameCompletedSemaphore},
    {(void *)_m, "primitiveDestroyHandle\000\000\000",
     (void *)primitiveDestroyHandle},
    {(void *)_m, "primitiveDestroySurface\000\000\000",
     (void *)primitiveDestroySurface},
    {(void *)_m, "primitiveSetFrameCompletedSemaphore\000\000\000",
     (void *)primitiveSetFrameCompletedSemaphore},
    {(void *)_m, "primitiveSetGWorldPtrOntoExistingSurface\000\000\000",
     (void *)primitiveSetGWorldPtrOntoExistingSurface},
    {(void *)_m, "primitiveSetGWorldPtrOntoSurface\000\000\000",
     (void *)primitiveSetGWorldPtrOntoSurface},
