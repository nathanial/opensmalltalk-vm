/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from DESPlugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "DESPlugin CryptographyPlugins-eem.30 uuid: "
...
static sqInt processKeymodeto(unsigned char *keyPtr, sqInt encode,
                              unsigned int *cookedPtr);
...
static const char *moduleName = "DESPlugin CryptographyPlugins-eem.30 " INT_EXT;
  ...
  if (!((isBytes(rawOop)) &&
        (((stSizeOf(rawOop)) == 8) &&
         ((isIntegerObject(encode)) &&
          ((isWords(cookedOop)) && ((stSizeOf(cookedOop)) == 32)))))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
  processKeymodeto(firstIndexableField(rawOop), (integerValueOf(encode)) != 0,
                   firstIndexableField(cookedOop));
...
primitiveDESTransform(void) {
  ...
  /* begin scrunch:to: */
  work[0] =
      (((((((usqInt)((data[0])) << 24))) + ((((usqInt)((data[1])) << 16)))) +
        ((((usqInt)((data[2])) << 8)))) +
       (data[3]));
  work[1] =
      (((((((usqInt)((data[4])) << 24))) + ((((usqInt)((data[5])) << 16)))) +
        ((((usqInt)((data[6])) << 8)))) +
       (data[7]));
  ...
  right = (((((usqInt)(right) << 1))) | ((((usqInt)(right)) >> 0x1F) & 1)) &
          0xFFFFFFFFU;
  work1 = (left ^ right) & 0xAAAAAAAAU;
  left = left ^ work1;
  right = right ^ work1;
  left = (((((usqInt)(left) << 1))) | ((((usqInt)(left)) >> 0x1F) & 1)) &
         0xFFFFFFFFU;
...
static sqInt processKeymodeto(unsigned char *keyPtr, sqInt encode,
  ...
  for (j = 0; j <= 55; j += 1) {
    l = pc1[j];
    m = l & 7;
    if ((keyPtr[((usqInt)(l)) >> 3]) & (byteBit[m])) {
      pc1m[j] = 1;
    } else {
      pc1m[j] = 0;
    }
...
void *DESPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveDESCookKey\000\001\003",
     (void *)primitiveDESCookKey},
    {(void *)_m, "primitiveDESPluginAvailable\000\377\001",
     (void *)primitiveDESPluginAvailable},
    {(void *)_m, "primitiveDESTransform\000\001\001",
     (void *)primitiveDESTransform},
