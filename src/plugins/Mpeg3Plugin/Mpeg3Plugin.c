/* Automatically generated by
   ...
   89cfcf0e-7f62-4687-b4a0-b2e75c471fd9 (Compiler-eem.513) from Mpeg3Plugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "Mpeg3Plugin VMMaker.oscog-eem.3509 uuid: "
...
static const char *moduleName = "Mpeg3Plugin VMMaker.oscog-eem.3509 " INT_EXT;
static mpeg3_t *mpegFiles[1024 + 1];

/*** Methods ***/

/* Mpeg3Plugin>>#checkFileEntry: */
sqInt checkFileEntry(mpeg3_t *aMpegFile) {
  sqInt i;
...
sqInt makeFileEntry(mpeg3_t *aMpegFile) {
  sqInt i;
...
static mpeg3_t *mpeg3tValueOf(sqInt mpeg3tHandle) {
  ...
  check = 0;
  success((isBytes(mpeg3tHandle)) && ((byteSizeOf(mpeg3tHandle)) == 4));
  if (failed()) {
    return null;
  } else {
...
primitiveMPEG3GenerateToc(void) {
  ...
  if (!((isIntegerObject((timecode = stackValue(2)))) &&
        ((isBooleanObject(stackValue(1))) && (isBytes(stackValue(0)))))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
...
primitiveMPEG3ReadAudio(void) {
  ...
  result = mpeg3_read_audio(file, (float *)NULL, arrayBase, aChannelNumber,
                            aSampleNumber, aNumber);
  if (!(failed())) {
    methodReturnInteger(result);
  }
  return null;
...
primitiveMPEG3ReadFrame(void) {
  ...
  outputRowsPtr =
      (unsigned char **)memoryAllocate(1, sizeof(unsigned char *) * outHeight);
  for (i = 0; i < outHeight; i += 1) {
    outputRowsPtr[i] = (bufferBaseAddr + (aByteNumber * i));
  }
  result = mpeg3_read_frame(file, outputRowsPtr, xNumber, yNumber, width,
                            height, outWidth, outHeight, model, aNumber);
...
primitiveMPEG3ReReadAudio(void) {
  ...
  result = mpeg3_reread_audio(file, (float *)NULL, arrayBase, aChannelNumber,
                              aSampleNumber, aNumber);
  if (!(failed())) {
    methodReturnInteger(result);
  }
...
sqInt removeFileEntry(mpeg3_t *aMpegFile) {
  sqInt i;
...
void *Mpeg3Plugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveMPEG3AudioChannels\000\001\000",
     (void *)primitiveMPEG3AudioChannels},
    {(void *)_m, "primitiveMPEG3AudioSamples\000\001\000",
     (void *)primitiveMPEG3AudioSamples},
    {(void *)_m, "primitiveMPEG3CheckSig\000\000\000",
     (void *)primitiveMPEG3CheckSig},
    {(void *)_m, "primitiveMPEG3Close\000\001\000",
     (void *)primitiveMPEG3Close},
    {(void *)_m, "primitiveMPEG3DropFrames\000\001\000",
     (void *)primitiveMPEG3DropFrames},
    {(void *)_m, "primitiveMPEG3EndOfAudio\000\001\000",
     (void *)primitiveMPEG3EndOfAudio},
    {(void *)_m, "primitiveMPEG3EndOfVideo\000\001\000",
     (void *)primitiveMPEG3EndOfVideo},
    {(void *)_m, "primitiveMPEG3FrameRate\000\001\000",
     (void *)primitiveMPEG3FrameRate},
    {(void *)_m, "primitiveMPEG3GenerateToc\000\001\000",
     (void *)primitiveMPEG3GenerateToc},
    {(void *)_m, "primitiveMPEG3GetFrame\000\001\000",
     (void *)primitiveMPEG3GetFrame},
    {(void *)_m, "primitiveMPEG3GetSample\000\001\000",
     (void *)primitiveMPEG3GetSample},
    {(void *)_m, "primitiveMPEG3GetTime\000\001\000",
     (void *)primitiveMPEG3GetTime},
    {(void *)_m, "primitiveMPEG3HasAudio\000\001\000",
     (void *)primitiveMPEG3HasAudio},
    {(void *)_m, "primitiveMPEG3HasVideo\000\001\000",
     (void *)primitiveMPEG3HasVideo},
    {(void *)_m, "primitiveMPEG3Open\000\000\000", (void *)primitiveMPEG3Open},
    {(void *)_m, "primitiveMPEG3OpenABuffer\000\000\000",
     (void *)primitiveMPEG3OpenABuffer},
    {(void *)_m, "primitiveMPEG3PreviousFrame\000\001\000",
     (void *)primitiveMPEG3PreviousFrame},
    {(void *)_m, "primitiveMPEG3ReadAudio\000\001\000",
     (void *)primitiveMPEG3ReadAudio},
    {(void *)_m, "primitiveMPEG3ReadFrame\000\001\000",
     (void *)primitiveMPEG3ReadFrame},
    {(void *)_m, "primitiveMPEG3ReadFrameBufferOffset\000\001\000",
     (void *)primitiveMPEG3ReadFrameBufferOffset},
    {(void *)_m, "primitiveMPEG3ReReadAudio\000\001\000",
     (void *)primitiveMPEG3ReReadAudio},
    {(void *)_m, "primitiveMPEG3SampleRate\000\001\000",
     (void *)primitiveMPEG3SampleRate},
    {(void *)_m, "primitiveMPEG3SeekPercentage\000\001\000",
     (void *)primitiveMPEG3SeekPercentage},
    {(void *)_m, "primitiveMPEG3SetCpus\000\001\000",
     (void *)primitiveMPEG3SetCpus},
    {(void *)_m, "primitiveMPEG3SetFrame\000\001\000",
     (void *)primitiveMPEG3SetFrame},
    {(void *)_m, "primitiveMPEG3SetMmx\000\001\000",
     (void *)primitiveMPEG3SetMmx},
    {(void *)_m, "primitiveMPEG3SetSample\000\001\000",
     (void *)primitiveMPEG3SetSample},
    {(void *)_m, "primitiveMPEG3TellPercentage\000\001\000",
     (void *)primitiveMPEG3TellPercentage},
    {(void *)_m, "primitiveMPEG3TotalAStreams\000\001\000",
     (void *)primitiveMPEG3TotalAStreams},
    {(void *)_m, "primitiveMPEG3TotalVStreams\000\001\000",
     (void *)primitiveMPEG3TotalVStreams},
    {(void *)_m, "primitiveMPEG3VideoFrames\000\001\000",
     (void *)primitiveMPEG3VideoFrames},
    {(void *)_m, "primitiveMPEG3VideoHeight\000\001\000",
     (void *)primitiveMPEG3VideoHeight},
    {(void *)_m, "primitiveMPEG3VideoWidth\000\001\000",
     (void *)primitiveMPEG3VideoWidth},
