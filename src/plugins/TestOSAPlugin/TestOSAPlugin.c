/* Automatically generated by
   ...
   b4089b49-1494-49d2-8966-57cba5c92194 from TestOSAPlugin
   VMMaker.oscog-eem.1950 uuid: b4089b49-1494-49d2-8966-57cba5c92194
 */
#if defined(__clang__) || defined(__GNUC__)
static const char __buildInfo[] __attribute__((unused)) =
    "TestOSAPlugin VMMaker.oscog-eem.1950 uuid: "
    "b4089b49-1494-49d2-8966-57cba5c92194 " __DATE__;
#else
...
primAECoerceDesc(void) {
  ...
  _return_value =
      positive32BitIntegerFor((AECoerceDesc(rcvr, *typeCode, result)));
  if (failed()) {
    return null;
  }
...
primAECreateDesc(void) {
  ...
  _return_value =
      positive32BitIntegerFor((AECreateDesc(*typeCode, aString, size, rcvr)));
  if (failed()) {
    return null;
  }
  popthenPush(3, _return_value);
...
primAEGetKeyPtr(void) {
  ...
  _return_value = positive32BitIntegerFor(
      (AEGetKeyPtr(rcvr, *key, *type, ignoreDesc, bytes, size, &ignoreSize)));
  if (failed()) {
    return null;
  }
...
primGetHandleSize(void) {
  ...
  _return_value =
      positive32BitIntegerFor((GetHandleSize((Handle) * (rcvr + anIndex))));
  if (failed()) {
    return null;
  }
  popthenPush(2, _return_value);
...
primOSACompile(void) {
  ...
  _return_value =
      positive32BitIntegerFor((OSACompile(*component, source, mode, object)));
  if (failed()) {
    return null;
  }
...
primOSADisplay(void) {
  ...
  _return_value = positive32BitIntegerFor(
      (OSADisplay(*component, *source, *type, mode, result)));
  if (failed()) {
    return null;
  }
  popthenPush(5, _return_value);
...
primOSAGetScriptInfo(void) {
  ...
  _return_value = positive32BitIntegerFor((OSAGetScriptInfo(
      *component, *aScriptID, *aDescType, (long *)resultData)));
  if (failed()) {
    return null;
  }
  popthenPush(4, _return_value);
...
primOSAGetSource(void) {
  ...
  _return_value = positive32BitIntegerFor(
      (OSAGetSource(*component, *aScriptID, *aDescType, resultData)));
  if (failed()) {
    return null;
  }
  popthenPush(4, _return_value);
...
primOSALoad(void) {
  ...
  _return_value =
      positive32BitIntegerFor((OSALoad(*component, source, mode, result)));
  if (failed()) {
    return null;
  }
  popthenPush(4, _return_value);
...
primOSAMakeContext(void) {
  ...
  _return_value = positive32BitIntegerFor(
      (OSAMakeContext(*component, name, *parent, result)));
  if (failed()) {
    return null;
  }
  popthenPush(4, _return_value);
...
primOSAScriptError(void) {
  ...
  _return_value = positive32BitIntegerFor(
      (OSAScriptError(*component, *selector, *type, result)));
  if (failed()) {
    return null;
  }
  popthenPush(4, _return_value);
...
primOSAScriptingComponentName(void) {
  ...
  _return_value = positive32BitIntegerFor(
      (OSAScriptingComponentName(*component, anAEDesc)));
  if (failed()) {
    return null;
  }
  popthenPush(2, _return_value);
...
primOSAStore(void) {
  ...
  _return_value = positive32BitIntegerFor(
      (OSAStore(*component, *source, *type, mode, result)));
  if (failed()) {
    return null;
  }
  popthenPush(5, _return_value);
...
void *TestOSAPlugin_exports[][3] = {
    ...
    {(void *)_m, "primOpenDefaultConfiguration\000\377",
     (void *)primOpenDefaultConfiguration},
    ...
    {(void *)_m, "primOSAScriptingComponentName\000\377",
     (void *)primOSAScriptingComponentName},
