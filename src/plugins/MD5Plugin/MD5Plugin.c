/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from MD5Plugin
...
static const char __buildInfo[] __attribute__((unused)) =
    "MD5Plugin CryptographyPlugins-eem.30 uuid: "
...
static const char *moduleName = "MD5Plugin CryptographyPlugins-eem.30 " INT_EXT;
...
primitiveDecodeState(void) {
  ...
  if (!((isBytes(bytesOop)) && ((stSizeOf(bytesOop)) == 16))) {
...
primitiveProcessBufferWithState(void) {
  ...
  if (!((isBytes(bufferOop)) &&
        (((stSizeOf(bufferOop)) == 64) &&
         ((isBytes(stateOop)) && ((stSizeOf(stateOop)) == 16))))) {
    return primitiveFailFor(PrimErrBadArgument);
  }
...
void *MD5Plugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveDecodeState\000\001\001",
     (void *)primitiveDecodeState},
    {(void *)_m, "primitiveInitializeState\000\001\001",
     (void *)primitiveInitializeState},
    {(void *)_m, "primitivePluginAvailable\000\377\001",
     (void *)primitivePluginAvailable},
    {(void *)_m, "primitiveProcessBufferWithState\000\001\001",
