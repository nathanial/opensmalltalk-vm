/* Automatically generated by
   ...
   d9ef6856-42d8-4074-bde7-82f1e1d41282 (Compiler-eem.512) from ADPCMCodecPlugin
   VMMaker.oscog-eem.3475 uuid: d9ef6856-42d8-4074-bde7-82f1e1d41282 ADPCMCodec
   * Sound-mt.97 uuid: 122e8e23-da9c-9b48-b787-b6478bd54df7
 */
...
static const char *moduleName =
    "ADPCMCodecPlugin VMMaker.oscog-eem.3475 " INT_EXT;
...
primitiveEncodeMono(void) {
  ...
  for (i = 1; i <= count; i += 1) {
    ...
    l2:;
      ...
      /* Compute encoded delta and the difference that this will cause in the
         predicted sample value during decoding. Note that this code
         approximates: delta := (4 * diff) / step. predictedDelta := ((delta +
         0.5) * step) / 4; but in the shift step bits are dropped. Thus, even if
         you have fast mul/div hardware you cannot use it since you would get
         slightly different bits what than the algorithm defines. */
      delta = 0;
      predictedDelta = 0;
      bit = deltaValueHighBit;
      while (bit > 0) {
...
void *ADPCMCodecPlugin_exports[][3] = {
    ...
    {(void *)_m, "primitiveDecodeMono\000\377\000",
     (void *)primitiveDecodeMono},
    {(void *)_m, "primitiveDecodeStereo\000\377\000",
     (void *)primitiveDecodeStereo},
    {(void *)_m, "primitiveEncodeMono\000\377\000",
     (void *)primitiveEncodeMono},
    {(void *)_m, "primitiveEncodeStereo\000\377\000",
