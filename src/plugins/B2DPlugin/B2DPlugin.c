/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-eem.3634 uuid: 8a640496-a277-4c3e-be09-22770a14fb3c
	(* Compiler-ct.519)
   from
	BalloonEnginePlugin VMMaker.oscog-eem.3634 uuid: 8a640496-a277-4c3e-be09-22770a14fb3c
 */
static char __buildInfo[] = "BalloonEnginePlugin VMMaker.oscog-eem.3634 uuid: 8a640496-a277-4c3e-be09-22770a14fb3c " __DATE__ ;
...
static sqInt loadCompressedShapeFromIntPointssegmentsleftFillsrightFillslineWidthslineFillsfillIndexList(int *points, sqInt nSegments, int *leftFills, int *rightFills, int *lineWidths, int *lineFills, int *fillIndexList);
static sqInt loadCompressedShapeFromShortPointssegmentsleftFillsrightFillslineWidthslineFillsfillIndexList(short *points, sqInt nSegments, int *leftFills, int *rightFills, int *lineWidths, int *lineFills, int *fillIndexList);
...
static sqInt loadShapeFromArraynSegmentsfilllineWidthlineFill(sqInt points, sqInt nSegments, sqInt fillIndex, sqInt lineWidth, sqInt lineFill);
static sqInt loadSpanBufferFrom(sqInt spanOop);
static sqInt loadTransformFromArrayintolength(sqInt transformOop, float *destPtr, sqInt n);
...
static sqInt
loadCompressedShapeFromIntPointssegmentsleftFillsrightFillslineWidthslineFillsfillIndexList(int *points, sqInt nSegments, int *leftFills, int *rightFills, int *lineWidths, int *lineFills, int *fillIndexList)
{
    int *dstPoint1;
    sqInt i;
    sqInt index;
	...
	for (i = 1; i <= nSegments; i += 1) {
		...
		/* begin loadCompressedSegment:fromIntPoints:leftFill:rightFill:lineWidth:lineColor: */
		...
		/* end loadCompressedSegment:fromIntPoints:leftFill:rightFill:lineWidth:lineColor: */
l1:
		if (engineStopped) {
			return null;
		}
...
static sqInt
loadCompressedShapeFromShortPointssegmentsleftFillsrightFillslineWidthslineFillsfillIndexList(short *points, sqInt nSegments, int *leftFills, int *rightFills, int *lineWidths, int *lineFills, int *fillIndexList)
{
    int *dstPoint1;
    sqInt i;
    sqInt index;
	...
	for (i = 1; i <= nSegments; i += 1) {
		...
		/* begin loadCompressedSegment:fromShortPoints:leftFill:rightFill:lineWidth:lineColor: */
		if ((leftValue == rightValue)
		 && ((widthValue == 0)
		 || (lineFillValue == 0))) {
			goto l1;
		...
		loadWideBezierlineFillleftFillrightFilln(widthValue, lineFillValue, leftValue, rightValue, segs);
		/* end loadCompressedSegment:fromShortPoints:leftFill:rightFill:lineWidth:lineColor: */
l1:
		if (engineStopped) {
			return null;
		}
...
loadGradientFillfromalongnormalisRadial(sqInt rampOop, int *point1, int *point2, int *point3, sqInt isRadial)
{
	...
	if (workBuffer[GWHasColorTransform]) {
		for (i = 0; i < rampWidth; i += 1) {
			rampPtr[i] = (transformColor((((int *) (firstIndexableField(rampOop))))[i]));
		}
	}
	else {
		for (i = 0; i < rampWidth; i += 1) {
...
static sqInt
loadShapeFromArraynSegmentsfilllineWidthlineFill(sqInt points, sqInt nSegments, sqInt fillIndex, sqInt lineWidth, sqInt lineFill)
{
    int *dstPoint1;
    sqInt i;
    int *point;
...
static sqInt
loadTransformFromArrayintolength(sqInt transformOop, float *destPtr, sqInt n)
{
    sqInt i;
    sqInt value;
...
primitiveAddBezierShape(void)
{
	...
	if (pointsIsArray) {
		loadShapeFromArraynSegmentsfilllineWidthlineFill(points, nSegments, fillIndex, lineWidth, lineFill);
	}
	else {
		if (pointsIsShorts) {
...
primitiveAddCompressedShape(void)
{
	...
	if ((slotSizeOf(points)) == (nSegments * 3)) {
		loadCompressedShapeFromShortPointssegmentsleftFillsrightFillslineWidthslineFillsfillIndexList(((short *) (firstIndexableField(points))), nSegments, ((int *) (firstIndexableField(leftFills))), ((int *) (firstIndexableField(rightFills))), ((int *) (firstIndexableField(lineWidths))), ((int *) (firstIndexableField(lineFills))), ((int *) (firstIndexableField(fillIndexList))));
	}
	else {
		loadCompressedShapeFromIntPointssegmentsleftFillsrightFillslineWidthslineFillsfillIndexList(((int *) (firstIndexableField(points))), nSegments, ((int *) (firstIndexableField(leftFills))), ((int *) (firstIndexableField(rightFills))), ((int *) (firstIndexableField(lineWidths))), ((int *) (firstIndexableField(lineFills))), ((int *) (firstIndexableField(fillIndexList))));
	}
	if (engineStopped) {
		return primitiveFailFor(GEFEngineStopped);
	}
...
primitiveMergeFillFrom(void)
{
	...
	fillBitmapSpanfromto(((int *) (firstIndexableField(bitsOop))), workBuffer[GWLastExportedLeftX], workBuffer[GWLastExportedRightX]);
...
primitiveNeedsFlushPut(void)
{
	...
	/* needsFlushPut: */
	workBuffer[GWNeedsFlush] = ((needFlush
		? 1
		: 0));
...
/*	Condense the trio of
	...
	into two primitives:
	[(reason := self primRenderAllScanlines: edge with: fill) ~= 0] whileTrue:
	[self processStopReason: reason edge: edge fill: fill]. */
...
void* B2DPlugin_exports[][3] = {
	...
	{(void*)_m, "primitiveGetAllStats\000\002\003", (void*)primitiveGetAllStats},
	...
	{(void*)_m, "primitiveRenderAllScanlines\000\377\000", (void*)primitiveRenderAllScanlines},
