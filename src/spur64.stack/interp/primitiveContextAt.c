		...
		if ((oopisGreaterThanOrEqualTo(index, /* firstValidIndexOfIndexableObject:withFormat: */
		 ...
		 && (oopisLessThanOrEqualTo(index, stSizeSqInt))) {
			...
			if (fmtUsqLong <= 5 /* lastPointerFormat */) {
				value = longAt((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFieldsSqInt) - 1)) << (shiftForWord()))))));
				goto l8;
			}
			if (fmtUsqLong >= (firstByteFormat())) {
				value = (((usqInt)(byteAt((void *)((aContext + BaseHeaderSize) + ((index + fixedFieldsSqInt) - 1)))) << 3) | 1);
				goto l8;
			}
			if (fmtUsqLong >= (firstShortFormat())) {
				value = (((usqInt)(((unsigned short) (shortAt((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFieldsSqInt) - 1)) << 1)))))))) << 3) | 1);
				goto l8;
			}
			if (fmtUsqLong == (sixtyFourBitIndexableFormat())) {
				value = positive64BitIntegerFor(long64At((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFieldsSqInt) - 1)) << 3))))));
				goto l8;
			}

			/* 32bit-word type objects; for now assume no 64-bit indexable objects */
			value = ((((((usqInt)(long32At((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFieldsSqInt) - 1)) << 2)))))))) & 0xFFFFFFFFU) << 3) | 1);
			goto l8;
		}
...
l1:
		...
		if (fmt <= 5 /* lastPointerFormat */) {
			value = longAt((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFields) - 1)) << (shiftForWord()))))));
			goto l2;
		}
		if (fmt >= (firstByteFormat())) {
			value = (((usqInt)(byteAt((void *)((aContext + BaseHeaderSize) + ((index + fixedFields) - 1)))) << 3) | 1);
			goto l2;
		}
		if (fmt >= (firstShortFormat())) {
			value = (((usqInt)(((unsigned short) (shortAt((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFields) - 1)) << 1)))))))) << 3) | 1);
			goto l2;
		}
		if (fmt == (sixtyFourBitIndexableFormat())) {
			value = positive64BitIntegerFor(long64At((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFields) - 1)) << 3))))));
			goto l2;
		}

		/* 32bit-word type objects; for now assume no 64-bit indexable objects */
		value = ((((((usqInt)(long32At((void *)((aContext + BaseHeaderSize) + ((((usqInt)(((index + fixedFields) - 1)) << 2)))))))) & 0xFFFFFFFFU) << 3) | 1);
