...
static void primitiveGetNextEvent(void) {
  ...
  static char *eventTypeNames[] = {"None",          "Mouse",      "Keyboard",
                                   "DragDropFiles", "Menu",       "Window",
                                   "Complex",       "MouseWheel", "Plugin"};
  ...
  if ((eventTraceMask != 0) &&
      (((eventTraceMask &
         ((((evtBuf[0]) < 0) ? (((usqInt)(1)) >> (-(evtBuf[0])))
                             : (1ULL << (evtBuf[0]))))) != 0))) {
    fprintf(
        stderr,
        "Event%s/%" PRIdSQINT " @ %" PRIuSQINT "\t\t%" PRIdSQINT "/%" PRIxSQINT
        " %" PRIdSQINT "/%" PRIxSQINT "\n\t%" PRIdSQINT "/%" PRIxSQINT
        " %" PRIdSQINT "/%" PRIxSQINT "\t %" PRIdSQINT "/%" PRIxSQINT " %p\n",
        ((((evtBuf[0]) >= 0) && ((evtBuf[0]) <= 8)) ? eventTypeNames[evtBuf[0]]
                                                    : "?"),
        evtBuf[0], evtBuf[1], evtBuf[2], evtBuf[2], evtBuf[3], evtBuf[3],
        evtBuf[4], evtBuf[4], evtBuf[5], evtBuf[5], evtBuf[6], evtBuf[6],
        ((void *)(evtBuf[7])));
  }
  ...
  if ((((((usqInt)(integerValue)) >> 60) + 1) & 15) <= 1) {
    ...
    assert((isNonImmediate(arg)) && (!(isForwarded(arg))));
    assert(validStorePointerUncheckedArgs(0, arg,
                                          (((usqInt)integerValue << 3) | 1)));
    longAtput((void *)((arg + BaseHeaderSize) + (0U << (shiftForWord()))),
              (((usqInt)integerValue << 3) | 1));
  } else {
    /* begin primitiveFail */
    if (!primFailCode) {
  ...
  if (eventTypeIs == 6) {
    ...
    if ((((((usqInt)(integerValue)) >> 60) + 1) & 15) <= 1) {
      /* begin storePointerUnchecked:ofObject:withValue: */
      assert((isNonImmediate(arg)) && (!(isForwarded(arg))));
      assert(validStorePointerUncheckedArgs(1, arg,
                                            (((usqInt)integerValue << 3) | 1)));
      longAtput((void *)((arg + BaseHeaderSize) + (1U << (shiftForWord()))),
                (((usqInt)integerValue << 3) | 1));
    } else {
      /* begin primitiveFail */
      if (!primFailCode) {
    ...
    for (i = 2; i <= 7; i += 1) {
      ...
      if ((((((usqIntptr_t)(value)) >> 60) + 1) & 15) <= 1) {
        ...
        if ((((((usqIntptr_t)(value)) >> 60) + 1) & 15) <= 1) {
          /* begin storePointerUnchecked:ofObject:withValue: */
          assert((isNonImmediate(arg)) && (!(isForwarded(arg))));
          assert(validStorePointerUncheckedArgs(i, arg,
                                                (((usqInt)value << 3) | 1)));
