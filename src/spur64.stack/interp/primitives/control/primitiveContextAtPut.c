...
static void primitiveContextAtPut(void) {
  ...
  l8:
    ...
    if ((oopisGreaterThanOrEqualTo(
      ...
      if (fmtUsqLong >= (firstByteFormat())) {
        ...
        byteAtput((void *)((aContext + BaseHeaderSize) +
      ...
      if (fmtUsqLong >= (firstShortFormat())) {
        ...
        shortAtput(
            (void *)((aContext + BaseHeaderSize) +
                     ((((usqInt)(((index + fixedFieldsSqInt) - 1)) << 1)))),
            signedValueToStore);
        goto l7;
      }
      if (fmtUsqLong == (sixtyFourBitIndexableFormat())) {
      ...
      if (!primFailCode) {
        ...
        long32Atput(
            (void *)((aContext + BaseHeaderSize) +
                     ((((usqInt)(((index + fixedFieldsSqInt) - 1)) << 2)))),
  ...
  l1:
    ...
    if (fmt >= (firstByteFormat())) {
      ...
      /* storeByte:ofObject:withValue: */
      byteAtput(
          (void *)((aContext + BaseHeaderSize) + ((index + fixedFields) - 1)),
          signedValueToStore);
      goto l4;
    }
    if (fmt >= (firstShortFormat())) {
      ...
      /* storeShort16:ofObject:withValue: */
      shortAtput((void *)((aContext + BaseHeaderSize) +
    ...
    if (fmt == (sixtyFourBitIndexableFormat())) {
      ...
      if (!primFailCode) {
        /* storeLong64:ofObject:withValue: */
        long64Atput((void *)((aContext + BaseHeaderSize) +
    ...
    if (!primFailCode) {
      /* storeLong32:ofObject:withValue: */
      long32Atput((void *)((aContext + BaseHeaderSize) +
  ...
  if ((index - 1) < ((frameNumArgs = byteAt((spouseFP + FoxFrameFlags) + 1)))) {
    longAtput((spouseFP + FoxCallerSavedIP) +
                  ((frameNumArgs - (index - 1)) * BytesPerWord),
              value);
  } else {
    longAtput(((spouseFP + FoxReceiver) - BytesPerWord) +
                  ((frameNumArgs - (index - 1)) * BytesPerWord),
              value);
  }
