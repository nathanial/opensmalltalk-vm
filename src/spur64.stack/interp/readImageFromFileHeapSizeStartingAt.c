...
l1:
	...
	heapSize = (((heapSizeUsqInt & ((1ULL << bit) - 1)) != 0)
				? (((heapSizeUsqInt | ((1ULL << bit) - 1)) - ((1ULL << bit) - 1))) + (1ULL << bit)
				: heapSizeUsqInt);
	if ((mem = ((usqInt)(allocateMemoryMinimumImageFileHeaderSize(heapSize, minimumMemory, f, headerSize))))) {
	...
	if (((numSlots = byteAt((void *)(classArrayClass + (numSlotsFieldByteOffset()))))) == (numSlotsMask())) {
		toDoLimit = ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(classArrayClass - BaseHeaderSize)))) << 8)))))) >> 8;
	}
	else {
		toDoLimit = numSlots;
	}
	...
	if (((numSlots = byteAt((void *)(classArrayObj + (numSlotsFieldByteOffset()))))) == (numSlotsMask())) {
		toDoLimit1 = ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(classArrayObj - BaseHeaderSize)))) << 8)))))) >> 8;
	}
	else {
		toDoLimit1 = numSlots;
	}
