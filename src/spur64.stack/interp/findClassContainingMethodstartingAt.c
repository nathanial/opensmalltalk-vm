...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (/* isOopForwarded: */
		((!(classObj & (tagMask()))))
	 && ((!((longAt((void *)(classObj))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
		/* begin followForwarded: */
		assert(isUnambiguouslyForwarder(classObj));
		currClass = longAt((void *)((classObj + BaseHeaderSize) + (0U << (shiftForWord()))));
		while (/* isOopForwarded: */
			((!(currClass & (tagMask()))))
		 && ((!((longAt((void *)(currClass))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
			currClass = longAt((void *)((currClass + BaseHeaderSize) + (0U << (shiftForWord()))));
		}
	}
	else {
		currClass = classObj;
	...
	do {
		...
		classDict = longAt((void *)((currClass + BaseHeaderSize) + ((((usqInt)(MethodDictionaryIndex) << (shiftForWord()))))));
		if (/* isOopForwarded: */
			((!(classDict & (tagMask()))))
		...
		if (classDictSize > MethodArrayIndex) {
			...
			if (/* isOopForwarded: */
			 ...
			 && ((!((longAt((void *)(methodArray))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
				...
				referentSqInt = longAt((void *)((methodArray + BaseHeaderSize) + (0U << (shiftForWord()))));
				while (/* isOopForwarded: */
		...
		/* begin noFixupFollowField:ofObject: */
		objOop = longAt((void *)((currClass + BaseHeaderSize) + ((((usqInt)(SuperclassIndex) << (shiftForWord()))))));
		if (/* isOopForwarded: */
			((!(objOop & (tagMask()))))
		 && ((!((longAt((void *)(objOop))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
			/* begin followForwarded: */
			assert(isUnambiguouslyForwarder(objOop));
			referentSqInt = longAt((void *)((objOop + BaseHeaderSize) + (0U << (shiftForWord()))));
			while (/* isOopForwarded: */
				((!(referentSqInt & (tagMask()))))
			 && ((!((longAt((void *)(referentSqInt))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
				referentSqInt = longAt((void *)((referentSqInt + BaseHeaderSize) + (0U << (shiftForWord()))));
