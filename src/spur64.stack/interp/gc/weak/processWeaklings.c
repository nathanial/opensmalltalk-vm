...
static void processWeaklings(void) {
  ...
  while (i < rememberedSetSize) {
    ...
    /* begin isWeakNonImm: */
    format = (byteAt((void *)(rootObj + (formatFieldByteOffset())))) &
             (formatMask());
  ...
  if (weakList) {
    weakCorpse =
        ((((usqInt)((weakList - 1)) << 3 /* shiftForAllocationUnit */))) +
        newSpaceStart;
    while (weakCorpse) {
      ...
      if ((processWeakSurvivor(weakObj)) &&
          (((/* begin isOldObject: */
           ...
           (!(((byteAt((void *)(weakObj + (formatFieldByteOffset())))) &
      ...
      listOffset = ((((usqInt)(((long32At((void *)(weakCorpse + 4))) &
                                (identityHashHalfWordMask())))
                      << (formatFieldWidthShift())))) +
                   ((byteAt((void *)(weakCorpse + (formatFieldByteOffset())))) &
                    (formatMask()));
      weakCorpse =
