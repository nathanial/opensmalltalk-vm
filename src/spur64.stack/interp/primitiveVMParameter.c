...
primitiveVMParameter(void)
{
	...
	if (!argumentCount) {
		...
		resultSqInt = instantiateClassindexableSize(longAt((void *)((specialObjectsOop + BaseHeaderSize) + ((((usqInt)(ClassArray) << (shiftForWord())))))), paramsArraySize);
		...
		valuePointer = (((usqInt)((freeStart - (((eden).start))) + (pastSpaceStart - (((pastSpace).start)))) << 3) | 1);
...
totalHeapSizeIncludingBridges)));
		...
		valuePointer = (((usqInt)(((sqInt)(((scavengerTenuringThreshold()) * (((pastSpace.limit)) - ((pastSpace.start)))) / (8 * BytesPerOop)))) << 3) | 1);
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(6, resultSqInt, (((usqInt)statFullGCs << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (6U << (shiftForWord()))),(((usqInt)statFullGCs << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(7, resultSqInt, ((((statFullGCUsecs + 500) / 1000) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (7U << (shiftForWord()))),((((statFullGCUsecs + 500) / 1000) << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(8, resultSqInt, (((usqInt)statScavenges << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (8U << (shiftForWord()))),(((usqInt)statScavenges << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(9, resultSqInt, ((((statScavengeGCUsecs + 500) / 1000) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (9U << (shiftForWord()))),((((statScavengeGCUsecs + 500) / 1000) << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(10, resultSqInt, (((usqInt)statTenures << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (10U << (shiftForWord()))),(((usqInt)statTenures << 3) | 1));
...
#      endif
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(17, resultSqInt, ((((statCompactionUsecs + 500) / 1000) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (17U << (shiftForWord()))),((((statCompactionUsecs + 500) / 1000) << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(21, resultSqInt, (((usqInt)statRootTableOverflows << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (21U << (shiftForWord()))),(((usqInt)statRootTableOverflows << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(23, resultSqInt, (((usqInt)shrinkThreshold << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (23U << (shiftForWord()))),(((usqInt)shrinkThreshold << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(24, resultSqInt, (((usqInt)growHeadroom << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (24U << (shiftForWord()))),(((usqInt)growHeadroom << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(26, resultSqInt, (((usqInt)statMarkCount << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (26U << (shiftForWord()))),(((usqInt)statMarkCount << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(29, resultSqInt, (((usqInt)statCompactPassCount << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (29U << (shiftForWord()))),(((usqInt)statCompactPassCount << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(30, resultSqInt, (((usqInt)statGrowMemory << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (30U << (shiftForWord()))),(((usqInt)statGrowMemory << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(0x1F, resultSqInt, (((usqInt)statShrinkMemory << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (0x1FU << (shiftForWord()))),(((usqInt)statShrinkMemory << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(32, resultSqInt, (((usqInt)statRootTableCount << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (32U << (shiftForWord()))),(((usqInt)statRootTableCount << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(34, resultSqInt, (((usqInt)statSurvivorCount << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (34U << (shiftForWord()))),(((usqInt)statSurvivorCount << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(35, resultSqInt, ((((statGCEndUsecs / 1000) & MillisecondClockMask) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (35U << (shiftForWord()))),((((statGCEndUsecs / 1000) & MillisecondClockMask) << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(37, resultSqInt, ((((statIGCDeltaUsecs + 500) / 1000) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (37U << (shiftForWord()))),((((statIGCDeltaUsecs + 500) / 1000) << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(38, resultSqInt, (((usqInt)statPendingFinalizationSignals << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (38U << (shiftForWord()))),(((usqInt)statPendingFinalizationSignals << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(41, resultSqInt, (((usqInt)numStackPages << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (41U << (shiftForWord()))),(((usqInt)numStackPages << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(43, resultSqInt, (((usqInt)(((eden.limit)) - ((eden.start))) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (43U << (shiftForWord()))),(((usqInt)(((eden.limit)) - ((eden.start))) << 3) | 1));
		...
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (45U << (shiftForWord()))),nilObj);

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(46, resultSqInt, getDesiredCogCodeSize()));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (46U << (shiftForWord()))),nilObj);
		...
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (49U << (shiftForWord()))),nilObj);
		valuePointer = (((usqInt)(((oldImageBaseAddress != oldSpaceStart
		? 1
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(52, resultSqInt, (((usqInt)numSegments << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (52U << (shiftForWord()))),(((usqInt)numSegments << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(53, resultSqInt, ((totalFreeOldSpace << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (53U << (shiftForWord()))),((totalFreeOldSpace << 3) | 1));
		...
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (61U << (shiftForWord()))),nilObj);

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(0x3E, resultSqInt, getCodeCompactionMSecs()));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (0x3EU << (shiftForWord()))),nilObj);
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(65, resultSqInt, (((usqInt)bytesPerPage << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (65U << (shiftForWord()))),(((usqInt)bytesPerPage << 3) | 1));
		...
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(71, resultSqInt, ((((statMarkUsecs + 500) / 1000) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (71U << (shiftForWord()))),((((statMarkUsecs + 500) / 1000) << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(72, resultSqInt, ((((statSweepUsecs + 500) / 1000) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (72U << (shiftForWord()))),((((statSweepUsecs + 500) / 1000) << 3) | 1));

		/* begin storePointerUnchecked:ofObject:withValue: */
		assert((isNonImmediate(resultSqInt))
		 && (!(isForwarded(resultSqInt))));
		assert(validStorePointerUncheckedArgs(73, resultSqInt, (((usqInt)((statMaxAllocSegmentTime + 500) / 1000) << 3) | 1)));
		longAtput((void *)((resultSqInt + BaseHeaderSize) + (73U << (shiftForWord()))),(((usqInt)((statMaxAllocSegmentTime + 500) / 1000) << 3) | 1));
		...
		assert(!((failed())));
		longAtput((sp = stackPointer + (((argumentCount + 1) - 1) * BytesPerWord)),resultSqInt);
		stackPointer = sp;
		return;
	}
	if (argumentCount > 2) {
	...
	/* index read & checks */
	index = longAt(stackPointer + (((argumentCount == 1
		? 0
		: 1)) * BytesPerWord));
	if (!((((index) & 7) == 1))) {
		/* primitiveFailFor: */
	...
	if (argumentCount == 1) {
		...
		case 1:
			...
			break;
		case 2:
			result = (((usqInt)((freeStart - (((eden).start))) + (pastSpaceStart - (((pastSpace).start)))) << 3) | 1);
			goto l1;
			break;
		case 3:
...
totalHeapSizeIncludingBridges)));
			...
			break;
		case 6:
			result = (((usqInt)(((sqInt)(((scavengerTenuringThreshold()) * (((pastSpace.limit)) - ((pastSpace.start)))) / (8 * BytesPerOop)))) << 3) | 1);
			goto l1;
			break;
		case 7:
...
#        endif
		...
		case 50:
			...
			break;
		case 51:
			result = (((usqInt)(((oldImageBaseAddress != oldSpaceStart
		? 1
		: 0)) + ((sqImageFileIsEmbedded()
		? 2
		: 0))) << 3) | 1);
...
l3:;
	...
	case 5:
		break;
	case 6:
		resultSqInt = (((usqInt)(((sqInt)(((scavengerTenuringThreshold()) * (((pastSpace.limit)) - ((pastSpace.start)))) / (8 * BytesPerOop)))) << 3) | 1);
		...
		aProportion = (((double) (arg * (8 * BytesPerOop)) )) / (((double) (((pastSpace.limit)) - ((pastSpace.start))) ));

		/* begin scavengerTenuringThreshold: */
		tenuringProportion = aProportion;
		tenureThreshold = (aProportion == 0.0
					? 0
					: (round(((((pastSpace.limit)) - ((pastSpace.start))) * (1.0 - aProportion)))) + ((pastSpace.start)));
		primFailCode = 0;
...
l5:
	...
	case 74:
		if (arg >= 0) {
			resultSqInt = (((usqInt)((statMaxAllocSegmentTime + 500) / 1000) << 3) | 1);
