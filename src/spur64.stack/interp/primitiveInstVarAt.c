	...
	if ((fmt == (indexablePointersFormat()))
	 && ((hdr & (classIndexMask())) == ClassMethodContextCompactIndex)) {
		...
		if (fmt <= 5 /* lastPointerFormat */) {
			value = longAt((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((index - 1)) << (shiftForWord()))))));
			goto l1;
		}
		if (fmt >= (firstByteFormat())) {
			value = (((usqInt)(byteAt((void *)((rcvr + BaseHeaderSize) + (index - 1)))) << 3) | 1);
			goto l1;
		}
		if (fmt >= (firstShortFormat())) {
			value = (((usqInt)(((unsigned short) (shortAt((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((index - 1)) << 1)))))))) << 3) | 1);
			goto l1;
		}
		if (fmt == (sixtyFourBitIndexableFormat())) {
			value = positive64BitIntegerFor(long64At((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((index - 1)) << 3))))));
			goto l1;
		}

		/* 32bit-word type objects; for now assume no 64-bit indexable objects */
		value = ((((((usqInt)(long32At((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((index - 1)) << 2)))))))) & 0xFFFFFFFFU) << 3) | 1);
