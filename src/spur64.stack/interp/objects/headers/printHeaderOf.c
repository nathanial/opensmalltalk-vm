...
void printHeaderOf(sqInt objOop) {
  ...
  /* printHexnp: */
  fprintf(transcript, "%p", ((void *)objOop));
  if ((byteAt((void *)(objOop + (numSlotsFieldByteOffset())))) ==
    ...
    fprintf(
        transcript, "%p",
        ((void *)(((((usqInt)(((sqInt)((usqInt)((longAt(
  ...
  printChar(' ');
  printChar(((byteAt((void *)(objOop + (markBitsByteOffset())))) &
  ...
  printChar(((byteAt((void *)(objOop + (markBitsByteOffset())))) &
                 ...
                 ? 'G'
                 : 'g'));
  printChar(((byteAt((void *)(objOop + (formatFieldByteOffset())))) &
