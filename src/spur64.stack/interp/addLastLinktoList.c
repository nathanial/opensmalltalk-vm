...
static void addLastLinktoList(sqInt proc, sqInt aList) {
  ...
  /* begin isEmptyList: */
  assert(!(isForwarded(aList)));
  if ((longAt((void *)((aList + BaseHeaderSize) +
    ...
    if (oopisGreaterThanOrEqualTo(aList, oldSpaceStart)) {
      if (/* isYoung: */
          ((!(proc & (tagMask())))) && (oopisLessThan(proc, oldSpaceStart))) {
    ...
    if (oopisGreaterThanOrEqualTo(lastLink, oldSpaceStart)) {
      if (/* isYoung: */
          ((!(proc & (tagMask())))) && (oopisLessThan(proc, oldSpaceStart))) {
        /* begin possibleRootStoreInto: */
        if (!((byteAt((void *)(lastLink + (formatFieldByteOffset())))) &
              (1U << (rememberedBitByteShift())))) {
          remember(lastLink);
        }
      }
    ...
    /* most stores into young objects */
    longAtput((void *)((lastLink + BaseHeaderSize) +
  ...
  if (oopisGreaterThanOrEqualTo(proc, oldSpaceStart)) {
    if (/* isYoung: */
        ((!(aList & (tagMask())))) && (oopisLessThan(aList, oldSpaceStart))) {
      /* begin possibleRootStoreInto: */
  ...
  /* most stores into young objects */
  longAtput((void *)((proc + BaseHeaderSize) +
