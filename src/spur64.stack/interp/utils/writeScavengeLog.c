...
static NeverInline void writeScavengeLog(void) {
  ...
  fprintf(scavengeLog,
          "scavenge %" PRIdSQINT " eden bytes: 0x%" PRIxSQINT "/%" PRIdSQINT
          " past bytes: 0x%" PRIxSQINT "/%" PRIdSQINT "\n\trem set: %" PRIdSQINT
          " redzone: %" PRIdSQINT " size: %" PRIdSQINT "\n",
          statScavenges, (scavengeLogRecord.sEdenBytes),
          (scavengeLogRecord.sEdenBytes), (scavengeLogRecord.sPastBytes),
  ...
  fprintf(scavengeLog,
          (((scavengeLogRecord.tTenureCriterion)) == TenureToShrinkRT
               ? "\ttenure below 0x%" PRIxSQINT "/%" PRIdSQINT
                 " %s refct %" PRIdSQINT "\n"
  ...
  fprintf(
      scavengeLog,
      "\tsurvivor bytes: 0x%" PRIxSQINT "/%" PRIdSQINT " rem set: %" PRIdSQINT
      " tenured: %" PRIdSQINT " usecs: %" PRIdSQINT "\n",
      (scavengeLogRecord.eSurvivorBytes), (scavengeLogRecord.eSurvivorBytes),
