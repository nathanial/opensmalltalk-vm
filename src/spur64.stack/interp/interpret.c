		...
		case 272: // 16	pushLiteralVariable16CasesBytecode
			{
				...
				/* begin internalPush: */
				longAtput((localSP -= BytesPerOop),longAt((void *)((litVar + BaseHeaderSize) + 8 /* (ValueIndex << shiftForWord) */)));
			}
			break;
...
#        if IMMUTABILITY
				...
				if ((((usqInt)((byteAt((void *)(rcvr + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) {
...
#        endif // IMMUTABILITY
				...
				longAtput((void *)((rcvr + BaseHeaderSize) + ((instVarIndex << (shiftForWord())))),top);
		...
		case 464: // 208	storeAndPopTemporaryVariableBytecode
			{
				...
				if (0 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + (frameNumArgs * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + (frameNumArgs * BytesPerWord),longAt(localSP));
				}
		...
		case 465: // 209	storeAndPopTemporaryVariableBytecode
			{
				...
				if (1 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - 1) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - 1) * BytesPerWord),longAt(localSP));
				}
		...
		case 466: // 210	storeAndPopTemporaryVariableBytecode
			{
				...
				if (2 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - 2) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - 2) * BytesPerWord),longAt(localSP));
				}
		...
		case 467: // 211	storeAndPopTemporaryVariableBytecode
			{
				...
				if (3 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - 3) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - 3) * BytesPerWord),longAt(localSP));
				}
		...
		case 468: // 212	storeAndPopTemporaryVariableBytecode
			{
				...
				if (4 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - 4) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - 4) * BytesPerWord),longAt(localSP));
				}
		...
		case 469: // 213	storeAndPopTemporaryVariableBytecode
			{
				...
				if (5 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - 5) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - 5) * BytesPerWord),longAt(localSP));
				}
		...
		case 470: // 214	storeAndPopTemporaryVariableBytecode
			{
				...
				if (6 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - 6) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - 6) * BytesPerWord),longAt(localSP));
				}
		...
		case 471: // 215	storeAndPopTemporaryVariableBytecode
			{
				...
				if (7 < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - 7) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - 7) * BytesPerWord),longAt(localSP));
				}
		...
		commonReturn:
			/* commonReturn */
			{
				...
				while (closure != nilObj) {
					...
					if ((!((longAt((void *)(home))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun()))))) {
						home = fixFollowedFieldofObjectwithInitialValue(ClosureOuterContextIndex, closure, home);
					}
					if (!(/* isContext: */
							((!(home & (tagMask()))))
						 && (((longAt((void *)(home))) & (classIndexMask())) == ClassMethodContextCompactIndex))) {
...
l158:
					...
					/* begin followObjField:ofObject: */
					closure = longAt((void *)((home + BaseHeaderSize) + ((((usqInt)(ClosureIndex) << (shiftForWord()))))));
					assert(isNonImmediate(closure));
					if ((!((longAt((void *)(closure))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun()))))) {
						closure = fixFollowedFieldofObjectwithInitialValue(ClosureIndex, home, closure);
					}
				}
...
l159:
 ...
 && (ctxtOrNilOrZero == (nilObject())))));
				if (!ctxtOrNilOrZero) {
					theMethod = longAt((void *)((home + BaseHeaderSize) + ((((usqInt)(MethodIndex) << (shiftForWord()))))));
...
l157:
				...
				if (((((longAt((void *)((home + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord())))))))) & 7) == 1)) {
					assert(checkIsStillMarriedContextcurrentFP(home, localFP));

					/* begin frameOfMarriedContext: */
					senderOop = longAt((void *)((home + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord()))))));
					...
					contextToReturnTo = longAt((void *)((home + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord()))))));
					if ((/* isContext: */
						((!(contextToReturnTo & (tagMask()))))
					 && (((longAt((void *)(contextToReturnTo))) & (classIndexMask())) == ClassMethodContextCompactIndex))
					 && (((((longAt((void *)((contextToReturnTo + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord())))))))) & 7) == 1))) {
						assert(checkIsStillMarriedContextcurrentFP(contextToReturnTo, localFP));

						/* begin frameOfMarriedContext: */
						senderOop = longAt((void *)((contextToReturnTo + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord()))))));
						assert((((senderOop) & 7) == 1));
				...
				if (contextToReturnTo) {
					...
					if (((((longAt((void *)((contextToReturnTo + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord())))))))) & 7) == 1)) {
					...
					if (!(((((longAt((void *)((contextToReturnTo + BaseHeaderSize) + ((((usqInt)(InstructionPointerIndex) << (shiftForWord())))))))) & 7) == 1))) {
						frameToReturnTo = 0;
						goto l156;
					}
				...
				if (newPage != stackPage) {
					...
					while (1) {
						...
						if (((((longAt((void *)((currentCtx + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord())))))))) & 7) == 1)) {
							...
							nextCntx = longAt((void *)((currentCtx + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord()))))));
...
l163:
						...
						if (!(isAContext
							 && (((((longAt((void *)((contextToReturnTo + BaseHeaderSize) + ((((usqInt)(InstructionPointerIndex) << (shiftForWord())))))))) & 7) == 1)))) {
							/* begin internalCannotReturn: */
							/* begin ensureFrameIsMarried:SP: */
							if (byteAt((localFP + FoxFrameFlags) + 2)) {
								assert(isContext(frameContext(localFP)));
		...
		case 128: // extendedPushBytecode
			{
				...
				if (!variableType) {
					...
					/* begin internalPush: */
					longAtput((localSP -= BytesPerOop),longAt((void *)(((longAt(localFP + FoxReceiver)) + BaseHeaderSize) + ((variableIndex << (shiftForWord()))))));
					goto l2;
				}
				if (variableType == 1) {
				...
				if (variableType == 3) {
					...
					/* begin internalPush: */
					longAtput((localSP -= BytesPerOop),longAt((void *)((litVar + BaseHeaderSize) + ((((usqInt)(ValueIndex) << (shiftForWord())))))));
					goto l2;
				}
			}
			/* end case */
...
#          if IMMUTABILITY
					...
					if ((((usqInt)((byteAt((void *)(objOop + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) {
						/* begin cannotAssign:to:withIndex: */
						/* begin internalPush: */
...
#          endif // IMMUTABILITY
					...
					/* most stores into young objects */
					longAtput((void *)((objOop + BaseHeaderSize) + ((variableIndex << (shiftForWord())))),value);
					/* end storePointerImmutabilityCheck:ofObject:withValue: */
l3:;
					break;
				case 1:
...
#          if IMMUTABILITY
					...
					if ((((usqInt)((byteAt((void *)(litVar + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) {
						/* begin cannotAssign:to:withIndex: */
						/* begin internalPush: */
...
#          endif // IMMUTABILITY
					...
					/* most stores into young objects */
					longAtput((void *)((litVar + BaseHeaderSize) + ((((usqInt)(ValueIndex) << (shiftForWord()))))),value);
					/* end storePointerImmutabilityCheck:ofObject:withValue: */
l4:;
					break;
				default:
					...
					if (primitiveFunctionPointer) {
						if ((((usqIntptr_t) primitiveFunctionPointer)) <= MaxQuickPrimitiveIndex) {
							...
							if (localPrimIndex >= 264) {
								longAtput(localSP,longAt((void *)(((longAt(localSP)) + BaseHeaderSize) + ((((usqInt)((localPrimIndex - 264)) << (shiftForWord())))))));
								goto l168;
							}
				...
				if (opType == 2) {
					...
					if ((byte3 <= StackPointerIndex)
					 && (((longAt((void *)(obj))) & (classIndexMask())) == ClassMethodContextCompactIndex)) {
						...
						if (!(((((longAt((void *)((obj + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord())))))))) & 7) == 1))) {
						...
						/* begin frameOfMarriedContext: */
						senderOop = longAt((void *)((obj + BaseHeaderSize) + ((((usqInt)(SenderIndex) << (shiftForWord()))))));
						assert((((senderOop) & 7) == 1));
...
l10:
						...
						/* begin internalPush: */
						longAtput((localSP -= BytesPerOop),longAt((void *)((obj + BaseHeaderSize) + ((((usqInt)(byte3) << (shiftForWord())))))));
					}
					goto l7;
				}
				if (opType == 3) {
...
#          endif // IMMUTABILITY
					...
					/* most stores into young objects */
					longAtput((void *)((litVar + BaseHeaderSize) + ((((usqInt)(ValueIndex) << (shiftForWord()))))),top);
					/* end storePointerImmutabilityCheck:ofObject:withValue: */
l9:
...
#          if IMMUTABILITY
					...
					if ((((usqInt)((byteAt((void *)(obj + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) {
						/* begin cannotAssign:to:withIndex: */
						/* begin internalPush: */
...
l7:;
		...
		superclassSend:
			/* superclassSend */
			{
				...
				/* begin superclassOf: */
				/* begin followObjField:ofObject: */
				superclass = longAt((void *)((classPointer + BaseHeaderSize) + ((((usqInt)(SuperclassIndex) << (shiftForWord()))))));
				assert(isNonImmediate(superclass));
				if ((!((longAt((void *)(superclass))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun()))))) {
					superclass = fixFollowedFieldofObjectwithInitialValue(SuperclassIndex, classPointer, superclass);
				}
				...
				lkupClassTag = ((hash = (long32At((void *)(superclass + 4))) & (identityHashHalfWordMask()))
							? hash
							: (objCouldBeClassObj(superclass)
									? ((err = enterIntoClassTable(superclass))
											? -err
											: (long32At((void *)(superclass + 4))) & (identityHashHalfWordMask()))
									: -PrimErrBadReceiver));
...
l13:
				...
				/* Can't use NewObjectMemory>>#eeInstantiateSmallClassIndex:format:numSlots:
				   cuz it assumes <= 252 bytes whereras this may allocate 127 * 4 + headerSize bytes. */
				if (popValues) {
					for (i = 0; i < size; i += 1) {
						/* begin storePointerUnchecked:ofObject:withValue: */
						assert((isNonImmediate(array))
						 && (!(isForwarded(array))));
						assert(validStorePointerUncheckedArgs(i, array, longAt((void *)(localSP + (((size - i) - 1) * BytesPerOop)))));
						longAtput((void *)((array + BaseHeaderSize) + ((((usqInt)(i) << (shiftForWord()))))),longAt((void *)(localSP + (((size - i) - 1) * BytesPerOop))));
					}
		...
		case 507: // 251	pushRemoteTempLongBytecode
			{
				...
				/* begin internalPush: */
				longAtput((localSP -= BytesPerOop),longAt((void *)((tempVector + BaseHeaderSize) + ((((usqInt)(remoteTempIndex) << (shiftForWord())))))));
			}
			break;
		...
		case 508: // 252	storeRemoteTempLongBytecode
			{
				...
				/* most stores into young objects */
				longAtput((void *)((tempVector + BaseHeaderSize) + ((((usqInt)(remoteTempIndex) << (shiftForWord()))))),valuePointer);
			}
			break;
...
l16:
				...
				assert((isNonImmediate(newClosure))
				 && (!(isForwarded(newClosure))));
				assert(validStorePointerUncheckedArgs(ClosureNumArgsIndex, newClosure, ((numArgs << 3) | 1)));
				longAtput((void *)((newClosure + BaseHeaderSize) + ((((usqInt)(ClosureNumArgsIndex) << (shiftForWord()))))),((numArgs << 3) | 1));
				if (numCopied > 0) {
					for (i = 0; i < numCopied; i += 1) {
						/* begin storePointerUnchecked:ofObject:withValue: */
						assert((isNonImmediate(newClosure))
						 && (!(isForwarded(newClosure))));
						assert(validStorePointerUncheckedArgs(i + ClosureFirstCopiedValueIndex, newClosure, longAt((void *)(localSP + (((numCopied - i) - 1) * BytesPerOop)))));
						longAtput((void *)((newClosure + BaseHeaderSize) + ((((usqInt)((i + ClosureFirstCopiedValueIndex)) << (shiftForWord()))))),longAt((void *)(localSP + (((numCopied - i) - 1) * BytesPerOop))));
					}
...
l21:
					...
					if ((tagBits = arg & (tagMask()))) {
						...
						if (((longAt((void *)(arg))) & (classIndexMask())) == ClassFloatCompactIndex) {
			...
			/* booleanCheatTrue */
			{
				...
				if ((bytecode < 173)
				 && (bytecode > 151)) {
					...
					/* long jumpIfFalse */
					if (bytecode > 167) {
						offset = ((((usqInt)((bytecode - 168)) << 8))) + (byteAt(++localIP));
		...
		case 363: // 107	bytecodePrimMakePoint
			{
				...
				if ((/* isFloatOrInt: */
					(((rcvr & (tagMask())) != 0)
						? !(((rcvr & (characterTag())) != 0))
						: ((longAt((void *)(rcvr))) & (classIndexMask())) == ClassFloatCompactIndex))
				 && (/* isFloatOrInt: */
					(((arg & (tagMask())) != 0)
						? !(((arg & (characterTag())) != 0))
						 ...
						 && (oopisLessThanOrEqualTo(indexSqInt, stSize))) {
							...
							if (fmtSqInt < (firstByteFormat())) {
								if (fmtSqInt >= (firstShortFormat())) {
									result = (((usqInt)(((unsigned short) (shortAt((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((indexSqInt - 1)) << 1)))))))) << 3) | 1);
									goto l53;
								}
								if (fmtSqInt == (sixtyFourBitIndexableFormat())) {
									result = positive64BitIntegerFor(long64At((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((indexSqInt - 1)) << 3))))));
									goto l53;
								}
								resultSqInt = long32At((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((indexSqInt - 1)) << 2)))));
							...
							if (fmtSqInt >= 32 /* firstStringyFakeFormat */) {
								resultSqInt = (fmtSqInt < ((firstByteFormat()) + 32 /* firstStringyFakeFormat */)
											? (fmtSqInt < ((firstShortFormat()) + 32 /* firstStringyFakeFormat */)
													? long32At((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((indexSqInt - 1)) << 2)))))
													: ((unsigned short) (shortAt((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((indexSqInt - 1)) << 1))))))))
											: byteAt((void *)((rcvr + BaseHeaderSize) + (indexSqInt - 1))));
								result = ((((usqInt)(resultSqInt) << (numTagBits())))) + (characterTag());
								goto l53;
							}
							else {
								if ((fmtSqInt < (firstCompiledMethodFormat()))
								 || (indexSqInt >= ((((literalCountOf(rcvr)) + LiteralStart) * BytesPerOop) + 1))) {
									result = (((usqInt)(byteAt((void *)((rcvr + BaseHeaderSize) + (indexSqInt - 1)))) << 3) | 1);
									goto l53;
								}
							}
						}
						...
						if ((oopisGreaterThanOrEqualTo(indexSqInt, 1))
						 && (oopisLessThanOrEqualTo(indexSqInt, stSize))) {
							...
							if (fmtSqInt <= (weakArrayFormat())) {
								...
								/* most stores into young objects */
								((void) (longAtput((void *)((rcvr + BaseHeaderSize) + ((((usqInt)(fieldIndex) << (shiftForWord()))))),value)));
								goto l63;
							}
							if (fmtSqInt < (firstByteFormat())) {
								if (fmtSqInt >= (firstShortFormat())) {
									...
									shortAtput((void *)((rcvr + BaseHeaderSize) + ((((usqInt)((indexSqInt - 1)) << 1)))),valToPut);
									goto l63;
								}
								if (fmtSqInt == (sixtyFourBitIndexableFormat())) {
							...
							if (fmtSqInt >= 32 /* firstStringyFakeFormat */) {
								...
								if (fmtSqInt < ((firstByteFormat()) + 32 /* firstStringyFakeFormat */)) {
									if (fmtSqInt < ((firstShortFormat()) + 32 /* firstStringyFakeFormat */)) {
										assert(fmtSqInt != ((sixtyFourBitIndexableFormat()) + (firstStringyFakeFormat())));
							...
							byteAtput((void *)((rcvr + BaseHeaderSize) + (indexSqInt - 1)),valToPut);
							goto l63;
						}
						reasonCode = (isIndexable(rcvr)
									? PrimErrBadIndex
		...
		case 198: // bytecodePrimIdentical
			{
				...
				if (/* isOopForwarded: */
					((!(arg & (tagMask()))))
				 && ((!((longAt((void *)(arg))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
		...
		case 382: // 126	bytecodePrimPointX
			{
				...
				if ((!(rcvr & (tagMask())))) {
					...
					assert(!(isImmediate(rcvr)));
					ccIndex = (longAt((void *)(rcvr))) & (classIndexMask());
					isClassOfNonImmequalTocompactClassIndexRV = ClassPointCompactIndex == ccIndex;
...
l138:
					...
					/* begin internalPush: */
					longAtput((localSP -= BytesPerOop),longAt((void *)((obj + BaseHeaderSize) + ((((usqInt)(index) << (shiftForWord())))))));
				}
			}
			break;
...
l140:
		...
		directedSuperclassSend:
			/* directedSuperclassSend */
			{
				...
				localSP += BytesPerOop;
				if ((!((longAt((void *)(class))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun()))))) {
					/* begin followForwarded: */
					assert(isUnambiguouslyForwarder(class));
					referent = longAt((void *)((class + BaseHeaderSize) + (0U << (shiftForWord()))));
					while (/* isOopForwarded: */
						((!(referent & (tagMask()))))
					 && ((!((longAt((void *)(referent))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
						referent = longAt((void *)((referent + BaseHeaderSize) + (0U << (shiftForWord()))));
				...
				/* begin superclassOf: */
				/* begin followObjField:ofObject: */
				superclass = longAt((void *)((class + BaseHeaderSize) + ((((usqInt)(SuperclassIndex) << (shiftForWord()))))));
				assert(isNonImmediate(superclass));
				if ((!((longAt((void *)(superclass))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun()))))) {
					superclass = fixFollowedFieldofObjectwithInitialValue(SuperclassIndex, class, superclass);
				}
		...
		case 498: // 242	longStoreAndPopTemporaryVariableBytecode
			{
				...
				if (index < ((frameNumArgs = byteAt((localFP + FoxFrameFlags) + 1)))) {
					longAtput((localFP + FoxCallerSavedIP) + ((frameNumArgs - index) * BytesPerWord),longAt(localSP));
				}
				else {
					longAtput(((localFP + FoxReceiver) - BytesPerWord) + ((frameNumArgs - index) * BytesPerWord),longAt(localSP));
				}
...
#        endif // IMMUTABILITY
				...
				/* most stores into young objects */
				longAtput((void *)((litVar + BaseHeaderSize) + ((((usqInt)(ValueIndex) << (shiftForWord()))))),anObject);
				/* end storePointerImmutabilityCheck:ofObject:withValue: */
l148:
		...
		case 505: // 249	extPushFullClosureBytecode
			{
				...
				compiledBlockLiteralIndex = (byteAt(++localIP)) + ((((usqInt)(extA) << 8)));
				extA = 0;
				...
				header = longAt((void *)((compiledBlock + BaseHeaderSize) + ((((usqInt)(HeaderIndex) << (shiftForWord()))))));
...
l151:
				...
				assert((isNonImmediate(newClosure))
				 && (!(isForwarded(newClosure))));
				assert(validStorePointerUncheckedArgs(FullClosureCompiledBlockIndex, newClosure, compiledBlock));
				longAtput((void *)((newClosure + BaseHeaderSize) + ((((usqInt)(FullClosureCompiledBlockIndex) << (shiftForWord()))))),compiledBlock);
				...
				if (receiverIsOnStack) {
					...
					assert((isNonImmediate(newClosure))
					 && (!(isForwarded(newClosure))));
					assert(validStorePointerUncheckedArgs(FullClosureReceiverIndex, newClosure, longAt(localFP + FoxReceiver)));
					longAtput((void *)((newClosure + BaseHeaderSize) + ((((usqInt)(FullClosureReceiverIndex) << (shiftForWord()))))),longAt(localFP + FoxReceiver));
				...
				if (numCopiedSqInt > 0) {
					for (i = 0; i < numCopiedSqInt; i += 1) {
						...
						assert((isNonImmediate(newClosure))
						 && (!(isForwarded(newClosure))));
						assert(validStorePointerUncheckedArgs(i + startIndex, newClosure, longAt((void *)(localSP + (((numCopiedSqInt - i) - 1) * BytesPerOop)))));
						longAtput((void *)((newClosure + BaseHeaderSize) + ((((usqInt)((i + startIndex)) << (shiftForWord()))))),longAt((void *)(localSP + (((numCopiedSqInt - i) - 1) * BytesPerOop))));
					}
