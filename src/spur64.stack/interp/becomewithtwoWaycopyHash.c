...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	if (!(/* isArray: */
			((!(array1 & (tagMask()))))
		 && (((byteAt((void *)(array1 + (formatFieldByteOffset())))) & (formatMask())) == (arrayFormat())))) {
		return PrimErrBadReceiver;
	}
	if (!((/* isArray: */
			((!(array2 & (tagMask()))))
		 && (((byteAt((void *)(array2 + (formatFieldByteOffset())))) & (formatMask())) == (arrayFormat())))
		 && (((/* begin numSlotsOf: */
			assert((classIndexOf(array1)) > (isForwardedObjectClassIndexPun())),
		(((numSlotsUsqInt = byteAt((void *)(array1 + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
					? ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(array1 - BaseHeaderSize)))) << 8)))))) >> 8
					: numSlotsUsqInt))) == ((/* begin numSlotsOf: */
			assert((classIndexOf(array2)) > (isForwardedObjectClassIndexPun())),
		(((numSlots = byteAt((void *)(array2 + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
					? ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(array2 - BaseHeaderSize)))) << 8)))))) >> 8
					: numSlots)))))) {
	...
	if (fmt <= 5 /* lastPointerFormat */) {
		if ((fmt == (indexablePointersFormat()))
		 && (((longAt((void *)(array1))) & (classIndexMask())) == ClassMethodContextCompactIndex)) {
			/* begin fetchStackPointerOf: */
			sp = longAt((void *)((array1 + BaseHeaderSize) + ((((usqInt)(StackPointerIndex) << (shiftForWord()))))));
			if (!((((sp) & 7) == 1))) {
				contextSize = 0;
				goto l5;
			}
...
l5:
	...
	assert((classIndexOf(array1)) > (isForwardedObjectClassIndexPun())),
(((numSlots = byteAt((void *)(array1 + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
			? ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(array1 - BaseHeaderSize)))) << 8)))))) >> 8
	...
	header = longAt((void *)((array1 + BaseHeaderSize) + ((((usqInt)(HeaderIndex) << (shiftForWord()))))));
...
l2:
	...
	while (fieldOffset >= BaseHeaderSize) {
		...
		if (/* isOopForwarded: */
			((!(oop1 & (tagMask()))))
		 && ((!((longAt((void *)(oop1))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
			/* begin followForwarded: */
			assert(isUnambiguouslyForwarder(oop1));
			referent = longAt((void *)((oop1 + BaseHeaderSize) + (0U << (shiftForWord()))));
		...
		if ((byteAt((void *)(oop1 + (formatFieldByteOffset())))) & (1U << (pinnedBitByteShift()))) {
			ec = PrimErrObjectIsPinned;
			goto l6;
		}
		if (
#    if IMMUTABILITY
			((((usqInt)((byteAt((void *)(oop1 + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) != 0
#    else
			0
#    endif
			) {
...
l3:
		...
		if (/* isOopForwarded: */
			((!(oop2 & (tagMask()))))
		 && ((!((longAt((void *)(oop2))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
			/* begin followForwarded: */
			assert(isUnambiguouslyForwarder(oop2));
			referentSqInt = longAt((void *)((oop2 + BaseHeaderSize) + (0U << (shiftForWord()))));
			while (/* isOopForwarded: */
		...
		if (oop1 != oop2) {
			if (twoWayFlag) {
				...
				if ((byteAt((void *)(oop2 + (formatFieldByteOffset())))) & (1U << (pinnedBitByteShift()))) {
					ec = PrimErrObjectIsPinned;
					goto l6;
				}
				if (
#        if IMMUTABILITY
					((((usqInt)((byteAt((void *)(oop2 + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) != 0
#        else // IMMUTABILITY
					0
#        endif
					) {
...
l6:
	...
	if (twoWayFlag) {
		...
		toDoLimit = ((assert((classIndexOf(array1)) > (isForwardedObjectClassIndexPun())),
(((numSlots = byteAt((void *)(array1 + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
			? ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(array1 - BaseHeaderSize)))) << 8)))))) >> 8
			: numSlots))) - 1;
		for (i = 0; i <= toDoLimit; i += 1) {
			/* begin followField:ofObject: */
			obj1 = longAt((void *)((array1 + BaseHeaderSize) + ((((usqInt)(i) << (shiftForWord()))))));
			if (/* isOopForwarded: */
				((!(obj1 & (tagMask()))))
			 && ((!((longAt((void *)(obj1))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
				obj1 = fixFollowedFieldofObjectwithInitialValue(i, array1, obj1);
			}

			/* begin followField:ofObject: */
			obj2 = longAt((void *)((array2 + BaseHeaderSize) + ((((usqInt)(i) << (shiftForWord()))))));
			if (/* isOopForwarded: */
				((!(obj2 & (tagMask()))))
			 && ((!((longAt((void *)(obj2))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
				obj2 = fixFollowedFieldofObjectwithInitialValue(i, array2, obj2);
			}
			if (obj1 != obj2) {
				/* begin doBecome:and:copyHash: */
				o1ClassIndex = (long32At((void *)(obj1 + 4))) & (identityHashHalfWordMask());
				if ((o1ClassIndex != 0)
				 && ((classAtIndex(o1ClassIndex)) != obj1)) {
					o1ClassIndex = 0;
				}
				o2ClassIndex = (long32At((void *)(obj2 + 4))) & (identityHashHalfWordMask());
				if ((o2ClassIndex != 0)
				...
				(((numSlotsUsqInt = byteAt((void *)(obj1 + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
							? ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(obj1 - BaseHeaderSize)))) << 8)))))) >> 8
							: numSlotsUsqInt))) == ((/* begin numSlotsOf: */
					assert((classIndexOf(obj2)) > (isForwardedObjectClassIndexPun())),
				(((numSlots = byteAt((void *)(obj2 + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
							? ((((usqInt)(((sqInt)((usqInt)((longAt((void *)(obj2 - BaseHeaderSize)))) << 8)))))) >> 8
							: numSlots))))
				...
				if (o1ClassIndex) {
					if (o2ClassIndex) {
						...
						newObj2 = longAt((void *)((obj1 + BaseHeaderSize) + (0U << (shiftForWord()))));
						while (/* isOopForwarded: */
							((!(newObj2 & (tagMask()))))
						 && ((!((longAt((void *)(newObj2))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
							newObj2 = longAt((void *)((newObj2 + BaseHeaderSize) + (0U << (shiftForWord()))));
						}
						assert((rawHashBitsOf(newObj2)) == 0);

						/* begin setHashBitsOf:to: */
						long32Atput((void *)(newObj2 + 4),((((long32At((void *)(newObj2 + 4))) | (identityHashHalfWordMask())) - (identityHashHalfWordMask()))) + (o1ClassIndex & (identityHashHalfWordMask())));
					}
				}
				else {
					if (o2ClassIndex) {
						...
						newObj1 = longAt((void *)((obj2 + BaseHeaderSize) + (0U << (shiftForWord()))));
						while (/* isOopForwarded: */
							((!(newObj1 & (tagMask()))))
						 && ((!((longAt((void *)(newObj1))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
							newObj1 = longAt((void *)((newObj1 + BaseHeaderSize) + (0U << (shiftForWord()))));
						}
						assert((rawHashBitsOf(newObj1)) == 0);

						/* begin setHashBitsOf:to: */
						long32Atput((void *)(newObj1 + 4),((((long32At((void *)(newObj1 + 4))) | (identityHashHalfWordMask())) - (identityHashHalfWordMask()))) + (o2ClassIndex & (identityHashHalfWordMask())));
					}
				}
				/* end doBecome:and:copyHash: */
l1:
				objOop = longAt((void *)((array1 + BaseHeaderSize) + ((((usqInt)(i) << (shiftForWord()))))));
				if (/* isOopForwarded: */
					((!(objOop & (tagMask()))))
				...
				/* begin followField:ofObject: */
				objOopSqInt = longAt((void *)((array2 + BaseHeaderSize) + ((((usqInt)(i) << (shiftForWord()))))));
				if (/* isOopForwarded: */
					((!(objOopSqInt & (tagMask()))))
				 && ((!((longAt((void *)(objOopSqInt))) & ((classIndexMask()) - (isForwardedObjectClassIndexPun())))))) {
					objOopSqInt = fixFollowedFieldofObjectwithInitialValue(i, array2, objOopSqInt);
				}
			}
		}
	}
...
(((numSlots = byteAt((void *)(array1 + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
		...
		for (i = 0; i <= toDoLimit; i += 1) {
			...
			if (obj1 != obj2) {
				...
				longAtput((void *)(obj1),((longAt((void *)(obj1))) & (~(usqIntptr_t)(((((usqInt)((formatMask())) << (formatShift())))) + (classIndexMask())))) + ((isForwardedObjectClassIndexPun()) + ((((usqInt)((forwardedFormat())) << (formatShift()))))));
#        if IMMUTABILITY
				/* begin setIsImmutableOf:to: */
				longAtput((void *)(obj1),(longAt((void *)(obj1))) & (~(usqIntptr_t)(1U << (immutableBitShift()))));
#        endif // IMMUTABILITY
				...
				longAtput((void *)((obj1 + BaseHeaderSize) + (0U << (shiftForWord()))),obj2);
				...
				if (copyHashFlag) {
					...
					/* begin setHashBitsOf:to: */
					long32Atput((void *)(obj2 + 4),((((long32At((void *)(obj2 + 4))) | (identityHashHalfWordMask())) - (identityHashHalfWordMask()))) + (hash & (identityHashHalfWordMask())));
				}
