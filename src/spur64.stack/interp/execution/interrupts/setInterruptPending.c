...
/*	This is invoked frrom the platform GUI event subsystem when the user
        ...
        forceInterruptCheck so as to call the interruptCheckChain function if
   set. It's important to set interruptPending *before* calling
        forceInterruptCheck so that functions on the interruptCheckChain can
