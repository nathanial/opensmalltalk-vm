...
{   DECL_MAYBE_SQ_GLOBAL_STRUCT
	...
	clone1 = (((longAt((void *)(obj1))) & (classIndexMask())) == ClassMethodContextCompactIndex
				? cloneContext(obj1)
				: cloneObject(obj1));
	clone2 = (((longAt((void *)(obj2))) & (classIndexMask())) == ClassMethodContextCompactIndex
				? cloneContext(obj2)
				: cloneObject(obj2));
	if (
#  if IMMUTABILITY
		((((usqInt)((byteAt((void *)(obj1 + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) != 0
#  else
		0
#  endif
		) {
		/* begin setIsImmutableOf:to: */
		longAtput((void *)(clone1),(longAt((void *)(clone1))) | (1U << (immutableBitShift())));
	}
	if (
#  if IMMUTABILITY
		((((usqInt)((byteAt((void *)(obj2 + (immutableExtraBitsByteOffset())))))) >> (immutableBitByteShift())) & 1) != 0
#  else
		0
#  endif
		) {
		/* begin setIsImmutableOf:to: */
		longAtput((void *)(clone2),(longAt((void *)(clone2))) | (1U << (immutableBitShift())));
	}
	if (copyHashFlag) {
		hash = (long32At((void *)(obj1 + 4))) & (identityHashHalfWordMask());

		/* begin setHashBitsOf:to: */
		long32Atput((void *)(clone1 + 4),((((long32At((void *)(clone1 + 4))) | (identityHashHalfWordMask())) - (identityHashHalfWordMask()))) + (hash & (identityHashHalfWordMask())));
		hash = (long32At((void *)(obj2 + 4))) & (identityHashHalfWordMask());

		/* begin setHashBitsOf:to: */
		long32Atput((void *)(clone2 + 4),((((long32At((void *)(clone2 + 4))) | (identityHashHalfWordMask())) - (identityHashHalfWordMask()))) + (hash & (identityHashHalfWordMask())));
	}
	else {
		hash = (long32At((void *)(obj2 + 4))) & (identityHashHalfWordMask());
...
#  endif // IMMUTABILITY
	...
	longAtput((void *)((obj1 + BaseHeaderSize) + (0U << (shiftForWord()))),clone2);
	...
	assert((((isForwardedObjectClassIndexPun()) >= 0) && ((isForwardedObjectClassIndexPun()) <= (classIndexMask()))));
	assert((((forwardedFormat()) >= 0) && ((forwardedFormat()) <= (formatMask()))));
	longAtput((void *)(obj2),((longAt((void *)(obj2))) & (~(usqIntptr_t)(((((usqInt)((formatMask())) << (formatShift())))) + (classIndexMask())))) + ((isForwardedObjectClassIndexPun()) + ((((usqInt)((forwardedFormat())) << (formatShift()))))));
#  if IMMUTABILITY
	/* begin setIsImmutableOf:to: */
	longAtput((void *)(obj2),(longAt((void *)(obj2))) & (~(usqIntptr_t)(1U << (immutableBitShift()))));
#  endif // IMMUTABILITY
	...
	/* most stores into young objects */
	longAtput((void *)((obj2 + BaseHeaderSize) + (0U << (shiftForWord()))),clone1);
