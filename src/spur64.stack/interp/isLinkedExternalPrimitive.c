...
isLinkedExternalPrimitive(sqInt methodObj)
{
	...
	header = longAt((void *)((methodObj + BaseHeaderSize) + ((((usqInt)(HeaderIndex) << (shiftForWord()))))));
	...
	if (((header & AlternateHeaderHasPrimFlag) != 0)) {
		...
		primIdx = (byteAt((void *)(firstBytecode + 1))) + ((((usqInt)((byteAt((void *)(firstBytecode + 2)))) << 8)));
	}
	else {
		primIdx = 0;
	}
	...
	/* literalCountOfAlternateHeader: */
	 ...
	 && ((isArray((literal = longAt((void *)((methodObj + BaseHeaderSize) + (1U << (shiftForWord())))))))
	 && ((((/* begin numSlotsOf: */
	...
	(((numSlots = byteAt((void *)(literal + (numSlotsFieldByteOffset()))))) == (numSlotsMask())
				...
				: numSlots))) == 4)
	 && (((targetFunctionIndex = longAt((void *)((literal + BaseHeaderSize) + ((((usqInt)(ExternalCallLiteralTargetFunctionIndex) << (shiftForWord()))))))),
