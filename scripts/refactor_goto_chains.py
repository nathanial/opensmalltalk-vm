...
DEFAULT_CLANG_ARGS: Tuple[str, ...] = (
    ...
    "-Iplatforms/iOS/plugins/FilePlugin",
    "-Iplatforms/iOS/plugins/HostWindowPlugin",
    "-Iplatforms/iOS/plugins/SoundPlugin",
    "-Iplatforms/iOS/vm/Common",
    "-Iplatforms/iOS/vm/Common/Classes",
    "-Iplatforms/iOS/vm/OSX",
    "-Iplatforms/unix/vm",
    "-DDEBUGVM=0",
    "-DNDEBUG=1",
